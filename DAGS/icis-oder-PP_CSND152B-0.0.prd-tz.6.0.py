...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSND152B',WORKFLOW_ID='460253b4622547de831fcb76f2b606d2', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSND152B-0.0.prd-tz.6.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('460253b4622547de831fcb76f2b606d2')
    ...
    csnd152bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '990295d7bf784057a4abe516762f3578',
        'volumes': csnd152bJob_vol,
        'volume_mounts': csnd152bJob_volMnt,
        'env_from':csnd152bJob_env,
        'task_id':'csnd152bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=csnd152bJob","endTranDate=20240430","requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('460253b4622547de831fcb76f2b606d2')
