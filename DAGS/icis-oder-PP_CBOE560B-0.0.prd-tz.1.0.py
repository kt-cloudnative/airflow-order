...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOE560B',WORKFLOW_ID='198a762b55ff4798ab66ff4c752ee67b', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOE560B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('198a762b55ff4798ab66ff4c752ee67b')
    ...
    cboe560bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'f53b68c246e5435aa2df314435b7efe9',
    ...
    Complete = COMMON.getICISCompleteWflowTask('198a762b55ff4798ab66ff4c752ee67b')
