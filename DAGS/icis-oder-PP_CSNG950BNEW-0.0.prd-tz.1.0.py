...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG950BNEW',WORKFLOW_ID='8d4c1d21366b4187994a3d9b057845b9', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG950BNEW-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('8d4c1d21366b4187994a3d9b057845b9')
    ...
    Complete = COMMON.getICISCompleteWflowTask('8d4c1d21366b4187994a3d9b057845b9')
