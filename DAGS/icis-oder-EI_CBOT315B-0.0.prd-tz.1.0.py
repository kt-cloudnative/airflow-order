...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='EI_CBOT315B',WORKFLOW_ID='47ee7eee6338425d82d360da7367131b', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-EI_CBOT315B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('47ee7eee6338425d82d360da7367131b')
    ...
    cbot315bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '97297f1654a1464993e7d1b2752d1937',
    ...
    cbod445bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'fb231d6b5a3d4cfeac3d9db2314edeba',
    ...
    Complete = COMMON.getICISCompleteWflowTask('47ee7eee6338425d82d360da7367131b')
