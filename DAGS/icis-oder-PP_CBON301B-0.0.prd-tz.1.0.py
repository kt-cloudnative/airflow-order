...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON301B',WORKFLOW_ID='37eb42f6dbdf4b889ad2f37d2f4abdce', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON301B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('37eb42f6dbdf4b889ad2f37d2f4abdce')
    ...
    Complete = COMMON.getICISCompleteWflowTask('37eb42f6dbdf4b889ad2f37d2f4abdce')
