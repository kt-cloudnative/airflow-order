...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG797B',WORKFLOW_ID='53b1a1ea69c346daa10b1b421460d6fb', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG797B-0.0.prd-tz.0.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('53b1a1ea69c346daa10b1b421460d6fb')

    csng797bJob_vol = []
    csng797bJob_volMnt = []
    csng797bJob_vol.append(getVolume('t-order-ftp-pvc','t-order-ftp-pvc'))
    csng797bJob_volMnt.append(getVolumeMount('t-order-ftp-pvc','/app/order'))
    ...
    Complete = COMMON.getICISCompleteWflowTask('53b1a1ea69c346daa10b1b421460d6fb')
