...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IN_CBON323B',WORKFLOW_ID='7054b371c1d7477caca7f45c4acd0937', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IN_CBON323B-0.4.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('7054b371c1d7477caca7f45c4acd0937')
    ...
    cbon323bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'b0d55d35b47440eb91cf6c8a32b14764',
    ...
    Complete = COMMON.getICISCompleteWflowTask('7054b371c1d7477caca7f45c4acd0937')
