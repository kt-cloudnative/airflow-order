...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='EI_CBOT501B',WORKFLOW_ID='bce458e000404a4a8f9e9425a9629371', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-EI_CBOT501B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('bce458e000404a4a8f9e9425a9629371')
    ...
    cbot501bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '5a361028de4d48bfb18360e419f1a3e6',
    ...
    Complete = COMMON.getICISCompleteWflowTask('bce458e000404a4a8f9e9425a9629371')
