...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON327B',WORKFLOW_ID='f99bdfbffdfd4e7aab319fb45c6bf1f6', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON327B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('f99bdfbffdfd4e7aab319fb45c6bf1f6')
    ...
    cbon327bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'e79a66d5d9e94fa9ae507581c3dba80f',
    ...
    Complete = COMMON.getICISCompleteWflowTask('f99bdfbffdfd4e7aab319fb45c6bf1f6')
