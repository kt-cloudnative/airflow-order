...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG216B',WORKFLOW_ID='2ea30bb7050e48e79c6aa4557bc7f2b9', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG216B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('2ea30bb7050e48e79c6aa4557bc7f2b9')
    ...
    csng216bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '5d4af378fedc47389c871fb5d0e79073',
        'volumes': csng216bJob_vol,
        'volume_mounts': csng216bJob_volMnt,
        'env_from':csng216bJob_env,
        'task_id':'csng216bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.45',
        'arguments':["--job.name=csng216bJob", "endTranDate=20240701", "empNo=91332365","requestDate="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('2ea30bb7050e48e79c6aa4557bc7f2b9')
