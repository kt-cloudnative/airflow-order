...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG506B_12',WORKFLOW_ID='12d336e09db34b708fb8791b0f4b3452', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG506B_12-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('12d336e09db34b708fb8791b0f4b3452')
    ...
    csng506bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '4bef3d4425a3409b8bf5eb7011613e01',
        'volumes': csng506bJob_vol,
        'volume_mounts': csng506bJob_volMnt,
        'env_from':csng506bJob_env,
        'task_id':'csng506bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.132',
        'arguments':["--job.name=csng506bJob", "argv2=0054", "argv3=Y", "requestDate=${YYYYMM}" , "duplPrvnDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('12d336e09db34b708fb8791b0f4b3452')
