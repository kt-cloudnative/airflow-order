...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSND169B',WORKFLOW_ID='44d7c568fadd4182960332bdd387ef9c', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSND169B-0.0.prd-tz.2.2'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('44d7c568fadd4182960332bdd387ef9c')
    ...
    csnd169bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'f4acf303737540c6a1852fe1b67bb7b5',
    ...
    Complete = COMMON.getICISCompleteWflowTask('44d7c568fadd4182960332bdd387ef9c')
