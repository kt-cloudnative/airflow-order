...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IA_CBOT958B',WORKFLOW_ID='f49940de20a443a5a056dd9fd5ec3bbe', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IA_CBOT958B-0.2.prd-tz.3.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('f49940de20a443a5a056dd9fd5ec3bbe')

    cbot958bJob_vol = []
    cbot958bJob_volMnt = []
    cbot958bJob_vol.append(getVolume('shared-volume','shared-volume'))
    cbot958bJob_volMnt.append(getVolumeMount('shared-volume','/app/order'))
    ...
    cbot958bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '4893239b7291413b9086c66550023c62',
    ...
    Complete = COMMON.getICISCompleteWflowTask('f49940de20a443a5a056dd9fd5ec3bbe')
