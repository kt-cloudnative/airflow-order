...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG506B_05',WORKFLOW_ID='90e3afc0bc8d404481da9b1fce97da53', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG506B_05-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('90e3afc0bc8d404481da9b1fce97da53')
    ...
    csng506bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'ccde2439745b4112a4dafbba4c9e1f6b',
        'volumes': csng506bJob_vol,
        'volume_mounts': csng506bJob_volMnt,
        'env_from':csng506bJob_env,
        'task_id':'csng506bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.132',
        'arguments':["--job.name=csng506bJob", "argv2=0041", "argv3=Y", "requestDate=${YYYYMM}" , "duplPrvnDate=${YYYYMMDDHHMISSSSS}"
],
    ...
    Complete = COMMON.getICISCompleteWflowTask('90e3afc0bc8d404481da9b1fce97da53')
