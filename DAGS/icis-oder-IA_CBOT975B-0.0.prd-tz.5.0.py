...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IA_CBOT975B',WORKFLOW_ID='4f874c365f2541b4baa885360c9f8a08', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IA_CBOT975B-0.0.prd-tz.5.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('4f874c365f2541b4baa885360c9f8a08')
    ...
    cbot975bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '6b6444fd2922439fac599e9399daaf41',
    ...
    Complete = COMMON.getICISCompleteWflowTask('4f874c365f2541b4baa885360c9f8a08')
