...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='BI_CSAB803B',WORKFLOW_ID='900e7e7df30446379fe5c3d6f74ca59b', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-BI_CSAB803B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('900e7e7df30446379fe5c3d6f74ca59b')
    ...
    csab803bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'e07942eec9d1438ab6061d32f14a2d7b',
        ...
        'arguments':["--job.name=csab803bJob", "requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('900e7e7df30446379fe5c3d6f74ca59b')
