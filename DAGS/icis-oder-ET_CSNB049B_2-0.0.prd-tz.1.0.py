...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNB049B_2',WORKFLOW_ID='ee717bd2129646ada3c2a5d058feec7c', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNB049B_2-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('ee717bd2129646ada3c2a5d058feec7c')
    ...
    csnb049bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '3f02f3414b5f41428ce5e184927dbc03',
    ...
    Complete = COMMON.getICISCompleteWflowTask('ee717bd2129646ada3c2a5d058feec7c')
