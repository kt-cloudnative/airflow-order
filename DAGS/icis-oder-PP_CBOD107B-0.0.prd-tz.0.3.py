...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD107B',WORKFLOW_ID='039dc442bf1e4aa8b72ab9f394e60f0c', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD107B-0.0.prd-tz.0.3'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 4, 9, 20, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('039dc442bf1e4aa8b72ab9f394e60f0c')
    ...
    cbod107bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '167f51c93deb4bf3bb7bd91555234d7d',
    ...
    Complete = COMMON.getICISCompleteWflowTask('039dc442bf1e4aa8b72ab9f394e60f0c')
