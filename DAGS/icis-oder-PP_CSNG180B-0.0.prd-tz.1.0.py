...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG180B',WORKFLOW_ID='7b4d0c070638433c840105782b1ce137', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG180B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('7b4d0c070638433c840105782b1ce137')
    ...
    csng180bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '44e17281b87949acb3dcc731a37fc99a',
        'volumes': csng180bJob_vol,
        'volume_mounts': csng180bJob_volMnt,
        'env_from':csng180bJob_env,
        'task_id':'csng180bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.7',
        'arguments':["--job.name=csng180bJob" ,"workDate=20241129", "workRsCd=1" , "workType=S" ,"empNo=91354703" , "requestDate="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('7b4d0c070638433c840105782b1ce137')
