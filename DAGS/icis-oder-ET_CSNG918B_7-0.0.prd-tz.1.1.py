...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNG918B_7',WORKFLOW_ID='0707576d5e774bb3824b5ef20f04c2ee', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNG918B_7-0.0.prd-tz.1.1'
    ,'schedule_interval':'None'
    ,'start_date': datetime(2025, 1, 10, 10, 52, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
    ,'max_active_runs':1
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('0707576d5e774bb3824b5ef20f04c2ee')
    ...
    csng918bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'd31adaaae0244fddb73ad0dddc411a5f',
        ...
        'arguments':["--job.name=csng918bJob", "invMonth=${YYYYMM}", "subSaId=7", "date=${YYYYMMDDHHMISS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('0707576d5e774bb3824b5ef20f04c2ee')
