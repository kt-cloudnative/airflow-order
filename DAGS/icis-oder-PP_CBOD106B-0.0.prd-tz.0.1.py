...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD106B',WORKFLOW_ID='a178471fc75946c4a8fd752f4b4a9e2d', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD106B-0.0.prd-tz.0.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('a178471fc75946c4a8fd752f4b4a9e2d')
    ...
    cbod106bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'fade41bcc5154c2e950fb864b8850214',
    ...
    Complete = COMMON.getICISCompleteWflowTask('a178471fc75946c4a8fd752f4b4a9e2d')
