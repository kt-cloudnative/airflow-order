...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IC_CSNJ922B',WORKFLOW_ID='8eedcbf69968484b868dc74dd4d6e8bd', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IC_CSNJ922B-0.0.prd-tz.1.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 1, 15, 17, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
    ,'max_active_runs':1
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('8eedcbf69968484b868dc74dd4d6e8bd')
    ...
    csnj922bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '7dc1a1d520e14cb1b23d5622b8acf85d',
        ...
        'arguments':["--job.name=csnj922bJob", "requestDate=" + str(datetime.now()), "gszProcMonth=202407"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('8eedcbf69968484b868dc74dd4d6e8bd')
