...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG941B',WORKFLOW_ID='31018fe564ca4ab1b0b329dc4167ed6a', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG941B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('31018fe564ca4ab1b0b329dc4167ed6a')
    ...
    Complete = COMMON.getICISCompleteWflowTask('31018fe564ca4ab1b0b329dc4167ed6a')
