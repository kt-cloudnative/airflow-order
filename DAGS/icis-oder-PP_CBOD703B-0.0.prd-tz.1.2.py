...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD703B',WORKFLOW_ID='bf816137d9904e4da0563c60de53ea60', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD703B-0.0.prd-tz.1.2'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 4, 10, 36, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('bf816137d9904e4da0563c60de53ea60')
    ...
    cbod703bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '1cf932a420634b13991666ba8ade789b',
    ...
    Complete = COMMON.getICISCompleteWflowTask('bf816137d9904e4da0563c60de53ea60')
