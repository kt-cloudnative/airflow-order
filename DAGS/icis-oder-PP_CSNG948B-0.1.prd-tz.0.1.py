...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG948B',WORKFLOW_ID='a0b05ba3a92d40618c5305b0ce952082', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG948B-0.1.prd-tz.0.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('a0b05ba3a92d40618c5305b0ce952082')
    ...
    csng948bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '669c474b1d014c1cb8e7cd431b3104d2',
    ...
    Complete = COMMON.getICISCompleteWflowTask('a0b05ba3a92d40618c5305b0ce952082')
