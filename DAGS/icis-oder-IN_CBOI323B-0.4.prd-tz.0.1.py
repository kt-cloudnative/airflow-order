...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IN_CBOI323B',WORKFLOW_ID='d886f20724714fd8b7cb956325244608', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IN_CBOI323B-0.4.prd-tz.0.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('d886f20724714fd8b7cb956325244608')
    ...
    cboi323bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'c970097e2bf64fc0b458bd0056506d53',
        ...
        'arguments':["--job.name=cboi323bJob", "endDate=20241129", "requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('d886f20724714fd8b7cb956325244608')
