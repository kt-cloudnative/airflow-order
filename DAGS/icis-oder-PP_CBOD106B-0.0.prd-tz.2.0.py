...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD106B',WORKFLOW_ID='c080926c937d4afba670dd77640cc424', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD106B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('c080926c937d4afba670dd77640cc424')
    ...
    cbod106bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'fce0a4f4b4d7414382bd58d8d15e3fa6',
    ...
    Complete = COMMON.getICISCompleteWflowTask('c080926c937d4afba670dd77640cc424')
