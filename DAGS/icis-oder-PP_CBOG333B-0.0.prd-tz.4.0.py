...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOG333B',WORKFLOW_ID='a0a047ba38d540e39a342d6babc52c83', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOG333B-0.0.prd-tz.4.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('a0a047ba38d540e39a342d6babc52c83')
    ...
    cbog333bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'a09dd38f67184f1e869abce34da52ae7',
    ...
    Complete = COMMON.getICISCompleteWflowTask('a0a047ba38d540e39a342d6babc52c83')
