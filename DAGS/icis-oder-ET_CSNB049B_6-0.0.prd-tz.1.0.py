...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNB049B_6',WORKFLOW_ID='438a7bb9f12b405e856f3fea6b69cceb', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNB049B_6-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('438a7bb9f12b405e856f3fea6b69cceb')
    ...
    csnb049bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'd4a803135a47452e9b1651b48f63f4d2',
    ...
    Complete = COMMON.getICISCompleteWflowTask('438a7bb9f12b405e856f3fea6b69cceb')
