...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD112B',WORKFLOW_ID='6ae9c501eb9a46bda6b11c8f25e67dae', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD112B-0.0.prd-tz.2.4'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('6ae9c501eb9a46bda6b11c8f25e67dae')
    ...
    cbod112bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '94e752d8801b43c690cf21a89c59558a',
        'volumes': cbod112bJob_vol,
        'volume_mounts': cbod112bJob_volMnt,
        'env_from':cbod112bJob_env,
        'task_id':'cbod112bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=cbod112bJob", "endTranDate=20240530, "fromTime=00","toTime=13" ,"requestDate=${YYYYMMDDHHMISS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('6ae9c501eb9a46bda6b11c8f25e67dae')
