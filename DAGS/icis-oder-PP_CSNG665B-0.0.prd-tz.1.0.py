...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG665B',WORKFLOW_ID='f35c9413d66440d4afa527caad049f60', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG665B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('f35c9413d66440d4afa527caad049f60')
    ...
    csng665bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '18e167f309b443018ea1c8bac53315a8',
    ...
    Complete = COMMON.getICISCompleteWflowTask('f35c9413d66440d4afa527caad049f60')
