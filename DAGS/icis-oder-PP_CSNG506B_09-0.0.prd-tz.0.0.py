...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG506B_09',WORKFLOW_ID='d2bb1e73f063497c854cc07a89e3594d', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG506B_09-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('d2bb1e73f063497c854cc07a89e3594d')
    ...
    csng506bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '5377cb82220549afa938efcf2fb95477',
        'volumes': csng506bJob_vol,
        'volume_mounts': csng506bJob_volMnt,
        'env_from':csng506bJob_env,
        'task_id':'csng506bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.132',
        'arguments':["--job.name=csng506bJob", "argv2=0051", "argv3=Y", "requestDate=${YYYYMM}" , "duplPrvnDate=${YYYYMMDDHHMISSSSS}"
],
    ...
    Complete = COMMON.getICISCompleteWflowTask('d2bb1e73f063497c854cc07a89e3594d')
