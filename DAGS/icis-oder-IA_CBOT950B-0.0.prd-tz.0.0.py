...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IA_CBOT950B',WORKFLOW_ID='e71fdd95eed549978eb95d557aa3ef46', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IA_CBOT950B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('e71fdd95eed549978eb95d557aa3ef46')
    ...
    cbot950bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'f81c83783dc04a3099127547b76d1767',
        'volumes': cbot950bJob_vol,
        'volume_mounts': cbot950bJob_volMnt,
        'env_from':cbot950bJob_env,
        'task_id':'cbot950bJob',
        'image':'/icis/icis-oder-inetaplca-batch:0.4.1.19',
    ...
    Complete = COMMON.getICISCompleteWflowTask('e71fdd95eed549978eb95d557aa3ef46')
