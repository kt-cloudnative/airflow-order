...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IN_CBON335B',WORKFLOW_ID='360e82fb34864f299f4190b427b3e344', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IN_CBON335B-0.4.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('360e82fb34864f299f4190b427b3e344')
    ...
    cbon335bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '8455d7932d11405781f212293a70cd14',
    ...
    Complete = COMMON.getICISCompleteWflowTask('360e82fb34864f299f4190b427b3e344')
