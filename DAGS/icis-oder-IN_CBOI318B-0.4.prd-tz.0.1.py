...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IN_CBOI318B',WORKFLOW_ID='9b6c01217e124187a3f3315d460034cd', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IN_CBOI318B-0.4.prd-tz.0.1'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 1, 10, 11, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('9b6c01217e124187a3f3315d460034cd')
    ...
    cboi318bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '86fca01bc28748ff944cae5345c4fb69',
    ...
    Complete = COMMON.getICISCompleteWflowTask('9b6c01217e124187a3f3315d460034cd')
