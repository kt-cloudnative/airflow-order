...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD523B',WORKFLOW_ID='5a8acbcccaef479d870d47f3adc901e7', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD523B-0.0.prd-tz.3.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('5a8acbcccaef479d870d47f3adc901e7')
    ...
    cbod523bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'a413456ba19c450c9e7e5372b02e0748',
    ...
    Complete = COMMON.getICISCompleteWflowTask('5a8acbcccaef479d870d47f3adc901e7')
