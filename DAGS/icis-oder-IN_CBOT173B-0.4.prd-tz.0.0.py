...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IN_CBOT173B',WORKFLOW_ID='e284df994e364f17a365716ca8630556', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IN_CBOT173B-0.4.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('e284df994e364f17a365716ca8630556')
    ...
    cbot173bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '66cac3803bbb4f1ea92a6caba0577012',
        ...
        'arguments':["--job.name=cbot173bJob", "startDate=${YYYYMM}01", "closeDate=${YYYYMMDD}", "requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('e284df994e364f17a365716ca8630556')
