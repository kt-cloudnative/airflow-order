...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOE016B',WORKFLOW_ID='d6f157770ad048c88486665e3d2a0ffe', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOE016B-0.0.prd-tz.0.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 1, 19, 0, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('d6f157770ad048c88486665e3d2a0ffe')
    ...
    cboe016bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'c742d739ad194d509766a4cb85d3c4b0',
...
, "yyyyMm=${YYYYMM}", "svcName=cboe016bJob"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('d6f157770ad048c88486665e3d2a0ffe')
