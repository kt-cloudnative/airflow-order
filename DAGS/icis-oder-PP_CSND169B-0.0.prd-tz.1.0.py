...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSND169B',WORKFLOW_ID='22e6a7031cc1484c8a7a0fe8c7fbfea4', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSND169B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('22e6a7031cc1484c8a7a0fe8c7fbfea4')
    ...
    csnd169bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '065b1bead9104c1d9e35810d3a5f5fa8',
        'volumes': csnd169bJob_vol,
        'volume_mounts': csnd169bJob_volMnt,
        'env_from':csnd169bJob_env,
        'task_id':'csnd169bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.57',
        'arguments':["--job.name=csnd169bJob", "endTranDate=20240628", "pgmNm=csnd169b", "requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('22e6a7031cc1484c8a7a0fe8c7fbfea4')
