...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON302B',WORKFLOW_ID='cd654c715677410fbdeefa50c555291d', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON302B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('cd654c715677410fbdeefa50c555291d')
    ...
    cbon302bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '23368c8a593d482c90b7626a686de000',
...
"endTranDate=20240731"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('cd654c715677410fbdeefa50c555291d')
