...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON305B',WORKFLOW_ID='9af3da6624954b3c9c7da2b7fde0ff13', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON305B-0.0.prd-tz.4.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('9af3da6624954b3c9c7da2b7fde0ff13')
    ...
    cbon305bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'dbd712e7f6364e88b63cb716e41a7e3d',
    ...
    Complete = COMMON.getICISCompleteWflowTask('9af3da6624954b3c9c7da2b7fde0ff13')
