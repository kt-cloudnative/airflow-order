...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG666B',WORKFLOW_ID='ebf67197aa1b45b6858020c0914c463e', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG666B-0.0.prd-tz.4.3'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('ebf67197aa1b45b6858020c0914c463e')
    ...
    csng666bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '1466df3408084953aff88c997104636c',
        'volumes': csng666bJob_vol,
        'volume_mounts': csng666bJob_volMnt,
        'env_from':csng666bJob_env,
        'task_id':'csng666bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.69',
        'arguments':["--job.name=csng666bJob", "fromDate=20240530", "toDate=20240530", "requestDate="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('ebf67197aa1b45b6858020c0914c463e')
