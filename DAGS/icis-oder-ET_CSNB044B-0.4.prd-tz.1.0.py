...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNB044B',WORKFLOW_ID='f184fafad03d4ea7b03028889698eccd', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNB044B-0.4.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('f184fafad03d4ea7b03028889698eccd')
    ...
    csnb044bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '6eb2629e0e96437b86d741a7f7648e83',
    ...
    Complete = COMMON.getICISCompleteWflowTask('f184fafad03d4ea7b03028889698eccd')
