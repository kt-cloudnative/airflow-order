...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG207B',WORKFLOW_ID='603e7b3de3e24a7fbde5a440f3a0d987', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG207B-0.0.prd-tz.4.2'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('603e7b3de3e24a7fbde5a440f3a0d987')
    ...
    csng207bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '35b3963e4f684073a30fa9e116a1d4f3',
    ...
    Complete = COMMON.getICISCompleteWflowTask('603e7b3de3e24a7fbde5a440f3a0d987')
