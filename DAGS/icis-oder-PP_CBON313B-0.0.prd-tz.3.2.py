...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON313B',WORKFLOW_ID='9a4fdd303b004f04a72346e41a8ca2c4', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON313B-0.0.prd-tz.3.2'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('9a4fdd303b004f04a72346e41a8ca2c4')
    ...
    cbon313bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '090f449f9f024aa2ae92417899180cf6',
        'volumes': cbon313bJob_vol,
        'volume_mounts': cbon313bJob_volMnt,
        'env_from':cbon313bJob_env,
        'task_id':'cbon313bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=cbon313bJob","endTranDate=20240528","requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('9a4fdd303b004f04a72346e41a8ca2c4')
