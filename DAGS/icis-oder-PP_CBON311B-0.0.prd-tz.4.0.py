...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON311B',WORKFLOW_ID='3b5e7fbb70824861a00cf933c89d9899', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON311B-0.0.prd-tz.4.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('3b5e7fbb70824861a00cf933c89d9899')
    ...
    cbon311bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'ade261fcd83d418fa9f15f3d7a78ee07',
    ...
    Complete = COMMON.getICISCompleteWflowTask('3b5e7fbb70824861a00cf933c89d9899')
