...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG552B',WORKFLOW_ID='0ae084ce4a4845f28641d36ec246cffd', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG552B-0.0.prd-tz.4.4'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('0ae084ce4a4845f28641d36ec246cffd')
    ...
    csng552bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '5a1f488cc09b40b988847bc259880ab0',
        'volumes': csng552bJob_vol,
        'volume_mounts': csng552bJob_volMnt,
        'env_from':csng552bJob_env,
        'task_id':'csng552bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=csng552bJob", "tranDate=20240430", "testRequestDate=${YYYYMMDDHHMISS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('0ae084ce4a4845f28641d36ec246cffd')
