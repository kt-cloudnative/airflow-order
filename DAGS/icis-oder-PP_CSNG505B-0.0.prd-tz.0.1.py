...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG505B',WORKFLOW_ID='a777152d60994339ad13b10df4813486', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG505B-0.0.prd-tz.0.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('a777152d60994339ad13b10df4813486')
    ...
    csng505bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'ae09b118cebe42c28bdfc4ca4315ecce',
    ...
    Complete = COMMON.getICISCompleteWflowTask('a777152d60994339ad13b10df4813486')
