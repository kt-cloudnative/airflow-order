...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOA123B',WORKFLOW_ID='7b1e376256db4e2d80512529ddf52124', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOA123B-0.0.prd-tz.5.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('7b1e376256db4e2d80512529ddf52124')
    ...
    cboa123bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'dece129aeb6b478697fb13c75eae44b8',
    ...
    Complete = COMMON.getICISCompleteWflowTask('7b1e376256db4e2d80512529ddf52124')
