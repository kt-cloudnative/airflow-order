...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG950B',WORKFLOW_ID='2ac09fa5b295492795565682980861c0', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG950B-0.0.prd-tz.0.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 21, 20, 30, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('2ac09fa5b295492795565682980861c0')
    ...
    csng950bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '9e4ae5faa13e48779e76e469adf5f055',
        'volumes': csng950bJob_vol,
        'volume_mounts': csng950bJob_volMnt,
        'env_from':csng950bJob_env,
        'task_id':'csng950bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=csng950bJob","workDate=20240529", "requestDate="+str(datetime.now().strftime("%Y%m%d%H%M%S"))],
    ...
    Complete = COMMON.getICISCompleteWflowTask('2ac09fa5b295492795565682980861c0')
