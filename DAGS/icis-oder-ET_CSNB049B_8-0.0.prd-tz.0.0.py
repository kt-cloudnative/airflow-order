...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNB049B_8',WORKFLOW_ID='96ec2158d34f4d109b8330d8ca4d9a15', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNB049B_8-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('96ec2158d34f4d109b8330d8ca4d9a15')
    ...
    csnb049bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '78f4b15baebb47ea850a640796ff4c7d',
    ...
    Complete = COMMON.getICISCompleteWflowTask('96ec2158d34f4d109b8330d8ca4d9a15')
