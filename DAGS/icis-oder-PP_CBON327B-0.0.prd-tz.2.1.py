...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON327B',WORKFLOW_ID='3e429621dea84235a0a88fcf89f6e2e0', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON327B-0.0.prd-tz.2.1'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 19, 21, 56, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('3e429621dea84235a0a88fcf89f6e2e0')
    ...
    cbon327bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '267b03676c714296bd8e1ccdbc9b7385',
    ...
    Complete = COMMON.getICISCompleteWflowTask('3e429621dea84235a0a88fcf89f6e2e0')
