...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSND152B',WORKFLOW_ID='17baa60977cb46b79d3a06f5ba8624a3', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSND152B-0.0.prd-tz.3.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('17baa60977cb46b79d3a06f5ba8624a3')
    ...
    csnd152bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'f189bab180624938b960cf781d62101a',
    ...
    Complete = COMMON.getICISCompleteWflowTask('17baa60977cb46b79d3a06f5ba8624a3')
