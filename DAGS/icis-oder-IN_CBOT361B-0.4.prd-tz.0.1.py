...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IN_CBOT361B',WORKFLOW_ID='0257fa077b7b440ea7df2070714500b2', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IN_CBOT361B-0.4.prd-tz.0.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('0257fa077b7b440ea7df2070714500b2')
    ...
    cbot361bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '41edd8268fab4299a8cb3dcf3e020904',
    ...
    Complete = COMMON.getICISCompleteWflowTask('0257fa077b7b440ea7df2070714500b2')
