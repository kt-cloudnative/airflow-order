...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='EI_CBOT501B',WORKFLOW_ID='3e1ae17a642c44c7b59dcbe1e82129b8', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-EI_CBOT501B-0.0.prd-tz.1.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('3e1ae17a642c44c7b59dcbe1e82129b8')
    ...
    cbot501bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'eeb6845e93014ced90e7e71578adc0a0',
    ...
    Complete = COMMON.getICISCompleteWflowTask('3e1ae17a642c44c7b59dcbe1e82129b8')
