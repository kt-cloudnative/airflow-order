...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG665B',WORKFLOW_ID='07df29e8d18a42b29e64b7d8a386ba1a', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG665B-0.0.prd-tz.4.4'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('07df29e8d18a42b29e64b7d8a386ba1a')
    ...
    csng665bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '24d6f5341e3f491d96e556d8e700608e',
        'volumes': csng665bJob_vol,
        'volume_mounts': csng665bJob_volMnt,
        'env_from':csng665bJob_env,
        'task_id':'csng665bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=csng665bJob", "fromDate=20240430", "toDate=20240430", "requestDate="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('07df29e8d18a42b29e64b7d8a386ba1a')
