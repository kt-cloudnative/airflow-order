...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG187B',WORKFLOW_ID='61973d13fb0543908486312e81359e75', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG187B-0.0.prd-tz.4.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('61973d13fb0543908486312e81359e75')
    ...
    csng187bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'd8adb7affd3a4254b36f25ba795a0d9a',
...
, "requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('61973d13fb0543908486312e81359e75')
