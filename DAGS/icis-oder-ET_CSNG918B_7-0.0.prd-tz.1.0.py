...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNG918B_7',WORKFLOW_ID='9f40e5541e444ddeb167a60d96e8c096', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNG918B_7-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('9f40e5541e444ddeb167a60d96e8c096')
    ...
    csng918bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '0ea1d7e4c1024ed69db6a646e7bdc052',
    ...
    Complete = COMMON.getICISCompleteWflowTask('9f40e5541e444ddeb167a60d96e8c096')
