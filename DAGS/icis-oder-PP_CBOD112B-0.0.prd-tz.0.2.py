...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD112B',WORKFLOW_ID='c1049e6dd6054c5b94d28a1f4b6f3e2e', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD112B-0.0.prd-tz.0.2'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 1, 17, 32, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('c1049e6dd6054c5b94d28a1f4b6f3e2e')
    ...
    cbod112bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '5da62996cefc4b599161102078e7dda7',
    ...
    Complete = COMMON.getICISCompleteWflowTask('c1049e6dd6054c5b94d28a1f4b6f3e2e')
