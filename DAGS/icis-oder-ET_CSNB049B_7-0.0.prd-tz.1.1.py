...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNB049B_7',WORKFLOW_ID='b4f1cfca7b2f4bebb5394ea1c4ee2d1c', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNB049B_7-0.0.prd-tz.1.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('b4f1cfca7b2f4bebb5394ea1c4ee2d1c')
    ...
    csnb049bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'c426d76a09cf43b5b06ea9ab7a4309a2',
    ...
    Complete = COMMON.getICISCompleteWflowTask('b4f1cfca7b2f4bebb5394ea1c4ee2d1c')
