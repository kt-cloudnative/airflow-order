...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNG918B_3',WORKFLOW_ID='d340314ced1d4da19646372c3ff3c79a', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNG918B_3-0.0.prd-tz.1.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('d340314ced1d4da19646372c3ff3c79a')
    ...
    csng918bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '9884cfc7fc7a4516be480d57c5bb0f02',
        ...
        'arguments':["--job.name=csng918bJob", "invMonth=${YYYYMM}", "subSaId=3", "date=${YYYYMMDDHHMISS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('d340314ced1d4da19646372c3ff3c79a')
