...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='WC_CSNG061B',WORKFLOW_ID='62bb5a8c51174ff3b936de0c074997e1', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-WC_CSNG061B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('62bb5a8c51174ff3b936de0c074997e1')
    ...
    csng061bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '1c800a8c2ab74245ab5ccd331f6e371d',
    ...
    Complete = COMMON.getICISCompleteWflowTask('62bb5a8c51174ff3b936de0c074997e1')
