...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG926B',WORKFLOW_ID='ecff8f185b4c4141a1180a1f4fa7173c', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG926B-0.0.prd-tz.0.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('ecff8f185b4c4141a1180a1f4fa7173c')
    ...
    Complete = COMMON.getICISCompleteWflowTask('ecff8f185b4c4141a1180a1f4fa7173c')
