...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON301B',WORKFLOW_ID='e64dbc4e047a4be89b800d2603922b3e', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON301B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('e64dbc4e047a4be89b800d2603922b3e')
    ...
    cbon301bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'fbec2b7404a1480c9b763a80ebfd6adc',
    ...
    Complete = COMMON.getICISCompleteWflowTask('e64dbc4e047a4be89b800d2603922b3e')
