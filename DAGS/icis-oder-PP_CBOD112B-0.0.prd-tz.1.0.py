...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD112B',WORKFLOW_ID='5d03c65eebc6443a92d2318168e74737', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD112B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('5d03c65eebc6443a92d2318168e74737')

    cbod112bJob_vol = []
    cbod112bJob_volMnt = []
    cbod112bJob_vol.append(getVolume('shared-volume','shared-volume'))
    cbod112bJob_volMnt.append(getVolumeMount('shared-volume',''))
    ...
    cbod112bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '09e6fe08979b4b69a1efc2db75dce1ed',
        'volumes': cbod112bJob_vol,
        'volume_mounts': cbod112bJob_volMnt,
        'env_from':cbod112bJob_env,
        'task_id':'cbod112bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.57',
        'arguments':["--job.name=cbod112bJob", "endTranDate=20240628", "fromTime=00","toTime=13" ,"requestDate=${YYYYMMDDHHMISS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('5d03c65eebc6443a92d2318168e74737')
