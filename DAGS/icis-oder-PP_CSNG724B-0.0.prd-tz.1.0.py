...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG724B',WORKFLOW_ID='d1eb9cb95d514602887b528fb810ee5d', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG724B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('d1eb9cb95d514602887b528fb810ee5d')

    csng724bJob_vol = []
    csng724bJob_volMnt = []
    csng724bJob_vol.append(getVolume('shared-volume','shared-volume'))
    csng724bJob_volMnt.append(getVolumeMount('shared-volume','/app/order'))
    ...
    csng724bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '4d2441e4e09e4ef49241e507b49c84e3',
        'volumes': csng724bJob_vol,
        'volume_mounts': csng724bJob_volMnt,
        'env_from':csng724bJob_env,
        'task_id':'csng724bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.7',
        'arguments':["--job.name=csng724bJob", "inDate=202411", "inSaCd=2C48" ,"ver="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('d1eb9cb95d514602887b528fb810ee5d')
