...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IN_CBOI366B',WORKFLOW_ID='19acbcf79c68473eac8f69bbc612aa4c', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IN_CBOI366B-0.4.prd-tz.2.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('19acbcf79c68473eac8f69bbc612aa4c')
    ...
    cboi366bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'b22103d5941348f2bbf7ec954486a76f',
        ...
        'arguments':["--job.name=cboi366bJob",  "rcvEndDate=20241129", "regerEmpOfc=MNC013", "regerEmpNo=cboi366b", "regerEmpName=cboi366b", "requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('19acbcf79c68473eac8f69bbc612aa4c')
