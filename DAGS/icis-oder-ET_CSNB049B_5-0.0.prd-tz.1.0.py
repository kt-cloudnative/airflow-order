...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNB049B_5',WORKFLOW_ID='11674d49cf064c22858f34526b66823a', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNB049B_5-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('11674d49cf064c22858f34526b66823a')
    ...
    csnb049bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'aaba0b2a0fbe4d0cb6ca3a2f52af81a3',
        ...
        'arguments':["--job.name=csnb049bJob", "workYm=${YYYYMM}", "workGb=5", "regEmpNo=91108904", "date=${YYYYMMDDHHMISS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('11674d49cf064c22858f34526b66823a')
