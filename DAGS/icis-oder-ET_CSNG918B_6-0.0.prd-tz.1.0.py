...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNG918B_6',WORKFLOW_ID='ca2bf0efd59e483489f6a45faf9d2f73', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNG918B_6-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('ca2bf0efd59e483489f6a45faf9d2f73')
    ...
    csng918bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '99a940a16e1e427a8573878b419c426c',
    ...
    Complete = COMMON.getICISCompleteWflowTask('ca2bf0efd59e483489f6a45faf9d2f73')
