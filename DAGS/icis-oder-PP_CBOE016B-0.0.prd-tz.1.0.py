...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOE016B',WORKFLOW_ID='eb22286cc72e4b498c9a6fc875015eea', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOE016B-0.0.prd-tz.1.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 6, 18, 40, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('eb22286cc72e4b498c9a6fc875015eea')
    ...
    cboe016bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'b45d5f3f13874665a61379f82e8867db',
...
, "yyyyMm=${YYYYMM}", "svcName=cboe016bJob"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('eb22286cc72e4b498c9a6fc875015eea')
