...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG926B',WORKFLOW_ID='be9d3280368c4bc3a60e33bb60a33773', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG926B-0.0.prd-tz.6.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('be9d3280368c4bc3a60e33bb60a33773')
    ...
    csng926bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '402a36b7a79e45e092a52803f3aad237',
        'volumes': csng926bJob_vol,
        'volume_mounts': csng926bJob_volMnt,
        'env_from':csng926bJob_env,
        'task_id':'csng926bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=csng926bJob", "tranDate=20240430", "ver=003"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('be9d3280368c4bc3a60e33bb60a33773')
