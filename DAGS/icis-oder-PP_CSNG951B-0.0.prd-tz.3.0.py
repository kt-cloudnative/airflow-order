...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG951B',WORKFLOW_ID='b1cc60896ba94892be6d27373e168cbf', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG951B-0.0.prd-tz.3.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('b1cc60896ba94892be6d27373e168cbf')
    ...
    Complete = COMMON.getICISCompleteWflowTask('b1cc60896ba94892be6d27373e168cbf')
