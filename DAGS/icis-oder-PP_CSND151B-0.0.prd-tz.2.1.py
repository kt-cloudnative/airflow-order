...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSND151B',WORKFLOW_ID='35bb4674adf04d0b9b22e2e5623202b0', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSND151B-0.0.prd-tz.2.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('35bb4674adf04d0b9b22e2e5623202b0')
    ...
    csnd151bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'e5c1c9effb1a4f05b7b7b86a2418e342',
    ...
    Complete = COMMON.getICISCompleteWflowTask('35bb4674adf04d0b9b22e2e5623202b0')
