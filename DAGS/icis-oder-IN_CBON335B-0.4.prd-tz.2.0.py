...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IN_CBON335B',WORKFLOW_ID='811e27595d734eb081bcf264bce629ac', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IN_CBON335B-0.4.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('811e27595d734eb081bcf264bce629ac')
    ...
    cbon335bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '8742b4dd1e30421ca90ab5efd9f12a11',
        ...
        'arguments':["--job.name=cbon335bJob", "closeDate=${YYYYMMDD}", "empNo=cbon335b", "empNm=cbon335b", "ofcCd=710571", "requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('811e27595d734eb081bcf264bce629ac')
