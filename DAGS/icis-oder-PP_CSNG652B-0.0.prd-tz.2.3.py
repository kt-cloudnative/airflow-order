...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG652B',WORKFLOW_ID='6312e06768f149e3aff0026b5d7dcbe8', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG652B-0.0.prd-tz.2.3'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('6312e06768f149e3aff0026b5d7dcbe8')
    ...
    csng652bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'd0bf0c3207e34b19aed5003a282cfbfb',
        'volumes': csng652bJob_vol,
        'volume_mounts': csng652bJob_volMnt,
        'env_from':csng652bJob_env,
        'task_id':'csng652bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=csng652bJob","fromDate=20240529", "toDate=20240529", "ver="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('6312e06768f149e3aff0026b5d7dcbe8')
