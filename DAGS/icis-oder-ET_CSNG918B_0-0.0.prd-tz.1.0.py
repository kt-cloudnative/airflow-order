...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNG918B_0',WORKFLOW_ID='f93ccf4e8e774e59a322f5cb5756c197', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNG918B_0-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('f93ccf4e8e774e59a322f5cb5756c197')
    ...
    csng918bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '84b3a067d142477a9da2a65abae1e581',
    ...
    Complete = COMMON.getICISCompleteWflowTask('f93ccf4e8e774e59a322f5cb5756c197')
