...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNG918B_9',WORKFLOW_ID='d16b9f399e794fa7baee6c64342e12a1', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNG918B_9-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('d16b9f399e794fa7baee6c64342e12a1')
    ...
    csng918bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '3ad7756487df4922953c0320b82bd39f',
    ...
    Complete = COMMON.getICISCompleteWflowTask('d16b9f399e794fa7baee6c64342e12a1')
