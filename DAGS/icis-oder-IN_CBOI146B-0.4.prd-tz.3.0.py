...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IN_CBOI146B',WORKFLOW_ID='dccbe9ffbf4f402eac267cf57faf5f6b', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IN_CBOI146B-0.4.prd-tz.3.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('dccbe9ffbf4f402eac267cf57faf5f6b')
    ...
    cboi146bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'e82c5b55b4b54568be53835f5cde764b',
    ...
    Complete = COMMON.getICISCompleteWflowTask('dccbe9ffbf4f402eac267cf57faf5f6b')
