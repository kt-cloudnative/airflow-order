...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSND176B',WORKFLOW_ID='00de3bd50e764b889d31fb9f9f95c923', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSND176B-0.0.prd-tz.2.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('00de3bd50e764b889d31fb9f9f95c923')
    ...
    csnd176bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '015c0f9d96284a578b4da3d4c92034fb',
    ...
    Complete = COMMON.getICISCompleteWflowTask('00de3bd50e764b889d31fb9f9f95c923')
