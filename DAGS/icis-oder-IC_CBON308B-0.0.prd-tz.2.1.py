...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IC_CBON308B',WORKFLOW_ID='9215e32516624cf39d5325451166a6e8', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IC_CBON308B-0.0.prd-tz.2.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('9215e32516624cf39d5325451166a6e8')
    ...
    cbon308bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'c31ce0d0e465452aa5d233ca39afad16',
    ...
    Complete = COMMON.getICISCompleteWflowTask('9215e32516624cf39d5325451166a6e8')
