...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='WC_CBON327B',WORKFLOW_ID='e43bd98eda6b47ec857cd984528d4aee', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-WC_CBON327B-0.0.prd-tz.5.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('e43bd98eda6b47ec857cd984528d4aee')
    ...
    cbon327bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'da45304970a341dfa3a410a8d347df4c',
    ...
    Complete = COMMON.getICISCompleteWflowTask('e43bd98eda6b47ec857cd984528d4aee')
