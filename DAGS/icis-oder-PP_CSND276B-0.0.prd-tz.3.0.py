...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSND276B',WORKFLOW_ID='a729be4a65f340a2b0c0cd2c2d2f91d8', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSND276B-0.0.prd-tz.3.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('a729be4a65f340a2b0c0cd2c2d2f91d8')
    ...
    csnd276bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'd7a01b0f13d84866a6d860a22b8c7421',
        'volumes': csnd276bJob_vol,
        'volume_mounts': csnd276bJob_volMnt,
        'env_from':csnd276bJob_env,
        'task_id':'csnd276bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=csnd276bJob", "endTranDate=20240529", "pgmNm=csnd276b", "requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('a729be4a65f340a2b0c0cd2c2d2f91d8')
