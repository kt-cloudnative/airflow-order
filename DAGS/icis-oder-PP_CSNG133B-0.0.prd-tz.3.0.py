...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG133B',WORKFLOW_ID='4761525e25ee4d7c843fef2e5fa1fe00', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG133B-0.0.prd-tz.3.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2025, 1, 3, 18, 10, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
    ,'max_active_runs': 16
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('4761525e25ee4d7c843fef2e5fa1fe00')
    ...
    csng133bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'f46554a9aad14266ad8e1ce68edfd8e1',
...
, "workMonth=${YYYYMM}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('4761525e25ee4d7c843fef2e5fa1fe00')
