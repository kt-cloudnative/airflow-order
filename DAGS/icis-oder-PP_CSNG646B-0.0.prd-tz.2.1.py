...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG646B',WORKFLOW_ID='1990c21f6baa44198abbca529e33037c', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG646B-0.0.prd-tz.2.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('1990c21f6baa44198abbca529e33037c')
    ...
    csng646bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'c18c1ea1df614896b51006b04b2caf18',
    ...
    Complete = COMMON.getICISCompleteWflowTask('1990c21f6baa44198abbca529e33037c')
