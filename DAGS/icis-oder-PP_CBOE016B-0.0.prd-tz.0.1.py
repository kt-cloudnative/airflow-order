...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOE016B',WORKFLOW_ID='08808ab9e09c4810ae4e0e110d2fd999', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOE016B-0.0.prd-tz.0.1'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 4, 10, 40, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('08808ab9e09c4810ae4e0e110d2fd999')
    ...
    cboe016bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '19080a1419de4e96b8f3d504be16aec9',
...
, "yyyyMm=${YYYYMM}", "svcName=cboe016bJob"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('08808ab9e09c4810ae4e0e110d2fd999')
