...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IN_CBOT172B',WORKFLOW_ID='b4bd6123c1bb465285219ca81fb5429f', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IN_CBOT172B-0.4.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('b4bd6123c1bb465285219ca81fb5429f')
    ...
    cbot172bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '86ea1dbd24a24df2a381c48a19055e20',
        ...
        'arguments':["--job.name=cbot172bJob", "inDate=${YYYYMM}01", "requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('b4bd6123c1bb465285219ca81fb5429f')
