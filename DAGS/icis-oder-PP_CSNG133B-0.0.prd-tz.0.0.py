...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG133B',WORKFLOW_ID='1ad1b69d1016401a914a7e7f4db795a2', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG133B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('1ad1b69d1016401a914a7e7f4db795a2')
    ...
    csng133bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '0bc05537cfaa4755ae6128ebac2924e8',
...
, "workMonth=${YYYYMM}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('1ad1b69d1016401a914a7e7f4db795a2')
