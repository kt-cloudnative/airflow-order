...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='WC_CBOD999B',WORKFLOW_ID='4d97a64fe86a4854a60f5cb2e027a059', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-WC_CBOD999B-0.0.prd-tz.3.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('4d97a64fe86a4854a60f5cb2e027a059')
    ...
    cbod999bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '14b51d0a05194535a282a53b9ada48a2',
        'volumes': cbod999bJob_vol,
        'volume_mounts': cbod999bJob_volMnt,
        'env_from':cbod999bJob_env,
        'task_id':'cbod999bJob',
        'image':'/icis/icis-oder-wrlincomn-batch:0.7.1.3',
    ...
    Complete = COMMON.getICISCompleteWflowTask('4d97a64fe86a4854a60f5cb2e027a059')
