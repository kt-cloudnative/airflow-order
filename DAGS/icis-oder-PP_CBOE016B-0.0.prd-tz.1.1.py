...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOE016B',WORKFLOW_ID='232ab2b35eee40ec8fcc676a6494061e', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOE016B-0.0.prd-tz.1.1'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 8, 19, 0, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('232ab2b35eee40ec8fcc676a6494061e')
    ...
    cboe016bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '09228af58cb1418aa3041967f7983f99',
...
, "yyyyMm=${YYYYMM}", "svcName=cboe016bJob"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('232ab2b35eee40ec8fcc676a6494061e')
