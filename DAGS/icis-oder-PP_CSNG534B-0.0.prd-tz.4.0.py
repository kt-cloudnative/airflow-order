...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG534B',WORKFLOW_ID='746f1e0278084440bd0038cfe35601c7', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG534B-0.0.prd-tz.4.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('746f1e0278084440bd0038cfe35601c7')
    ...
    csng534bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '0bed2a271a444c799369be76c92e748a',
        'volumes': csng534bJob_vol,
        'volume_mounts': csng534bJob_volMnt,
        'env_from':csng534bJob_env,
        'task_id':'csng534bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.5',
        'arguments':["--job.name=csng534bJob", "inputDate=20250101","requestDate="+str(datetime.now())
],
    ...
    Complete = COMMON.getICISCompleteWflowTask('746f1e0278084440bd0038cfe35601c7')
