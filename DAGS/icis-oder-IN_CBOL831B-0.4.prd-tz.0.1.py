...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IN_CBOL831B',WORKFLOW_ID='b5e5f02537904f6eb54a9b8704406e85', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IN_CBOL831B-0.4.prd-tz.0.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('b5e5f02537904f6eb54a9b8704406e85')
    ...
    cbol831bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'f3fdfe0a4dc7429892659cd5bf6e28c4',
    ...
    Complete = COMMON.getICISCompleteWflowTask('b5e5f02537904f6eb54a9b8704406e85')
