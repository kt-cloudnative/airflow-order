...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNB049B_5',WORKFLOW_ID='8eba4405a4734df1912feb1543ffe42a', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNB049B_5-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('8eba4405a4734df1912feb1543ffe42a')
    ...
    csnb049bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'eab15999482b49dd8894774d1dbbd861',
    ...
    Complete = COMMON.getICISCompleteWflowTask('8eba4405a4734df1912feb1543ffe42a')
