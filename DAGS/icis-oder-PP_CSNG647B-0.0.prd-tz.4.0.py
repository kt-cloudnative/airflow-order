...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG647B',WORKFLOW_ID='a8447f9772be4a9496edc7de1830195c', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG647B-0.0.prd-tz.4.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 21, 19, 55, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('a8447f9772be4a9496edc7de1830195c')
    ...
    csng647bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '9683e9b50cb84b648a293a91bb65e8b5',
    ...
    Complete = COMMON.getICISCompleteWflowTask('a8447f9772be4a9496edc7de1830195c')
