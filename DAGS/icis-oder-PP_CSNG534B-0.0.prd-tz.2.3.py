...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG534B',WORKFLOW_ID='43851397fb084188b84555609d02950c', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG534B-0.0.prd-tz.2.3'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('43851397fb084188b84555609d02950c')
    ...
    csng534bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '2bc862e34e25426a923713f403543e59',
        'volumes': csng534bJob_vol,
        'volume_mounts': csng534bJob_volMnt,
        'env_from':csng534bJob_env,
        'task_id':'csng534bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=csng534bJob", "inputDate=20240529","requestDate="+str(datetime.now())
],
    ...
    Complete = COMMON.getICISCompleteWflowTask('43851397fb084188b84555609d02950c')
