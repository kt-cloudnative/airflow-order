...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOG088B',WORKFLOW_ID='7ec1eedf7687467fb1f82ba411b6a896', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOG088B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('7ec1eedf7687467fb1f82ba411b6a896')
    ...
    Complete = COMMON.getICISCompleteWflowTask('7ec1eedf7687467fb1f82ba411b6a896')
