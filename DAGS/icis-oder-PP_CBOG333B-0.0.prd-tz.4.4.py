...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOG333B',WORKFLOW_ID='22688c17e90c43739f6666d4b0259c2f', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOG333B-0.0.prd-tz.4.4'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('22688c17e90c43739f6666d4b0259c2f')
    ...
    cbog333bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'd963f9cb1b5d44f28c4df5d1b3c73589',
        'volumes': cbog333bJob_vol,
        'volume_mounts': cbog333bJob_volMnt,
        'env_from':cbog333bJob_env,
        'task_id':'cbog333bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=cbog333bJob", "endTranDate=20240430", "ver="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('22688c17e90c43739f6666d4b0259c2f')
