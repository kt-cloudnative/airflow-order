...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG216B',WORKFLOW_ID='3dab37235cbe476fb5a90031d53910cd', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG216B-0.0.prd-tz.8.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('3dab37235cbe476fb5a90031d53910cd')
    ...
    csng216bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '4898325ea41d410fafa1c340601ef0c8',
    ...
    Complete = COMMON.getICISCompleteWflowTask('3dab37235cbe476fb5a90031d53910cd')
