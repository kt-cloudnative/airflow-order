...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOG193B',WORKFLOW_ID='8bd6311271984b7d91a71c4c8838412e', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOG193B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('8bd6311271984b7d91a71c4c8838412e')
    ...
    cbog193bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'a8f41122e177470eaf7b11d48ffb9934',
        'volumes': cbog193bJob_vol,
        'volume_mounts': cbog193bJob_volMnt,
        'env_from':cbog193bJob_env,
        'task_id':'cbog193bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.132',
        'arguments':["--job.name=cbog193bJob", "requestDate="+str(datetime.now()),"procDate=20250103", "magamYn=N", "ofcCd=R01316", "empNo=91348344", "empName=박진수"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('8bd6311271984b7d91a71c4c8838412e')
