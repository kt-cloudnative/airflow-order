...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNG466B',WORKFLOW_ID='0c481d4d95424a0cadaf868626f6d07a', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNG466B-0.4.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('0c481d4d95424a0cadaf868626f6d07a')
    ...
    csng466bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '6a8c2cc41dec41f78f7bac61fb777590',
    ...
    Complete = COMMON.getICISCompleteWflowTask('0c481d4d95424a0cadaf868626f6d07a')
