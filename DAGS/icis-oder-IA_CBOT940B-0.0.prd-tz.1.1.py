...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IA_CBOT940B',WORKFLOW_ID='c4f05a2cd2564688b098ce350d1b531b', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IA_CBOT940B-0.0.prd-tz.1.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('c4f05a2cd2564688b098ce350d1b531b')
    ...
    cbot940bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'b3409bee10b248c4b197f0aa1b26f4f7',
    ...
    Complete = COMMON.getICISCompleteWflowTask('c4f05a2cd2564688b098ce350d1b531b')
