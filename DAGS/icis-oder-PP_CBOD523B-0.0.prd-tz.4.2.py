...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD523B',WORKFLOW_ID='b3f5f2f19c2a4d49ab44b211f227841f', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD523B-0.0.prd-tz.4.2'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('b3f5f2f19c2a4d49ab44b211f227841f')
    ...
    cbod523bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '0e398e4889134e268a3827d50c9a1d22',
    ...
    Complete = COMMON.getICISCompleteWflowTask('b3f5f2f19c2a4d49ab44b211f227841f')
