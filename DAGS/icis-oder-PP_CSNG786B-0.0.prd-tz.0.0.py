...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG786B',WORKFLOW_ID='9cfed270527c42a39f76b3031700a279', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG786B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('9cfed270527c42a39f76b3031700a279')
    ...
    csng786bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'e8864e822b584a70b6d6f1e8bf04a256',
    ...
    Complete = COMMON.getICISCompleteWflowTask('9cfed270527c42a39f76b3031700a279')
