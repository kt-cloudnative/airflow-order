...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD117B',WORKFLOW_ID='d533e398736b43f78ecd232abcac2757', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD117B-0.0.prd-tz.3.5'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('d533e398736b43f78ecd232abcac2757')
    ...
    cbod117bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '51e18b17e11e42e0b0a9c1ceb39f7bea',
        'volumes': cbod117bJob_vol,
        'volume_mounts': cbod117bJob_volMnt,
        'env_from':cbod117bJob_env,
        'task_id':'cbod117bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=cbod117bJob", "endTranDate=20240430", "fromTime=14","toTime=24" , "requestDate=${YYYYMMDDHHMISS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('d533e398736b43f78ecd232abcac2757')
