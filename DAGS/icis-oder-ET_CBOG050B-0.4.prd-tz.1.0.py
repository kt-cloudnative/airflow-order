...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CBOG050B',WORKFLOW_ID='72faefc899f341a5b0bb3fc5dcaaea0a', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CBOG050B-0.4.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('72faefc899f341a5b0bb3fc5dcaaea0a')
    ...
    cbog050bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '904b70de449a4e19b2af1f207237632f',
    ...
    Complete = COMMON.getICISCompleteWflowTask('72faefc899f341a5b0bb3fc5dcaaea0a')
