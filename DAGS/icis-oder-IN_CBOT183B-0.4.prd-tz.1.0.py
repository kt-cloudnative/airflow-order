...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IN_CBOT183B',WORKFLOW_ID='85e74e2e834443858308f5a18b30b9d0', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IN_CBOT183B-0.4.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('85e74e2e834443858308f5a18b30b9d0')
    ...
    cbot183bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'aa377c90f7784dcfa9e1fe008c3fe27d',
    ...
    Complete = COMMON.getICISCompleteWflowTask('85e74e2e834443858308f5a18b30b9d0')
