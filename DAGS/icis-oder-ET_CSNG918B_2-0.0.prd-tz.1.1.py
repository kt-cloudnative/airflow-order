...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNG918B_2',WORKFLOW_ID='8fa3bc3e1c274e698148877ac23fe90c', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNG918B_2-0.0.prd-tz.1.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('8fa3bc3e1c274e698148877ac23fe90c')
    ...
    csng918bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '82058ec42eea4bccbda78c4c985ff942',
    ...
    Complete = COMMON.getICISCompleteWflowTask('8fa3bc3e1c274e698148877ac23fe90c')
