...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNB049B_4',WORKFLOW_ID='5ce09311197a40848e6194ccbd9981df', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNB049B_4-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('5ce09311197a40848e6194ccbd9981df')
    ...
    csnb049bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'db24a81758e8478fb1844e63d5e7d50a',
    ...
    Complete = COMMON.getICISCompleteWflowTask('5ce09311197a40848e6194ccbd9981df')
