...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='BI_CSNL400B',WORKFLOW_ID='6d8d7f3f442c41d190ac0955c4847748', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-BI_CSNL400B-0.0.prd-tz.0.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2023, 11, 1, 0, 0, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
    ,'max_active_runs':1
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('6d8d7f3f442c41d190ac0955c4847748')
    ...
    csnl400bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '6741d2e6ebf1464d9f3404022a6af95b',
    ...
    Complete = COMMON.getICISCompleteWflowTask('6d8d7f3f442c41d190ac0955c4847748')
