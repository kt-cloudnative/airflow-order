...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNG462B',WORKFLOW_ID='536b79a7de594a44b657e52e592cddb7', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNG462B-0.4.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('536b79a7de594a44b657e52e592cddb7')
    ...
    csng462bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '980ddca8331e42d2b0d5c08aa3863ab1',
    ...
    Complete = COMMON.getICISCompleteWflowTask('536b79a7de594a44b657e52e592cddb7')
