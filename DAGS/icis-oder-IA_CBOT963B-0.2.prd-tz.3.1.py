...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IA_CBOT963B',WORKFLOW_ID='401cf2c2ba0c45a185f0b049bd4a70f6', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IA_CBOT963B-0.2.prd-tz.3.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('401cf2c2ba0c45a185f0b049bd4a70f6')

    cbot963bJob_vol = []
    cbot963bJob_volMnt = []
    cbot963bJob_vol.append(getVolume('shared-volume','shared-volume'))
    cbot963bJob_volMnt.append(getVolumeMount('shared-volume','/app/order'))
    ...
    cbot963bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'd2f33fd70b31483f925d3b5dd3aaac47',
    ...
    Complete = COMMON.getICISCompleteWflowTask('401cf2c2ba0c45a185f0b049bd4a70f6')
