...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='BI_CBOL411B',WORKFLOW_ID='0201c61290f64451b85d98677136ae0b', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-BI_CBOL411B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('0201c61290f64451b85d98677136ae0b')
    ...
    cbol411bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'd7f965844e9d43b088f04e9a0c4da3ad',
    ...
    Complete = COMMON.getICISCompleteWflowTask('0201c61290f64451b85d98677136ae0b')
