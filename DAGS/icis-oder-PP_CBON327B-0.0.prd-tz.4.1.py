...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON327B',WORKFLOW_ID='0f7982293cb54282a5b861899f5d9899', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON327B-0.0.prd-tz.4.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('0f7982293cb54282a5b861899f5d9899')
    ...
    cbon327bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '9e34791c56c243f5825c65c790e47afe',
        'volumes': cbon327bJob_vol,
        'volume_mounts': cbon327bJob_volMnt,
        'env_from':cbon327bJob_env,
        'task_id':'cbon327bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.5',
        'arguments':["--job.name=cbon327bJob", "endTranDate=${YYYYMMDD}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('0f7982293cb54282a5b861899f5d9899')
