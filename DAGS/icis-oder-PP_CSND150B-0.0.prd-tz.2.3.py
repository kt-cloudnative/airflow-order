...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSND150B',WORKFLOW_ID='160200d7cdc54093a06d033f4e5780cd', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSND150B-0.0.prd-tz.2.3'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('160200d7cdc54093a06d033f4e5780cd')
    ...
    Complete = COMMON.getICISCompleteWflowTask('160200d7cdc54093a06d033f4e5780cd')
