...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON305B',WORKFLOW_ID='3d8fc3dfda8b4407b23bd8d221947caa', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON305B-0.0.prd-tz.4.3'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('3d8fc3dfda8b4407b23bd8d221947caa')
    ...
    cbon305bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '733b6da217434af382a41a1007ea0c83',
        'volumes': cbon305bJob_vol,
        'volume_mounts': cbon305bJob_volMnt,
        'env_from':cbon305bJob_env,
        'task_id':'cbon305bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=cbon305bJob", "endTranDate=20240529", "ver="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('3d8fc3dfda8b4407b23bd8d221947caa')
