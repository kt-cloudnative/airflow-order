...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG505B',WORKFLOW_ID='2b525998a9194e0db5b40f0d8de02818', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG505B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('2b525998a9194e0db5b40f0d8de02818')
    ...
    csng505bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'bd40e0f9173a473ab33ea0972e70c457',
    ...
    Complete = COMMON.getICISCompleteWflowTask('2b525998a9194e0db5b40f0d8de02818')
