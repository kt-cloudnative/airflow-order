...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON302B',WORKFLOW_ID='fe37a3efc5bd4b6eb7912c02297c2d90', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON302B-0.0.prd-tz.6.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 29, 10, 43, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('fe37a3efc5bd4b6eb7912c02297c2d90')
    ...
    cbon302bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '2b97df376b554d4b97f46c23426f0fcf',
...
"endTranDate=20240430"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('fe37a3efc5bd4b6eb7912c02297c2d90')
