...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON311B',WORKFLOW_ID='c14ed1c9c656410ca04cd240c57449e5', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON311B-0.0.prd-tz.4.4'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('c14ed1c9c656410ca04cd240c57449e5')
    ...
    cbon311bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '5e61abfc67a54909873961e03f83567d',
        'volumes': cbon311bJob_vol,
        'volume_mounts': cbon311bJob_volMnt,
        'env_from':cbon311bJob_env,
        'task_id':'cbon311bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=cbon311bJob", "endTranDate=20240530", "ver="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('c14ed1c9c656410ca04cd240c57449e5')
