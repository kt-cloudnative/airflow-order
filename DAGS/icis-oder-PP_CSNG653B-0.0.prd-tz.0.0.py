...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG653B',WORKFLOW_ID='233b8fcc371a423192ba382bdb1612cc', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG653B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('233b8fcc371a423192ba382bdb1612cc')
    ...
    Complete = COMMON.getICISCompleteWflowTask('233b8fcc371a423192ba382bdb1612cc')
