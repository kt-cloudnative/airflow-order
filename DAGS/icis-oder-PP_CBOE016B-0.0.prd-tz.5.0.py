...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOE016B',WORKFLOW_ID='34b6521e727347fcbea6d861b144b728', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOE016B-0.0.prd-tz.5.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('34b6521e727347fcbea6d861b144b728')
    ...
    cboe016bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'cdd84fadda6646b28e917c728fd1e2c9',
...
, "yyyyMm=202411", "svcName=cboe016bJob"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('34b6521e727347fcbea6d861b144b728')
