...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IA_CBOT940B',WORKFLOW_ID='499a4d9722cb409ca4a4c7a578af5480', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IA_CBOT940B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('499a4d9722cb409ca4a4c7a578af5480')
    ...
    cbot940bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'ce4385940fc4489082233237fcd34bf9',
    ...
    Complete = COMMON.getICISCompleteWflowTask('499a4d9722cb409ca4a4c7a578af5480')
