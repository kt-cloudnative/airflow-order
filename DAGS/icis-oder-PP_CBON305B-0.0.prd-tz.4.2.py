...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON305B',WORKFLOW_ID='497233fb900544a7bc9954814991cea3', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON305B-0.0.prd-tz.4.2'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 19, 21, 5, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('497233fb900544a7bc9954814991cea3')
    ...
    cbon305bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '13e96623d2cc40d0964593fde6865c0f',
        'volumes': cbon305bJob_vol,
        'volume_mounts': cbon305bJob_volMnt,
        'env_from':cbon305bJob_env,
        'task_id':'cbon305bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=cbon305bJob", "endTranDate=20240528", "ver="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('497233fb900544a7bc9954814991cea3')
