...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG506B_08',WORKFLOW_ID='e0ae5ef2dbeb4f1185af6ed6cec9f9dd', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG506B_08-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('e0ae5ef2dbeb4f1185af6ed6cec9f9dd')
    ...
    csng506bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '9e5043197730495981ebd2ec1ed28401',
        'volumes': csng506bJob_vol,
        'volume_mounts': csng506bJob_volMnt,
        'env_from':csng506bJob_env,
        'task_id':'csng506bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.132',
        'arguments':["--job.name=csng506bJob", "argv2=0044", "argv3=Y", "requestDate=${YYYYMM}" , "duplPrvnDate=${YYYYMMDDHHMISSSSS}"
],
    ...
    Complete = COMMON.getICISCompleteWflowTask('e0ae5ef2dbeb4f1185af6ed6cec9f9dd')
