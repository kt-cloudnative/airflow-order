...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG632B',WORKFLOW_ID='b2e41edb37f943c19692178c2661653e', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG632B-0.0.prd-tz.5.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('b2e41edb37f943c19692178c2661653e')
    ...
    csng632bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '62d7c0c3d3c845af802b497f67d394e6',
...
,"pgmNm=csng632b"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('b2e41edb37f943c19692178c2661653e')
