...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSND225B',WORKFLOW_ID='aa0e6482a6c74841bbdf27b5f9d05e6f', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSND225B-0.0.prd-tz.3.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('aa0e6482a6c74841bbdf27b5f9d05e6f')
    ...
    csnd225bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '001dfc6202ef4a8cb5938f542405b674',
    ...
    Complete = COMMON.getICISCompleteWflowTask('aa0e6482a6c74841bbdf27b5f9d05e6f')
