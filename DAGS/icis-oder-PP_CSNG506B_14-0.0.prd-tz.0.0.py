...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG506B_14',WORKFLOW_ID='84d2140b4f544106a121a39a7d3c6fa5', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG506B_14-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('84d2140b4f544106a121a39a7d3c6fa5')
    ...
    csng506bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '5a4774aeb86d4d13be24b7d7668e7795',
        'volumes': csng506bJob_vol,
        'volume_mounts': csng506bJob_volMnt,
        'env_from':csng506bJob_env,
        'task_id':'csng506bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.132',
        'arguments':["--job.name=csng506bJob", "argv2=0061", "argv3=Y", "requestDate=${YYYYMM}" , "duplPrvnDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('84d2140b4f544106a121a39a7d3c6fa5')
