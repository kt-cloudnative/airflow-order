...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IA_CBOT972B',WORKFLOW_ID='183c10027a9643f6a274e480a499fcdc', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IA_CBOT972B-0.0.prd-tz.4.1'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2025, 1, 10, 14, 10, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
    ,'max_active_runs': 16
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('183c10027a9643f6a274e480a499fcdc')
    ...
    cbot972bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '893f87e9d051414c9ea6ece5c6da50c0',
    ...
    Complete = COMMON.getICISCompleteWflowTask('183c10027a9643f6a274e480a499fcdc')
