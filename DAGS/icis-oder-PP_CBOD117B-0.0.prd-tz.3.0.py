...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD117B',WORKFLOW_ID='4f31a14c922e45c99c9d2756143a4e16', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD117B-0.0.prd-tz.3.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('4f31a14c922e45c99c9d2756143a4e16')
    ...
    cbod117bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '23fa28deb05b4c6380ab1812857f0528',
    ...
    Complete = COMMON.getICISCompleteWflowTask('4f31a14c922e45c99c9d2756143a4e16')
