...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG110B',WORKFLOW_ID='e5ddbf4ce88740d4ab34adfb231187d7', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG110B-0.1.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('e5ddbf4ce88740d4ab34adfb231187d7')
    ...
    csng110bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'dae87de1d87e462bb770a2eca9cef35c',
        'volumes': csng110bJob_vol,
        'volume_mounts': csng110bJob_volMnt,
        'env_from':csng110bJob_env,
        'task_id':'csng110bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.45',
        'arguments':["--job.name=csng110bJob", "workDay=${YYYYMMDD}", "empNo=91326888", "requestDate="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('e5ddbf4ce88740d4ab34adfb231187d7')
