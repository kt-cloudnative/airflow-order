...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG534B',WORKFLOW_ID='d68ed9d6a2d240dabe560660490e3c53', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG534B-0.0.prd-tz.3.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('d68ed9d6a2d240dabe560660490e3c53')
    ...
    Complete = COMMON.getICISCompleteWflowTask('d68ed9d6a2d240dabe560660490e3c53')
