...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='WC_CBON327B',WORKFLOW_ID='06a212fee17e41ad80be13070156180f', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-WC_CBON327B-0.0.prd-tz.4.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('06a212fee17e41ad80be13070156180f')
    ...
    cbon327bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'bef99478d68d4f59b475f0aeab3faf20',
    ...
    Complete = COMMON.getICISCompleteWflowTask('06a212fee17e41ad80be13070156180f')
