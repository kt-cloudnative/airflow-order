...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG948B_0',WORKFLOW_ID='a8186205beb8425aa7888b8ced10555f', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG948B_0-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('a8186205beb8425aa7888b8ced10555f')
    ...
    csng948bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '7995ff936f614ef88dadc0de1c179cad',
        'volumes': csng948bJob_vol,
        'volume_mounts': csng948bJob_volMnt,
        'env_from':csng948bJob_env,
        'task_id':'csng948bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.5',
        'arguments':["--job.name=csng948bJob", "applyDate=${YYYYMM}", "saIdSecEnum=0"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('a8186205beb8425aa7888b8ced10555f')
