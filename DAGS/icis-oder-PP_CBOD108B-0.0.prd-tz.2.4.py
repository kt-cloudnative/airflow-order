...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD108B',WORKFLOW_ID='af60eb34b748421b83928bd73e2fa484', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD108B-0.0.prd-tz.2.4'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('af60eb34b748421b83928bd73e2fa484')
    ...
    cbod108bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '9bbe2a97d21e473bb6bc2059f45d4429',
        'volumes': cbod108bJob_vol,
        'volume_mounts': cbod108bJob_volMnt,
        'env_from':cbod108bJob_env,
        'task_id':'cbod108bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=cbod108bJob", "workDate=20240530", "saveSaId=11778599831","saveOrdNo=23002AT03694092",  "requestDate="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('af60eb34b748421b83928bd73e2fa484')
