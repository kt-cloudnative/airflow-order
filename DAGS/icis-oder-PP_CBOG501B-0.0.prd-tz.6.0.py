...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOG501B',WORKFLOW_ID='50a26447e8934b83809c143b585db983', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOG501B-0.0.prd-tz.6.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('50a26447e8934b83809c143b585db983')
    ...
    cbog501bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '6dd2c4518828433f82be0152fcc60a85',
        'volumes': cbog501bJob_vol,
        'volume_mounts': cbog501bJob_volMnt,
        'env_from':cbog501bJob_env,
        'task_id':'cbog501bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=cbog501bJob", "mainArgDate=20240430" , "requestDate="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('50a26447e8934b83809c143b585db983')
