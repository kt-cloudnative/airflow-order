...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNB049B_3',WORKFLOW_ID='fa4b605e6f5b438393256495517eaf58', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNB049B_3-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('fa4b605e6f5b438393256495517eaf58')
    ...
    csnb049bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '313c44af475d4be298cbfae926ce8186',
        ...
        'arguments':["--job.name=csnb049bJob", "workYm=${YYYYMM}", "workGb=3", "regEmpNo=91108904", "date=${YYYYMMDDHHMISS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('fa4b605e6f5b438393256495517eaf58')
