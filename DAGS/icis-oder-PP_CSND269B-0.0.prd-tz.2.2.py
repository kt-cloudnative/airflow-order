...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSND269B',WORKFLOW_ID='9177dc08e5dc4bb3b18d5ed231ba27e5', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSND269B-0.0.prd-tz.2.2'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('9177dc08e5dc4bb3b18d5ed231ba27e5')
    ...
    csnd269bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'eb2bce7544ac47f8b2bc99e2eea76e8d',
    ...
    Complete = COMMON.getICISCompleteWflowTask('9177dc08e5dc4bb3b18d5ed231ba27e5')
