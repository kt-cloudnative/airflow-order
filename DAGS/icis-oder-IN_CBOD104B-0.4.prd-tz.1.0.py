...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IN_CBOD104B',WORKFLOW_ID='a2b4474d551e4a8f86c1f36ed8348c8d', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IN_CBOD104B-0.4.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('a2b4474d551e4a8f86c1f36ed8348c8d')
    ...
    cbod104bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '8496ffb1eaf2440c9f1affe20608d496',
    ...
    Complete = COMMON.getICISCompleteWflowTask('a2b4474d551e4a8f86c1f36ed8348c8d')
