...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON302B',WORKFLOW_ID='a14b9f6850e94849850bd21c6e24ca18', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON302B-0.0.prd-tz.5.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 22, 14, 43, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('a14b9f6850e94849850bd21c6e24ca18')
    ...
    cbon302bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '4bdd755ce695465eb3dd11c3b5704630',
...
"endTranDate=20240530"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('a14b9f6850e94849850bd21c6e24ca18')
