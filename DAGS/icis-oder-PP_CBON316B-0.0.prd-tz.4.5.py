...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON316B',WORKFLOW_ID='18a6440ec8b84e1e9c9836d401b405e6', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON316B-0.0.prd-tz.4.5'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('18a6440ec8b84e1e9c9836d401b405e6')
    ...
    cbon316bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'e298b59c264044f287c4fd595c5bddf7',
        'volumes': cbon316bJob_vol,
        'volume_mounts': cbon316bJob_volMnt,
        'env_from':cbon316bJob_env,
        'task_id':'cbon316bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=cbon316bJob", "endTranDate=20240430", "ver="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('18a6440ec8b84e1e9c9836d401b405e6')
