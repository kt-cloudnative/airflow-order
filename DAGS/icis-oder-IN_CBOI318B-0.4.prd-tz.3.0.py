...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IN_CBOI318B',WORKFLOW_ID='1b3905db6f734effa69f420266e4a778', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IN_CBOI318B-0.4.prd-tz.3.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('1b3905db6f734effa69f420266e4a778')
    ...
    cboi318bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '5ddc2c6a00014fafabca1e409c6c3317',
    ...
    Complete = COMMON.getICISCompleteWflowTask('1b3905db6f734effa69f420266e4a778')
