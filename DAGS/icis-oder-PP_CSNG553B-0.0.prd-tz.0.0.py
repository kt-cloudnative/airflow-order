...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG553B',WORKFLOW_ID='3446aadaf01e452a9b4d4a41ad2da032', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG553B-0.0.prd-tz.0.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 1, 18, 0, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
    ,'max_active_runs':1
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('3446aadaf01e452a9b4d4a41ad2da032')
    ...
    csng553bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '03c46ffedc7348358fd6cd1b8561d5e8',
...
"date=${YYYYMMDDHHMISS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('3446aadaf01e452a9b4d4a41ad2da032')
