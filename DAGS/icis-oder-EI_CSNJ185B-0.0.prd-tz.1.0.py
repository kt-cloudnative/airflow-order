...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='EI_CSNJ185B',WORKFLOW_ID='22eb252f5f324e36858e98eddac1af6c', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-EI_CSNJ185B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('22eb252f5f324e36858e98eddac1af6c')
    ...
    csnj185bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'd47095303ba9422e99de6ce849824a51',
    ...
    Complete = COMMON.getICISCompleteWflowTask('22eb252f5f324e36858e98eddac1af6c')
