...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IA_CBOT935B',WORKFLOW_ID='620e12a2752341cb89446d96bb612b30', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IA_CBOT935B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('620e12a2752341cb89446d96bb612b30')
    ...
    cbot935bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '901ebd36421844999de22619e98147a7',
    ...
    Complete = COMMON.getICISCompleteWflowTask('620e12a2752341cb89446d96bb612b30')
