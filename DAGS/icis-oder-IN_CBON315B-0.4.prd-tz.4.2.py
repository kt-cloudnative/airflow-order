...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IN_CBON315B',WORKFLOW_ID='3b65702ea78a4e009bcefbaff3b988b5', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IN_CBON315B-0.4.prd-tz.4.2'
    ,'schedule_interval':'None'
    ,'start_date': datetime(2025, 1, 13, 18, 36, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
    ,'max_active_runs': 16
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('3b65702ea78a4e009bcefbaff3b988b5')
    ...
    cbon315bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'f6edda7456fd4e849e7f014268ff022b',
        ...
        'arguments':["--job.name=cbon315bJob", "endTranDate=20241129", "ofcCd=710571", "date=${YYYYMMDDHHMISS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('3b65702ea78a4e009bcefbaff3b988b5')
