...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='WC_CBOL207B',WORKFLOW_ID='72c058d80b8d46f59cf83ec43b9ca3dc', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-WC_CBOL207B-0.0.prd-tz.3.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('72c058d80b8d46f59cf83ec43b9ca3dc')
    ...
    cbol207bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '204d9af6885d426685d63683a5ccab01',
    ...
    Complete = COMMON.getICISCompleteWflowTask('72c058d80b8d46f59cf83ec43b9ca3dc')
