...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD202B',WORKFLOW_ID='53cb0e2dc5604c79b45e7ee01f0ef594', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD202B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('53cb0e2dc5604c79b45e7ee01f0ef594')
    ...
    cbod202bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '5c3719f6dd584e649d0de9b8e3e7cc5b',
        'volumes': cbod202bJob_vol,
        'volume_mounts': cbod202bJob_volMnt,
        'env_from':cbod202bJob_env,
        'task_id':'cbod202bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.45',
        'arguments':["--job.name=cbod202bJob", "endTranDate=20241017", "fromTime=09", "toTime=09", "requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('53cb0e2dc5604c79b45e7ee01f0ef594')
