...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='WC_CBON330B',WORKFLOW_ID='e48c33c0989c4ce0927ff481191ca520', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-WC_CBON330B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('e48c33c0989c4ce0927ff481191ca520')
    ...
    cbon330bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '6348f93aa75144469568f11ca0c1e1ae',
        ...
        'arguments':["--job.name=cbon330bJob", "workDate=${YYYYMMDD}", "testBatchRequestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('e48c33c0989c4ce0927ff481191ca520')
