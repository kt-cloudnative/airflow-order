...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON327B',WORKFLOW_ID='84e6dde9d79f4381b625abe2862b679a', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON327B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('84e6dde9d79f4381b625abe2862b679a')
    ...
    Complete = COMMON.getICISCompleteWflowTask('84e6dde9d79f4381b625abe2862b679a')
