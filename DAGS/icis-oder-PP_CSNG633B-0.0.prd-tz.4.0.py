...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG633B',WORKFLOW_ID='5f9680df5ac54f7ab5642f8a6cdd14b1', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG633B-0.0.prd-tz.4.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('5f9680df5ac54f7ab5642f8a6cdd14b1')
    ...
    csng633bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '8105d0ab43cd430f9548b9aa66767c23',
...
, "pgmNm=csng633b" ],
    ...
    Complete = COMMON.getICISCompleteWflowTask('5f9680df5ac54f7ab5642f8a6cdd14b1')
