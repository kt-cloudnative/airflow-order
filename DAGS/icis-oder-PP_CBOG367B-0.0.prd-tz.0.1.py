...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOG367B',WORKFLOW_ID='950a5cb319314b7a8f43834e2c114a2f', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOG367B-0.0.prd-tz.0.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('950a5cb319314b7a8f43834e2c114a2f')
    ...
    cbog367bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '3531759570fa4d7cba34d2aaf72fb002',
    ...
    Complete = COMMON.getICISCompleteWflowTask('950a5cb319314b7a8f43834e2c114a2f')
