...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD703B',WORKFLOW_ID='06695e4685c24dff83b51775ff5d3b8f', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD703B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('06695e4685c24dff83b51775ff5d3b8f')
    ...
    cbod703bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'b3b108193e8f40409990497beba032bc',
        'volumes': cbod703bJob_vol,
        'volume_mounts': cbod703bJob_volMnt,
        'env_from':cbod703bJob_env,
        'task_id':'cbod703bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.19',
        'arguments':["--job.name=cbod703bJob" , "endTranDate=20240801","trdDay=202408","requestDate=${YYYYMMDDHHMISS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('06695e4685c24dff83b51775ff5d3b8f')
