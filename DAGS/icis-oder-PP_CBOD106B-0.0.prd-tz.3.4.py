...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD106B',WORKFLOW_ID='97b93497b9014986b59fc98e9ee2f59c', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD106B-0.0.prd-tz.3.4'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('97b93497b9014986b59fc98e9ee2f59c')
    ...
    cbod106bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '9f165ac2521340a182258abba226413a',
        'volumes': cbod106bJob_vol,
        'volume_mounts': cbod106bJob_volMnt,
        'env_from':cbod106bJob_env,
        'task_id':'cbod106bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=cbod106bJob", "workDate=20240530", "saveSaId=24994981504","saveOrdNo=24268GH21545893", "requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('97b93497b9014986b59fc98e9ee2f59c')
