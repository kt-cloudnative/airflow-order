...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IC_CSNJ922B',WORKFLOW_ID='b2b60c49160344ba956291ae7e96fa5d', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IC_CSNJ922B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('b2b60c49160344ba956291ae7e96fa5d')
    ...
    csnj922bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '4a58ce937b1642f7b22ed69ca53a2814',
    ...
    Complete = COMMON.getICISCompleteWflowTask('b2b60c49160344ba956291ae7e96fa5d')
