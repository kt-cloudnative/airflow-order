...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG552B',WORKFLOW_ID='db20c4ab4f5541809ca292030a8a7cfd', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG552B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('db20c4ab4f5541809ca292030a8a7cfd')
    ...
    Complete = COMMON.getICISCompleteWflowTask('db20c4ab4f5541809ca292030a8a7cfd')
