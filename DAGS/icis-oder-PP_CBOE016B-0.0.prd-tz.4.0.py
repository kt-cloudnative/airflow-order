...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOE016B',WORKFLOW_ID='45f361cf5e4044c8a2dce3a0137cfd3b', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOE016B-0.0.prd-tz.4.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('45f361cf5e4044c8a2dce3a0137cfd3b')
    ...
    cboe016bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '2b56feefeadf40c0a579279d50a5e561',
...
, "yyyyMm=202411", "svcName=cboe016bJob"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('45f361cf5e4044c8a2dce3a0137cfd3b')
