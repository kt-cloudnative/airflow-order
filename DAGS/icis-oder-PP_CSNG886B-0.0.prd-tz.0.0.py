...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG886B',WORKFLOW_ID='42f7d318cd014fde9a4b3ccdfe7a14fb', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG886B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('42f7d318cd014fde9a4b3ccdfe7a14fb')
    ...
    csng886bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '7dfbce45dac54bcfa6a48ed1c88b5a0c',
...
"endTranDate=20220516"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('42f7d318cd014fde9a4b3ccdfe7a14fb')
