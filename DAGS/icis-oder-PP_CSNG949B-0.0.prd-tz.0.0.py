...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG949B',WORKFLOW_ID='2b6e1bba860148e88326c2f492faec22', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG949B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('2b6e1bba860148e88326c2f492faec22')
    ...
    csng949bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'd9e4392937e4480382ee0933e17fd3c9',
...
"date="+str(datetime.now().strftime("%Y%m%d%H%M%S"))],
    ...
    Complete = COMMON.getICISCompleteWflowTask('2b6e1bba860148e88326c2f492faec22')
