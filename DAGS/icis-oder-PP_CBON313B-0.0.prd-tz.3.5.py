...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON313B',WORKFLOW_ID='e9994dd683594a12bbe2bfca581cfa34', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON313B-0.0.prd-tz.3.5'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('e9994dd683594a12bbe2bfca581cfa34')
    ...
    cbon313bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'e656bdb3f27544ae8a736cb70eefddf0',
        'volumes': cbon313bJob_vol,
        'volume_mounts': cbon313bJob_volMnt,
        'env_from':cbon313bJob_env,
        'task_id':'cbon313bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=cbon313bJob","endTranDate=20240430","requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('e9994dd683594a12bbe2bfca581cfa34')
