...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNG918B_5',WORKFLOW_ID='672b63ecdab04867ab075d4fe5978bb1', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNG918B_5-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('672b63ecdab04867ab075d4fe5978bb1')
    ...
    csng918bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '360431297fbb48d794934f14f210a074',
    ...
    Complete = COMMON.getICISCompleteWflowTask('672b63ecdab04867ab075d4fe5978bb1')
