...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNG918B_1',WORKFLOW_ID='7d0a5563e1034573b1e2dcc4dceed743', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNG918B_1-0.0.prd-tz.1.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('7d0a5563e1034573b1e2dcc4dceed743')
    ...
    csng918bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '6d0a85a7936849448e5895eecd90be9a',
        ...
        'arguments':["--job.name=csng918bJob", "invMonth=${YYYYMM}", "subSaId=1", "date=${YYYYMMDDHHMISS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('7d0a5563e1034573b1e2dcc4dceed743')
