...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD523B',WORKFLOW_ID='91cce9cd75b542adbdadb03432e15f05', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD523B-0.0.prd-tz.4.5'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('91cce9cd75b542adbdadb03432e15f05')
    ...
    cbod523bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '2045993bc1ec43aeba23551ed074422c',
        'volumes': cbod523bJob_vol,
        'volume_mounts': cbod523bJob_volMnt,
        'env_from':cbod523bJob_env,
        'task_id':'cbod523bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=cbod523bJob","endTranDate=20240430","requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('91cce9cd75b542adbdadb03432e15f05')
