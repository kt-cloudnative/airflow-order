...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG933B',WORKFLOW_ID='59a316971b9f4aedb7e26354e20d2cef', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG933B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('59a316971b9f4aedb7e26354e20d2cef')
    ...
    csng933bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'e881e57e4d34499a8355d08fb87f12a1',
    ...
    Complete = COMMON.getICISCompleteWflowTask('59a316971b9f4aedb7e26354e20d2cef')
