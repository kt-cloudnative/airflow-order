...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD201B',WORKFLOW_ID='823e1c6edd514982ade70ecb5149ec16', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD201B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('823e1c6edd514982ade70ecb5149ec16')
    ...
    cbod201bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '51456c62a8fb40b69cb4ba60a318fdb2',
        'volumes': cbod201bJob_vol,
        'volume_mounts': cbod201bJob_volMnt,
        'env_from':cbod201bJob_env,
        'task_id':'cbod201bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.5',
        'arguments':["--job.name=cbod201bJob", "endTranDate=20241201", "empNo=952794853", "requestDate="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('823e1c6edd514982ade70ecb5149ec16')
