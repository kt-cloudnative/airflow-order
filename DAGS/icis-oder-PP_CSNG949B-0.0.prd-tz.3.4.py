...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG949B',WORKFLOW_ID='1e8ae7398c5c49a782eb9092f018c62e', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG949B-0.0.prd-tz.3.4'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('1e8ae7398c5c49a782eb9092f018c62e')
    ...
    csng949bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '0117acc354334e79b350c45a74c61ce6',
...
"date="+str(datetime.now().strftime("%Y%m%d%H%M%S"))],
    ...
    Complete = COMMON.getICISCompleteWflowTask('1e8ae7398c5c49a782eb9092f018c62e')
