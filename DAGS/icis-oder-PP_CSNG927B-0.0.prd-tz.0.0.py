...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG927B',WORKFLOW_ID='84d8e01b11a547c98818f8106a908ca4', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG927B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('84d8e01b11a547c98818f8106a908ca4')
    ...
    csng927bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'f9ff4974fcd74f5c805d855dfb3720d2',
        'volumes': csng927bJob_vol,
        'volume_mounts': csng927bJob_volMnt,
        'env_from':csng927bJob_env,
        'task_id':'csng927bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.5',
        'arguments':["--job.name=csng927bJob", "duplPrvnDate=${YYYYMMDDHHMISSSSS}", "tranDate=${YYYYMMDD}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('84d8e01b11a547c98818f8106a908ca4')
