...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG646B',WORKFLOW_ID='3de90da00ee449fab6f84a5af6707a40', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG646B-0.0.prd-tz.2.3'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('3de90da00ee449fab6f84a5af6707a40')
    ...
    Complete = COMMON.getICISCompleteWflowTask('3de90da00ee449fab6f84a5af6707a40')
