...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON316B',WORKFLOW_ID='7e9a521bec674d22a8824f71f5d3eef2', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON316B-0.0.prd-tz.4.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('7e9a521bec674d22a8824f71f5d3eef2')
    ...
    cbon316bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '79e28e43cf8143b2873c5f4559b00371',
        'volumes': cbon316bJob_vol,
        'volume_mounts': cbon316bJob_volMnt,
        'env_from':cbon316bJob_env,
        'task_id':'cbon316bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=cbon316bJob", "endTranDate=20240628", "ver="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('7e9a521bec674d22a8824f71f5d3eef2')
