...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CBOD460B',WORKFLOW_ID='c9318ac7013445f3a5d901c844f34004', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CBOD460B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('c9318ac7013445f3a5d901c844f34004')
    ...
    cbod460bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '1da6871e3daf41768d5a1c41e175715b',
    ...
    Complete = COMMON.getICISCompleteWflowTask('c9318ac7013445f3a5d901c844f34004')
