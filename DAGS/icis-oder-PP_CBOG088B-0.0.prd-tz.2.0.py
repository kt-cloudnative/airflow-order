...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOG088B',WORKFLOW_ID='43dc9f6ec4574b4a8ba8246f868e2d15', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOG088B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('43dc9f6ec4574b4a8ba8246f868e2d15')
    ...
    cbog088bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '4438c7d1a3404a5e96234f5d516c97f5',
    ...
    Complete = COMMON.getICISCompleteWflowTask('43dc9f6ec4574b4a8ba8246f868e2d15')
