...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSND176B',WORKFLOW_ID='ff9735e03aa44cecaf2252b3d154ff72', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSND176B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('ff9735e03aa44cecaf2252b3d154ff72')
    ...
    csnd176bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '0489bc4cd0724dd19b80e618da01e205',
    ...
    Complete = COMMON.getICISCompleteWflowTask('ff9735e03aa44cecaf2252b3d154ff72')
