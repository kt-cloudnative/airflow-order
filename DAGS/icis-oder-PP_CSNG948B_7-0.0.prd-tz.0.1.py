...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG948B_7',WORKFLOW_ID='97eb254a835f451493dcbb678aa1a1e6', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG948B_7-0.0.prd-tz.0.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('97eb254a835f451493dcbb678aa1a1e6')
    ...
    csng948bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'c787d5c55683495d9d7a5eaba07d4879',
        'volumes': csng948bJob_vol,
        'volume_mounts': csng948bJob_volMnt,
        'env_from':csng948bJob_env,
        'task_id':'csng948bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.5',
        'arguments':["--job.name=csng948bJob", "applyDate=${YYYYMM}", "saIdSecEnum=7"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('97eb254a835f451493dcbb678aa1a1e6')
