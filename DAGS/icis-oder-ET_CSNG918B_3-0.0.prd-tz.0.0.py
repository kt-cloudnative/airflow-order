...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNG918B_3',WORKFLOW_ID='0be059f09444485a8c05e1475c682ee2', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNG918B_3-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('0be059f09444485a8c05e1475c682ee2')
    ...
    csng918bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'eb248cb063234d23b88c679d61b1a9d2',
    ...
    Complete = COMMON.getICISCompleteWflowTask('0be059f09444485a8c05e1475c682ee2')
