...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSND169B',WORKFLOW_ID='195e33b809ea425992fcddb93fcb7060', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSND169B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('195e33b809ea425992fcddb93fcb7060')
    ...
    csnd169bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'dca89dba2b0443049a2585405893e62f',
    ...
    Complete = COMMON.getICISCompleteWflowTask('195e33b809ea425992fcddb93fcb7060')
