...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOE559B',WORKFLOW_ID='27d083111a4641d8ab0d7aac47c16ed6', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOE559B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('27d083111a4641d8ab0d7aac47c16ed6')
    ...
    cboe559bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '69afb7c7089d48159634805e0d2db107',
    ...
    Complete = COMMON.getICISCompleteWflowTask('27d083111a4641d8ab0d7aac47c16ed6')
