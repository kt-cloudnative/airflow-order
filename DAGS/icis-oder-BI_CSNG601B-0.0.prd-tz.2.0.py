...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='BI_CSNG601B',WORKFLOW_ID='ca4dfb2d15cc45c29f3c7a666080fb38', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-BI_CSNG601B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('ca4dfb2d15cc45c29f3c7a666080fb38')
    ...
    csng601bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '56793481080c4127a6192693d22d5cc2',
    ...
    Complete = COMMON.getICISCompleteWflowTask('ca4dfb2d15cc45c29f3c7a666080fb38')
