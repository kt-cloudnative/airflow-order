...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNB049B_5',WORKFLOW_ID='2b5c5adb33bf49ac97a10e613cf9ecf1', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNB049B_5-0.0.prd-tz.1.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('2b5c5adb33bf49ac97a10e613cf9ecf1')
    ...
    csnb049bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'ad3e1bf101004e06933981aa949ac47a',
    ...
    Complete = COMMON.getICISCompleteWflowTask('2b5c5adb33bf49ac97a10e613cf9ecf1')
