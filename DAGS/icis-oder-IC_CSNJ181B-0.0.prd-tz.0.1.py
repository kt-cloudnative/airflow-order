...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IC_CSNJ181B',WORKFLOW_ID='c2e420fdaccd43849dbf3463091933ba', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IC_CSNJ181B-0.0.prd-tz.0.1'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2025, 1, 14, 11, 10, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
    ,'max_active_runs':1
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('c2e420fdaccd43849dbf3463091933ba')
    ...
    csnj181bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'd601031c711949f98d9b522f0a56efe6',
        ...
        'arguments':["--job.name=csnj181bJob", "reqDate=${YYYYMMDDHHMISS}", "procDate=20241127"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('c2e420fdaccd43849dbf3463091933ba')
