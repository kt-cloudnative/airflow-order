...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='EI_CBOT315B',WORKFLOW_ID='3b318acabcff4322982acd8b4f89b304', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-EI_CBOT315B-0.0.prd-tz.2.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('3b318acabcff4322982acd8b4f89b304')
    ...
    cbot315bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '94c97d9b98224fb9a5eb280cd5f91284',
    ...
    cbod445bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '8675db15a0c14251b217928b22853b57',
    ...
    Complete = COMMON.getICISCompleteWflowTask('3b318acabcff4322982acd8b4f89b304')
