...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNB049B_9',WORKFLOW_ID='dab593bf7c324ae28fa52a8c0706a9d4', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNB049B_9-0.0.prd-tz.1.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('dab593bf7c324ae28fa52a8c0706a9d4')
    ...
    csnb049bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'ff7b787fdb69479a9b62518cd9e2343a',
    ...
    Complete = COMMON.getICISCompleteWflowTask('dab593bf7c324ae28fa52a8c0706a9d4')
