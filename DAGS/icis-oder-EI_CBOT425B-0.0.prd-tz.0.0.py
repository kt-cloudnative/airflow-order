...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='EI_CBOT425B',WORKFLOW_ID='a10c509094704837bea013f954d961e7', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-EI_CBOT425B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('a10c509094704837bea013f954d961e7')
    ...
    cbot425bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '12e05cbd0ba14c0c843f5fc6a5e100de',
    ...
    Complete = COMMON.getICISCompleteWflowTask('a10c509094704837bea013f954d961e7')
