...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IN_CBOI889B',WORKFLOW_ID='c8e772e48fd7431b8d4e88ce78accaf7', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IN_CBOI889B-0.4.prd-tz.1.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('c8e772e48fd7431b8d4e88ce78accaf7')
    ...
    cboi889bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '554e0edb4afc48aebda1629abba4fb0b',
    ...
    Complete = COMMON.getICISCompleteWflowTask('c8e772e48fd7431b8d4e88ce78accaf7')
