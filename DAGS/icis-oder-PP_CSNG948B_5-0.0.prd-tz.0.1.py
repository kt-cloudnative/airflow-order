...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG948B_5',WORKFLOW_ID='3fe6ec82ecc04bc0b62d867031686d55', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG948B_5-0.0.prd-tz.0.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('3fe6ec82ecc04bc0b62d867031686d55')
    ...
    csng948bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '808f30a7da3a4884a6357e3ddec7e458',
        'volumes': csng948bJob_vol,
        'volume_mounts': csng948bJob_volMnt,
        'env_from':csng948bJob_env,
        'task_id':'csng948bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.5',
        'arguments':["--job.name=csng948bJob", "applyDate=${YYYYMM}", "saIdSecEnum=5"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('3fe6ec82ecc04bc0b62d867031686d55')
