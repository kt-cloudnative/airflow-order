...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON316B',WORKFLOW_ID='0fad7ca466b540028280f8eefcf7ad45', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON316B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('0fad7ca466b540028280f8eefcf7ad45')
    ...
    Complete = COMMON.getICISCompleteWflowTask('0fad7ca466b540028280f8eefcf7ad45')
