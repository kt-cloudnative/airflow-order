...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNG918B_4',WORKFLOW_ID='a3cc1c218d844e6ebe6cb67524f60d72', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNG918B_4-0.0.prd-tz.0.0'
    ,'schedule_interval':'None'
    ,'start_date': datetime(2025, 1, 10, 10, 49, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
    ,'max_active_runs':1
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('a3cc1c218d844e6ebe6cb67524f60d72')
    ...
    csng918bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '176a18fd7cc64433b73f0968559a6aae',
        ...
        'arguments':["--job.name=csng918bJob", "invMonth=${YYYYMM}", "subSaId=4", "date=${YYYYMMDDHHMISS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('a3cc1c218d844e6ebe6cb67524f60d72')
