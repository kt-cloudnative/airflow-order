...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSND151B',WORKFLOW_ID='aa4e61aa6b13403a9efc50adcf0065f5', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSND151B-0.0.prd-tz.0.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('aa4e61aa6b13403a9efc50adcf0065f5')
    ...
    Complete = COMMON.getICISCompleteWflowTask('aa4e61aa6b13403a9efc50adcf0065f5')
