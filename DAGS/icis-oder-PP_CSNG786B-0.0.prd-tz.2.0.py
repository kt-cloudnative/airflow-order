...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG786B',WORKFLOW_ID='62f619372b2d49349d9b6004032be02f', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG786B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('62f619372b2d49349d9b6004032be02f')
    ...
    csng786bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '71cc72ef83084b9cb384caa1103f73be',
    ...
    Complete = COMMON.getICISCompleteWflowTask('62f619372b2d49349d9b6004032be02f')
