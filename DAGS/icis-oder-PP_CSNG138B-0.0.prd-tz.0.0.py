...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG138B',WORKFLOW_ID='4eb119f251e4457e91e3f26e5dd7fb87', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG138B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('4eb119f251e4457e91e3f26e5dd7fb87')
    ...
    csng138bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'bc3e0e20b2e6455ea07cbcd3357bd6f6',
    ...
    Complete = COMMON.getICISCompleteWflowTask('4eb119f251e4457e91e3f26e5dd7fb87')
