...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD429B',WORKFLOW_ID='59dbca600e934fa8a0cd725b0bbcd844', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD429B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('59dbca600e934fa8a0cd725b0bbcd844')
    ...
    cbod429bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '7e390c5bc17d4fd08cd45bc80d899e1d',
        'volumes': cbod429bJob_vol,
        'volume_mounts': cbod429bJob_volMnt,
        'env_from':cbod429bJob_env,
        'task_id':'cbod429bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.7',
        'arguments':["--job.name=cbod429bJob", "endTranDate=20241129", "requestDate="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('59dbca600e934fa8a0cd725b0bbcd844')
