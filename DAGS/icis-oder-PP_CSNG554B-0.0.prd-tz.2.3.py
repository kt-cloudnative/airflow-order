...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG554B',WORKFLOW_ID='fba34cf070d1446abbd4a6e1429fd627', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG554B-0.0.prd-tz.2.3'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('fba34cf070d1446abbd4a6e1429fd627')
    ...
    Complete = COMMON.getICISCompleteWflowTask('fba34cf070d1446abbd4a6e1429fd627')
