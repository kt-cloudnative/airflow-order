...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNB049B_4',WORKFLOW_ID='ca5bfbd400e443b7bd60149e07036eae', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNB049B_4-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('ca5bfbd400e443b7bd60149e07036eae')
    ...
    csnb049bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'a0a63812db7d4b609744341491018538',
    ...
    Complete = COMMON.getICISCompleteWflowTask('ca5bfbd400e443b7bd60149e07036eae')
