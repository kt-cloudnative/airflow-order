...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG941B',WORKFLOW_ID='1b3a651504874bdb8850e7946fba872f', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG941B-0.0.prd-tz.5.1'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 29, 11, 7, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('1b3a651504874bdb8850e7946fba872f')
    ...
    csng941bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'c11fd25a09784567ba827d863a656c68',
        'volumes': csng941bJob_vol,
        'volume_mounts': csng941bJob_volMnt,
        'env_from':csng941bJob_env,
        'task_id':'csng941bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=csng941bJob", "endTranDate=20240430", "requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('1b3a651504874bdb8850e7946fba872f')
