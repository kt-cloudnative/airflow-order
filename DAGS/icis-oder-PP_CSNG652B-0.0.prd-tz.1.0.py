...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG652B',WORKFLOW_ID='de2eacce2bdb42b8a5ea20bb9f7cc34a', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG652B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('de2eacce2bdb42b8a5ea20bb9f7cc34a')

    csng652bJob_vol = []
    csng652bJob_volMnt = []
    csng652bJob_vol.append(getVolume('shared-volume','shared-volume'))
    csng652bJob_volMnt.append(getVolumeMount('shared-volume',''))
    ...
    csng652bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '6a9f8ecbea4841a8bfe817ffbe33b562',
        'volumes': csng652bJob_vol,
        'volume_mounts': csng652bJob_volMnt,
        'env_from':csng652bJob_env,
        'task_id':'csng652bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.57',
        'arguments':["--job.name=csng652bJob","fromDate=20240628", "toDate=20240628", "ver="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('de2eacce2bdb42b8a5ea20bb9f7cc34a')
