...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG506B_13',WORKFLOW_ID='0444415d01384ffc86603deb28755f93', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG506B_13-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('0444415d01384ffc86603deb28755f93')
    ...
    csng506bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '58971b57b62a4066aabafd1f5c073382',
        'volumes': csng506bJob_vol,
        'volume_mounts': csng506bJob_volMnt,
        'env_from':csng506bJob_env,
        'task_id':'csng506bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.132',
        'arguments':["--job.name=csng506bJob", "argv2=0055", "argv3=Y", "requestDate=${YYYYMM}" , "duplPrvnDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('0444415d01384ffc86603deb28755f93')
