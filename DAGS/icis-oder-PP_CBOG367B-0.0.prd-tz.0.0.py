...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOG367B',WORKFLOW_ID='516ebd59a3384e61bff50f4069dccc25', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOG367B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('516ebd59a3384e61bff50f4069dccc25')
    ...
    cbog367bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '003428cde505400dacc0960c06677d5a',
        'volumes': cbog367bJob_vol,
        'volume_mounts': cbog367bJob_volMnt,
        'env_from':cbog367bJob_env,
        'task_id':'cbog367bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.45',
        'arguments':["--job.name=cbog367bJob","requestDate="+str(datetime.now().strftime("%Y%m%d")),"duplPrvnDate="+str(datetime.now().strftime("%Y%m%d%H%M%S"))],
    ...
    Complete = COMMON.getICISCompleteWflowTask('516ebd59a3384e61bff50f4069dccc25')
