...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD117B',WORKFLOW_ID='44b395229e714a48b2a979706b80d69b', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD117B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('44b395229e714a48b2a979706b80d69b')
    ...
    cbod117bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'a01e16f1f8e74a0fb5f90dab7f3aaf01',
        'volumes': cbod117bJob_vol,
        'volume_mounts': cbod117bJob_volMnt,
        'env_from':cbod117bJob_env,
        'task_id':'cbod117bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.45',
        'arguments':["--job.name=cbod117bJob", "endTranDate=${YYYYMMDD}", "fromTime=14","toTime=24" , "requestDate=${YYYYMMDDHHMISS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('44b395229e714a48b2a979706b80d69b')
