...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNG918B_4',WORKFLOW_ID='7cb81f2c529f412dae61d96851e43e1e', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNG918B_4-0.0.prd-tz.1.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('7cb81f2c529f412dae61d96851e43e1e')
    ...
    csng918bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '01a80456713842089e3a6306456e2579',
    ...
    Complete = COMMON.getICISCompleteWflowTask('7cb81f2c529f412dae61d96851e43e1e')
