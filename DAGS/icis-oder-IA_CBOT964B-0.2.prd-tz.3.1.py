...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IA_CBOT964B',WORKFLOW_ID='93add0b775e64572b9eba529fd5f4c1e', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IA_CBOT964B-0.2.prd-tz.3.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('93add0b775e64572b9eba529fd5f4c1e')

    cbot964bJob_vol = []
    cbot964bJob_volMnt = []
    cbot964bJob_vol.append(getVolume('shared-volume','shared-volume'))
    cbot964bJob_volMnt.append(getVolumeMount('shared-volume','/app/order'))
    ...
    cbot964bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '51176dc4a0da4e8f8d24c913ae54e21e',
    ...
    Complete = COMMON.getICISCompleteWflowTask('93add0b775e64572b9eba529fd5f4c1e')
