...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IA_CBOT963B',WORKFLOW_ID='b054cef652d54c499f013b4f507dd441', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IA_CBOT963B-0.2.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('b054cef652d54c499f013b4f507dd441')
    ...
    cbot963bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'c45788a45dc040c2999e5217d487ec74',
    ...
    Complete = COMMON.getICISCompleteWflowTask('b054cef652d54c499f013b4f507dd441')
