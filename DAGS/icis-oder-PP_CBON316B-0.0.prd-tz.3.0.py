...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON316B',WORKFLOW_ID='453fcb112e114161a6b2c11a3378d42f', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON316B-0.0.prd-tz.3.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('453fcb112e114161a6b2c11a3378d42f')
    ...
    cbon316bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'ec27035e70934ae5a72e2266db1b27ef',
    ...
    Complete = COMMON.getICISCompleteWflowTask('453fcb112e114161a6b2c11a3378d42f')
