...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG553B',WORKFLOW_ID='05291c73950d4dd98fdc54b1aeea367b', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG553B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('05291c73950d4dd98fdc54b1aeea367b')
    ...
    csng553bJob_vol.append(getVolume('t-order-ftp-pvc','t-order-ftp-pvc'))
    csng553bJob_volMnt.append(getVolumeMount('t-order-ftp-pvc','/app/order'))
    ...
    csng553bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '45230f6229bf4e47b5633f997d0915a5',
...
"date=${YYYYMMDDHHMISS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('05291c73950d4dd98fdc54b1aeea367b')
