...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNG918B_9',WORKFLOW_ID='a931fc9c334b42458894dbb8c8abef08', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNG918B_9-0.0.prd-tz.1.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('a931fc9c334b42458894dbb8c8abef08')
    ...
    csng918bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '87c7403bea504ef394504b999dc5ca5f',
    ...
    Complete = COMMON.getICISCompleteWflowTask('a931fc9c334b42458894dbb8c8abef08')
