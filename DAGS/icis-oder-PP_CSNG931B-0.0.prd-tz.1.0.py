...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG931B',WORKFLOW_ID='401f17b15b1d4b5f88f5d65a2030f523', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG931B-0.0.prd-tz.1.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2025, 1, 3, 17, 20, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
    ,'max_active_runs': 16
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('401f17b15b1d4b5f88f5d65a2030f523')
    ...
    csng931bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '3550a631aa27482c9578b730c8d5f613',
    ...
    Complete = COMMON.getICISCompleteWflowTask('401f17b15b1d4b5f88f5d65a2030f523')
