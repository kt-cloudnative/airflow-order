...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSND169B',WORKFLOW_ID='e9a64f39141441928f5f61aa56e273bd', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSND169B-0.0.prd-tz.2.5'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('e9a64f39141441928f5f61aa56e273bd')
    ...
    csnd169bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'e032ec879e044b3fb9ea1bbd80afd538',
    ...
    Complete = COMMON.getICISCompleteWflowTask('e9a64f39141441928f5f61aa56e273bd')
