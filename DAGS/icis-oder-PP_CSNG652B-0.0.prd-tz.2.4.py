...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG652B',WORKFLOW_ID='b97a539aa0a34373a047bf67b815e709', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG652B-0.0.prd-tz.2.4'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('b97a539aa0a34373a047bf67b815e709')
    ...
    csng652bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '7ff7a15100654643bac451c438033b34',
        'volumes': csng652bJob_vol,
        'volume_mounts': csng652bJob_volMnt,
        'env_from':csng652bJob_env,
        'task_id':'csng652bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=csng652bJob","fromDate=20240530", "toDate=20240530", "ver="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('b97a539aa0a34373a047bf67b815e709')
