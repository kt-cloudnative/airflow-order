...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG647B',WORKFLOW_ID='0a975d0982e54a958cae2f6606b8a770', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG647B-0.0.prd-tz.1.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 6, 14, 0, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('0a975d0982e54a958cae2f6606b8a770')
    ...
    csng647bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '7149551af90f46fbb21cea043949c25d',
    ...
    Complete = COMMON.getICISCompleteWflowTask('0a975d0982e54a958cae2f6606b8a770')
