...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG652B',WORKFLOW_ID='5d90051f0bb344ff94e6f62e764cbe37', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG652B-0.0.prd-tz.5.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('5d90051f0bb344ff94e6f62e764cbe37')
    ...
    csng652bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'e24f1686eb5840babaa2e05e734b2fbe',
        'volumes': csng652bJob_vol,
        'volume_mounts': csng652bJob_volMnt,
        'env_from':csng652bJob_env,
        'task_id':'csng652bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.7',
        'arguments':["--job.name=csng652bJob","fromDate=20241122", "toDate=20241129", "ver="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('5d90051f0bb344ff94e6f62e764cbe37')
