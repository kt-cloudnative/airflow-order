...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG937B',WORKFLOW_ID='8a92743b0f6f4563a216c77aaf8fbd8b', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG937B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('8a92743b0f6f4563a216c77aaf8fbd8b')
    ...
    csng937bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '9dadd7d7037e46b082d39595c24e357b',
    ...
    Complete = COMMON.getICISCompleteWflowTask('8a92743b0f6f4563a216c77aaf8fbd8b')
