...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD117B',WORKFLOW_ID='649ad68bfb814ea2b41ee9a77737503c', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD117B-0.0.prd-tz.3.4'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('649ad68bfb814ea2b41ee9a77737503c')
    ...
    cbod117bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '6da0e0e2ef5b4de3ac5278a65f721338',
        'volumes': cbod117bJob_vol,
        'volume_mounts': cbod117bJob_volMnt,
        'env_from':cbod117bJob_env,
        'task_id':'cbod117bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=cbod117bJob", "endTranDate=20240530", "fromTime=14","toTime=24" , "requestDate=${YYYYMMDDHHMISS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('649ad68bfb814ea2b41ee9a77737503c')
