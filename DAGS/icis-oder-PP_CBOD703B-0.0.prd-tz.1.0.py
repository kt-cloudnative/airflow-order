...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD703B',WORKFLOW_ID='80cb8727b78e4ca5809d0ff8c7bc4c32', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD703B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('80cb8727b78e4ca5809d0ff8c7bc4c32')
    ...
    cbod703bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'a1f28c147abf429fa87f79dfb1502131',
    ...
    Complete = COMMON.getICISCompleteWflowTask('80cb8727b78e4ca5809d0ff8c7bc4c32')
