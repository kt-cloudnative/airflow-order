...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNB049B_0',WORKFLOW_ID='24bd4a2f09d041b6be6d7210325e0542', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNB049B_0-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('24bd4a2f09d041b6be6d7210325e0542')
    ...
    csnb049bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'fdb2777cfd2c4993845ed25167190ccf',
        ...
        'arguments':["--job.name=csnb049bJob", "workYm=${YYYYMM}", "workGb=0", "regEmpNo=91108904", "date=${YYYYMMDDHHMISS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('24bd4a2f09d041b6be6d7210325e0542')
