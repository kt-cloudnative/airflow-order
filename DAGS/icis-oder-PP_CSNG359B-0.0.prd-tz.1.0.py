...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG359B',WORKFLOW_ID='9b9203a416f840da877c465baeb5a603', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG359B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('9b9203a416f840da877c465baeb5a603')

    csng359bJob_vol = []
    csng359bJob_volMnt = []
    csng359bJob_vol.append(getVolume('shared-volume','shared-volume'))
    csng359bJob_volMnt.append(getVolumeMount('shared-volume','/app/order'))
    ...
    csng359bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '2eda7135901b4cd7a825787934716553',
...
,"inputFile=KT11202411.dat"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('9b9203a416f840da877c465baeb5a603')
