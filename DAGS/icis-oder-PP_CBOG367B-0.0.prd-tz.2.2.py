...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOG367B',WORKFLOW_ID='c324ebbb81004b50b0de2eff1595c69f', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOG367B-0.0.prd-tz.2.2'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('c324ebbb81004b50b0de2eff1595c69f')
    ...
    cbog367bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '17efaed2903341f5b43bdf5015e8d238',
    ...
    Complete = COMMON.getICISCompleteWflowTask('c324ebbb81004b50b0de2eff1595c69f')
