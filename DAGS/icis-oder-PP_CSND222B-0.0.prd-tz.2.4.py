...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSND222B',WORKFLOW_ID='897999a74c3640db9ffdedec817c3b98', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSND222B-0.0.prd-tz.2.4'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('897999a74c3640db9ffdedec817c3b98')
    ...
    csnd222bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'd7277002ace54762836ad26cdd7010e1',
        'volumes': csnd222bJob_vol,
        'volume_mounts': csnd222bJob_volMnt,
        'env_from':csnd222bJob_env,
        'task_id':'csnd222bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=csnd222bJob", "endTranDate=20240530", "pgmNm=csnd222b", "requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('897999a74c3640db9ffdedec817c3b98')
