...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNB049B_A',WORKFLOW_ID='8505e42228f34718be436e043720ac39', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNB049B_A-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('8505e42228f34718be436e043720ac39')
    ...
    csnb049bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '4142edfb841a439f80f4aa382e453247',
    ...
    Complete = COMMON.getICISCompleteWflowTask('8505e42228f34718be436e043720ac39')
