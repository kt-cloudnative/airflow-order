...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD523B',WORKFLOW_ID='74a43f3437cd4dd7b30d15a541c9c63c', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD523B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('74a43f3437cd4dd7b30d15a541c9c63c')
    ...
    Complete = COMMON.getICISCompleteWflowTask('74a43f3437cd4dd7b30d15a541c9c63c')
