...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG953B',WORKFLOW_ID='edd4d564298a4cf8b79bcc6b40d4de4d', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG953B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('edd4d564298a4cf8b79bcc6b40d4de4d')
    ...
    csng953bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '23a00676fb3046a1ae3c74f6dacb7072',
...
"requestDate=${YYYYMMDDHHMISS}", ],
    ...
    Complete = COMMON.getICISCompleteWflowTask('edd4d564298a4cf8b79bcc6b40d4de4d')
