...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNG918B_3',WORKFLOW_ID='526c150289bb461cb5f6a786ffdcaa16', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNG918B_3-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('526c150289bb461cb5f6a786ffdcaa16')
    ...
    csng918bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '0689c5ec608344f59734ebb74a91790b',
    ...
    Complete = COMMON.getICISCompleteWflowTask('526c150289bb461cb5f6a786ffdcaa16')
