...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON327B',WORKFLOW_ID='e860862fe3e946a2b7c43a7f091e10c9', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON327B-0.0.prd-tz.4.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('e860862fe3e946a2b7c43a7f091e10c9')
    ...
    cbon327bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '1d69a609bb40482bab603029fe54ccd3',
    ...
    Complete = COMMON.getICISCompleteWflowTask('e860862fe3e946a2b7c43a7f091e10c9')
