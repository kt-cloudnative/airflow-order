...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG506B_04',WORKFLOW_ID='7f0e753cd23345f2b14f1c5e87dc37da', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG506B_04-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('7f0e753cd23345f2b14f1c5e87dc37da')
    ...
    csng506bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '24f98d7b6f944d378391b0374e3044f7',
        'volumes': csng506bJob_vol,
        'volume_mounts': csng506bJob_volMnt,
        'env_from':csng506bJob_env,
        'task_id':'csng506bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.132',
        'arguments':["--job.name=csng506bJob", "argv2=0032", "argv3=Y", "requestDate=202410" , "duplPrvnDate=${YYYYMMDDHHMISSSSS}"
],
    ...
    Complete = COMMON.getICISCompleteWflowTask('7f0e753cd23345f2b14f1c5e87dc37da')
