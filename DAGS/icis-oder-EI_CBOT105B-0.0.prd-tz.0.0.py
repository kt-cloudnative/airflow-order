...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='EI_CBOT105B',WORKFLOW_ID='5830901318b840c88f9629df986c05d1', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-EI_CBOT105B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('5830901318b840c88f9629df986c05d1')
    ...
    cbot105bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '990bee0800d641b789487833579eeeec',
    ...
    Complete = COMMON.getICISCompleteWflowTask('5830901318b840c88f9629df986c05d1')
