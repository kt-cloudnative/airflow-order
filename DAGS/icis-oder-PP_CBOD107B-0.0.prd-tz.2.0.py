...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD107B',WORKFLOW_ID='b5095460c3774ac1a6a9a10408d2f76c', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD107B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('b5095460c3774ac1a6a9a10408d2f76c')
    ...
    cbod107bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '5817afcae3464616ac8c7b31480b2e87',
    ...
    Complete = COMMON.getICISCompleteWflowTask('b5095460c3774ac1a6a9a10408d2f76c')
