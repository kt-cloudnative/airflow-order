...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG926B',WORKFLOW_ID='d99175cbcda945bda0ff1fe504c5dc08', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG926B-0.0.prd-tz.5.1'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 29, 13, 52, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('d99175cbcda945bda0ff1fe504c5dc08')
    ...
    csng926bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '83e501e63d0749b9a2d684165dd358bc',
        'volumes': csng926bJob_vol,
        'volume_mounts': csng926bJob_volMnt,
        'env_from':csng926bJob_env,
        'task_id':'csng926bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=csng926bJob", "tranDate=20240430" , "requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('d99175cbcda945bda0ff1fe504c5dc08')
