...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON311B',WORKFLOW_ID='883cc660f313448ebe55f1ce64cdfb6f', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON311B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('883cc660f313448ebe55f1ce64cdfb6f')
    ...
    Complete = COMMON.getICISCompleteWflowTask('883cc660f313448ebe55f1ce64cdfb6f')
