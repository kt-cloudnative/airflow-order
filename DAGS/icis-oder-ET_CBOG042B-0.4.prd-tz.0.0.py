...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CBOG042B',WORKFLOW_ID='10c933da5f594ba7b6549a7a3707d429', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CBOG042B-0.4.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('10c933da5f594ba7b6549a7a3707d429')
    ...
    cbog042bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '92b67b6ebd2247d792f8b94c6cdbbd42',
    ...
    Complete = COMMON.getICISCompleteWflowTask('10c933da5f594ba7b6549a7a3707d429')
