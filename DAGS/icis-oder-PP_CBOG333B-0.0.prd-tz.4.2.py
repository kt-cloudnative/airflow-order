...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOG333B',WORKFLOW_ID='e49714a95091423787b0584dada91303', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOG333B-0.0.prd-tz.4.2'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('e49714a95091423787b0584dada91303')
    ...
    Complete = COMMON.getICISCompleteWflowTask('e49714a95091423787b0584dada91303')
