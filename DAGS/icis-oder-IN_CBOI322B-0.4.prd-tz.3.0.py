...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IN_CBOI322B',WORKFLOW_ID='c26e2c56ab5346a8af30df3c4f42488c', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IN_CBOI322B-0.4.prd-tz.3.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('c26e2c56ab5346a8af30df3c4f42488c')
    ...
    cboi322bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'b73dcbb305364553bae2406457aea4bb',
    ...
    Complete = COMMON.getICISCompleteWflowTask('c26e2c56ab5346a8af30df3c4f42488c')
