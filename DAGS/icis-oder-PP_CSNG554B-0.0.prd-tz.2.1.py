...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG554B',WORKFLOW_ID='7ac6567aaeb04192ae79440dec2e3fb2', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG554B-0.0.prd-tz.2.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('7ac6567aaeb04192ae79440dec2e3fb2')
    ...
    csng554bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '4754a35e2b8c443d8a77ff57001a3fea',
    ...
    Complete = COMMON.getICISCompleteWflowTask('7ac6567aaeb04192ae79440dec2e3fb2')
