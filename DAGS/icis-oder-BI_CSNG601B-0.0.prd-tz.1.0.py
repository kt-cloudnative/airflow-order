...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='BI_CSNG601B',WORKFLOW_ID='b44565443da74abeb098a5da77fa6236', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-BI_CSNG601B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('b44565443da74abeb098a5da77fa6236')
    ...
    csng601bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '41ea7533af614c55b7cdafd139d56a21',
    ...
    Complete = COMMON.getICISCompleteWflowTask('b44565443da74abeb098a5da77fa6236')
