...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD107B',WORKFLOW_ID='29e574bcdeab40b3b043776373c203aa', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD107B-0.0.prd-tz.0.5'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 4, 9, 33, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('29e574bcdeab40b3b043776373c203aa')
    ...
    cbod107bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '1e90aa99d27e484e9caececbb2962cdd',
    ...
    Complete = COMMON.getICISCompleteWflowTask('29e574bcdeab40b3b043776373c203aa')
