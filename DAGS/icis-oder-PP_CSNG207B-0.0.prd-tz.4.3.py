...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG207B',WORKFLOW_ID='3170c938b92b475c94082f60affdb666', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG207B-0.0.prd-tz.4.3'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('3170c938b92b475c94082f60affdb666')
    ...
    csng207bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'f91aab387202469f9ffeb4729f067de8',
        'volumes': csng207bJob_vol,
        'volume_mounts': csng207bJob_volMnt,
        'env_from':csng207bJob_env,
        'task_id':'csng207bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=csng207bJob", "endTranDate=20240529", "empNo=952794853","ver="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('3170c938b92b475c94082f60affdb666')
