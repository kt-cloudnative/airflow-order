...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_PSN24061201B_3',WORKFLOW_ID='2963d17bcb9f465c99ad014bc8da90f2', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_PSN24061201B_3-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('2963d17bcb9f465c99ad014bc8da90f2')
    ...
    psn24061201bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'f3d8b7c2e8bc48fd8e7edafcaa28e9e1',
    ...
    Complete = COMMON.getICISCompleteWflowTask('2963d17bcb9f465c99ad014bc8da90f2')
