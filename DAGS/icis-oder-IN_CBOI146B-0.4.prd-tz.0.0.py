...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IN_CBOI146B',WORKFLOW_ID='10d22e01467f49cf8b8a086d81103801', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IN_CBOI146B-0.4.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('10d22e01467f49cf8b8a086d81103801')
    ...
    cboi146bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '30610c59b7b84d87a76576b7fa568391',
    ...
    Complete = COMMON.getICISCompleteWflowTask('10d22e01467f49cf8b8a086d81103801')
