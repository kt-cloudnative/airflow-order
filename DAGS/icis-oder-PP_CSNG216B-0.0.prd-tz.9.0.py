...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG216B',WORKFLOW_ID='bc0e1a76cd1849049389f3bc0c559d1d', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG216B-0.0.prd-tz.9.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('bc0e1a76cd1849049389f3bc0c559d1d')
    ...
    csng216bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'ce03a3214ae445a8ac439ba880aebdbd',
        'volumes': csng216bJob_vol,
        'volume_mounts': csng216bJob_volMnt,
        'env_from':csng216bJob_env,
        'task_id':'csng216bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.7',
        'arguments':["--job.name=csng216bJob", "endTranDate=20241129", "empNo=91332365","requestDate="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('bc0e1a76cd1849049389f3bc0c559d1d')
