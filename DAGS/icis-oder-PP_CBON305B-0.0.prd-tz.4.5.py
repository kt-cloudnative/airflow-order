...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON305B',WORKFLOW_ID='f95d60c116ef4ec68f2db6f401d02e5e', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON305B-0.0.prd-tz.4.5'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 29, 12, 5, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('f95d60c116ef4ec68f2db6f401d02e5e')
    ...
    cbon305bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'fa80fe70cc2045dca8fe447df61ea6f2',
        'volumes': cbon305bJob_vol,
        'volume_mounts': cbon305bJob_volMnt,
        'env_from':cbon305bJob_env,
        'task_id':'cbon305bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.2',
        'arguments':["--job.name=cbon305bJob", "endTranDate=20240430", "ver="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('f95d60c116ef4ec68f2db6f401d02e5e')
