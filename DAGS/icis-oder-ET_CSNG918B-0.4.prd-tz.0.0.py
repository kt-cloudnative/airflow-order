...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNG918B',WORKFLOW_ID='926df0eee3b14c0581af1c259e454d0b', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNG918B-0.4.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('926df0eee3b14c0581af1c259e454d0b')
    ...
    csng918bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '15733ca8192e45b98ab73fbf83a3ec0c',
    ...
    Complete = COMMON.getICISCompleteWflowTask('926df0eee3b14c0581af1c259e454d0b')
