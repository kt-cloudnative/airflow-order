...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG633B',WORKFLOW_ID='23d412cbb1c54c44a9a1bed26ab04ebe', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG633B-0.0.prd-tz.3.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 8, 12, 1, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('23d412cbb1c54c44a9a1bed26ab04ebe')
    ...
    csng633bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '2194f1200ce744a6b49980f7e447e786',
...
, "pgmNm=csng633b" ],
    ...
    Complete = COMMON.getICISCompleteWflowTask('23d412cbb1c54c44a9a1bed26ab04ebe')
