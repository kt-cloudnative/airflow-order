...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG948B_1',WORKFLOW_ID='4d7bd537a3714c1db4370eef074dcf7f', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG948B_1-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('4d7bd537a3714c1db4370eef074dcf7f')
    ...
    csng948bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '2ebea3978423486dad0bbf611c0bf5d0',
        'volumes': csng948bJob_vol,
        'volume_mounts': csng948bJob_volMnt,
        'env_from':csng948bJob_env,
        'task_id':'csng948bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.5',
        'arguments':["--job.name=csng948bJob", "applyDate=${YYYYMM}", "saIdSecEnum=1"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('4d7bd537a3714c1db4370eef074dcf7f')
