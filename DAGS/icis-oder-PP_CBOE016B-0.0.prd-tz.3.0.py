...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOE016B',WORKFLOW_ID='f05c0c4eef8948a799dc60d2c4bb5825', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOE016B-0.0.prd-tz.3.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('f05c0c4eef8948a799dc60d2c4bb5825')
    ...
    cboe016bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '778069f8f5de48c8bcfa3cf153892ac6',
...
, "yyyyMm=202501", "svcName=cboe016bJob"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('f05c0c4eef8948a799dc60d2c4bb5825')
