...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG949B',WORKFLOW_ID='36d1d1b14e524c1abc4064614dc72879', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG949B-0.0.prd-tz.3.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('36d1d1b14e524c1abc4064614dc72879')
    ...
    csng949bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'a01da9c33edc4281ac56292a9cee8459',
...
"date="+str(datetime.now().strftime("%Y%m%d%H%M%S"))],
    ...
    Complete = COMMON.getICISCompleteWflowTask('36d1d1b14e524c1abc4064614dc72879')
