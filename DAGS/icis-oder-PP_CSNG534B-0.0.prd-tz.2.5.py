...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG534B',WORKFLOW_ID='3ac890fc94ab4a1b988c568cdc7b1e33', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG534B-0.0.prd-tz.2.5'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('3ac890fc94ab4a1b988c568cdc7b1e33')
    ...
    csng534bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'aa3a982eb6fc459cb77fbe3145693346',
        'volumes': csng534bJob_vol,
        'volume_mounts': csng534bJob_volMnt,
        'env_from':csng534bJob_env,
        'task_id':'csng534bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=csng534bJob", "inputDate=20240430","requestDate="+str(datetime.now())
],
    ...
    Complete = COMMON.getICISCompleteWflowTask('3ac890fc94ab4a1b988c568cdc7b1e33')
