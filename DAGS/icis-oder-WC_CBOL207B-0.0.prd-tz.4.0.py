...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='WC_CBOL207B',WORKFLOW_ID='323ec3e8f3b947c8aef1a9d87cdd9056', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-WC_CBOL207B-0.0.prd-tz.4.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 1, 17, 5, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('323ec3e8f3b947c8aef1a9d87cdd9056')
    ...
    cbol207bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'fc486446c0ee4009b9bf67e8402bfb05',
    ...
    Complete = COMMON.getICISCompleteWflowTask('323ec3e8f3b947c8aef1a9d87cdd9056')
