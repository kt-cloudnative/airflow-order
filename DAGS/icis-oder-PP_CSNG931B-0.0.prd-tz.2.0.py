...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG931B',WORKFLOW_ID='dff6c53db77f48c2a99728093583876c', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG931B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('dff6c53db77f48c2a99728093583876c')
    ...
    csng931bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '83b321e3460e4e668f4a8f4a3f7c7d82',
        'volumes': csng931bJob_vol,
        'volume_mounts': csng931bJob_volMnt,
        'env_from':csng931bJob_env,
        'task_id':'csng931bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.7',
        'arguments':["--job.name=csng931bJob", "testreqestDate=${YYYYMMDDHHMISS}", "brOfcCd=R00510", "endDate=20241129"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('dff6c53db77f48c2a99728093583876c')
