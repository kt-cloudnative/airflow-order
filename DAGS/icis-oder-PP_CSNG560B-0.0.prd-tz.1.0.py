...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG560B',WORKFLOW_ID='8754d8a6d26e4caf9a80fe9c28501f99', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG560B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('8754d8a6d26e4caf9a80fe9c28501f99')

    csng560bJob_vol = []
    csng560bJob_volMnt = []
    csng560bJob_vol.append(getVolume('shared-volume','shared-volume'))
    csng560bJob_volMnt.append(getVolumeMount('shared-volume','/app/order'))
    ...
    csng560bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '227af20f65924a95bb9956990b30a7a9',
        'volumes': csng560bJob_vol,
        'volume_mounts': csng560bJob_volMnt,
        'env_from':csng560bJob_env,
        'task_id':'csng560bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.7',
        'arguments':["--job.name=csng560bJob","requestDate="+str(datetime.now()),"intbutDate=202401129","regOfcCd=252023","regerEmpNo=932894755","regerEmpName=홍길동"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('8754d8a6d26e4caf9a80fe9c28501f99')
