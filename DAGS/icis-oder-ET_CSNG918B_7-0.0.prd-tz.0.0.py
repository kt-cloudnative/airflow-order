...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNG918B_7',WORKFLOW_ID='d6d34f83c1244a26bb76d763cdc5af84', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNG918B_7-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('d6d34f83c1244a26bb76d763cdc5af84')
    ...
    csng918bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'f2992710a6924feebbb64bef11bf5ca0',
    ...
    Complete = COMMON.getICISCompleteWflowTask('d6d34f83c1244a26bb76d763cdc5af84')
