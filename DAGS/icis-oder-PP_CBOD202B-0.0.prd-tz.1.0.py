...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD202B',WORKFLOW_ID='2bd7cc4b793a4405bb68d6cd9caefeed', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD202B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('2bd7cc4b793a4405bb68d6cd9caefeed')
    ...
    cbod202bJob_vol.append(getVolume('t-order-ftp-pvc','t-order-ftp-pvc'))
    cbod202bJob_volMnt.append(getVolumeMount('t-order-ftp-pvc','/app/order'))
    ...
    cbod202bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '05eff97992d8428db936c888d03e57b9',
        'volumes': cbod202bJob_vol,
        'volume_mounts': cbod202bJob_volMnt,
        'env_from':cbod202bJob_env,
        'task_id':'cbod202bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.51',
        'arguments':["--job.name=cbod202bJob", "endTranDate=20240916", "fromTime=09", "toTime=19", "requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('2bd7cc4b793a4405bb68d6cd9caefeed')
