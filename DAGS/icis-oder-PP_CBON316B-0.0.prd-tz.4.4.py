...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON316B',WORKFLOW_ID='cab502eec4e94edd8a01cf1089ddd494', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON316B-0.0.prd-tz.4.4'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('cab502eec4e94edd8a01cf1089ddd494')
    ...
    cbon316bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '76586eb838934a5cae53afa47c2ee1a0',
        'volumes': cbon316bJob_vol,
        'volume_mounts': cbon316bJob_volMnt,
        'env_from':cbon316bJob_env,
        'task_id':'cbon316bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=cbon316bJob", "endTranDate=20240530", "ver="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('cab502eec4e94edd8a01cf1089ddd494')
