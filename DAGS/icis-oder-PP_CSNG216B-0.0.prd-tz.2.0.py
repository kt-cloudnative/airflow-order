...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG216B',WORKFLOW_ID='93bc23e884e2425b8f43532ba126c3a2', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG216B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('93bc23e884e2425b8f43532ba126c3a2')
    ...
    csng216bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'b4c71c414e3c49a3a4165de0ba725396',
        'volumes': csng216bJob_vol,
        'volume_mounts': csng216bJob_volMnt,
        'env_from':csng216bJob_env,
        'task_id':'csng216bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.57',
        'arguments':["--job.name=csng216bJob", "endTranDate=20240628", "empNo=91332365","requestDate="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('93bc23e884e2425b8f43532ba126c3a2')
