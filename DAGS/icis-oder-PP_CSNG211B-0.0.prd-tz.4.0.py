...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG211B',WORKFLOW_ID='38e4f62b44cd427ba915b7601ad04ce0', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG211B-0.0.prd-tz.4.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('38e4f62b44cd427ba915b7601ad04ce0')
    ...
    csng211bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '1a8e492cf2d34283bc672b8c5ad42efd',
        'volumes': csng211bJob_vol,
        'volume_mounts': csng211bJob_volMnt,
        'env_from':csng211bJob_env,
        'task_id':'csng211bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.7',
        'arguments':["--job.name=csng211bJob", "workMonth=202411", "ver="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('38e4f62b44cd427ba915b7601ad04ce0')
