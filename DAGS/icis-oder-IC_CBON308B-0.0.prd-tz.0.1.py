...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IC_CBON308B',WORKFLOW_ID='e5da3383f58940dca119d508c0aff8e4', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IC_CBON308B-0.0.prd-tz.0.1'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 1, 13, 10, 00, tzinfo=local_tz)
    ,'end_date': datetime(2024, 11, 2, 0, 0, 00, tzinfo=local_tz)
    ,'paused': False
    ,'max_active_runs':1
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('e5da3383f58940dca119d508c0aff8e4')
    ...
    cbon308bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'f7e96739de744e35998ff8f6ab5f46a4',
    ...
    Complete = COMMON.getICISCompleteWflowTask('e5da3383f58940dca119d508c0aff8e4')
