...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNG918B_1',WORKFLOW_ID='df155fd879f845e38f4d37f1cd513631', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNG918B_1-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('df155fd879f845e38f4d37f1cd513631')
    ...
    csng918bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '061009649004417786cfd017142797a3',
    ...
    Complete = COMMON.getICISCompleteWflowTask('df155fd879f845e38f4d37f1cd513631')
