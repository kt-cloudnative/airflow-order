...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='BI_CSAB806B',WORKFLOW_ID='1f54624088604adba413c3168608209d', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-BI_CSAB806B-0.0.prd-tz.0.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 8, 17, 0, 55, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
    ,'max_active_runs': 16
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('1f54624088604adba413c3168608209d')
    ...
    csab806bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'f0e5e3ea47fa4c9284b4b6d4cdea3643',
    ...
    Complete = COMMON.getICISCompleteWflowTask('1f54624088604adba413c3168608209d')
