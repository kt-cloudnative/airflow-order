...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD204B',WORKFLOW_ID='893eb8bc0504492dba2d034240d75aa5', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD204B-0.0.prd-tz.4.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('893eb8bc0504492dba2d034240d75aa5')
    ...
    cbod204bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '14b48f8fcc81408eaacbe98b6e4b9183',
...
"date=${YYYYMMDDHHMISS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('893eb8bc0504492dba2d034240d75aa5')
