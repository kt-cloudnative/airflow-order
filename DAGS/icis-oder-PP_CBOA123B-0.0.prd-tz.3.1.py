...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOA123B',WORKFLOW_ID='dcd7744aea93465b8c616bec3b30aca8', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOA123B-0.0.prd-tz.3.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('dcd7744aea93465b8c616bec3b30aca8')
    ...
    cboa123bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'e6f4f9b6e8134fe2b45c2f2c1262d674',
    ...
    Complete = COMMON.getICISCompleteWflowTask('dcd7744aea93465b8c616bec3b30aca8')
