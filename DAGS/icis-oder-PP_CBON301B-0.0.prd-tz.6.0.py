...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON301B',WORKFLOW_ID='f185e9ec90cf4233a6d9e67bd71790a9', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON301B-0.0.prd-tz.6.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('f185e9ec90cf4233a6d9e67bd71790a9')
    ...
    Complete = COMMON.getICISCompleteWflowTask('f185e9ec90cf4233a6d9e67bd71790a9')
