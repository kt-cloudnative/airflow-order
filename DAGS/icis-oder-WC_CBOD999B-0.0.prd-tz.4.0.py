...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='WC_CBOD999B',WORKFLOW_ID='4e968dc04a0e4afc8306e860d2c664aa', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-WC_CBOD999B-0.0.prd-tz.4.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('4e968dc04a0e4afc8306e860d2c664aa')
    ...
    cbod999bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '53250b1a85064af295f89ba90bfdb7e9',
    ...
    Complete = COMMON.getICISCompleteWflowTask('4e968dc04a0e4afc8306e860d2c664aa')
