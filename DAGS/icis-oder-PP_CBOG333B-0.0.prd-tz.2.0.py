...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOG333B',WORKFLOW_ID='9be4547d796e4d81b40cf4bd81fbc7f4', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOG333B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('9be4547d796e4d81b40cf4bd81fbc7f4')
    ...
    cbog333bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '603040b25a13418996669387637c89c5',
    ...
    Complete = COMMON.getICISCompleteWflowTask('9be4547d796e4d81b40cf4bd81fbc7f4')
