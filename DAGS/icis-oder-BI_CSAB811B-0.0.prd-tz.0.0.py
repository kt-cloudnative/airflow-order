...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='BI_CSAB811B',WORKFLOW_ID='8311139ffe224a91a1e1227ab098d5b9', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-BI_CSAB811B-0.0.prd-tz.0.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 8, 17, 1, 35, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
    ,'max_active_runs': 16
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('8311139ffe224a91a1e1227ab098d5b9')
    ...
    csab811bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '1064a98b88ad4336a98216d644f45ca7',
    ...
    Complete = COMMON.getICISCompleteWflowTask('8311139ffe224a91a1e1227ab098d5b9')
