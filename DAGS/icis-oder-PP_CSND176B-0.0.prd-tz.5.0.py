...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSND176B',WORKFLOW_ID='dbd07f12cb9d4901bb61bb58e820585e', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSND176B-0.0.prd-tz.5.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('dbd07f12cb9d4901bb61bb58e820585e')
    ...
    csnd176bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '6701f2243c984bc7a52fbf205db17932',
    ...
    Complete = COMMON.getICISCompleteWflowTask('dbd07f12cb9d4901bb61bb58e820585e')
