...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG133B',WORKFLOW_ID='550931c3947c489fb9c3a6db72cab562', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG133B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('550931c3947c489fb9c3a6db72cab562')
    ...
    csng133bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '4486f70706b54e0c9f3816f92f6c0bf2',
...
, "workMonth=202407"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('550931c3947c489fb9c3a6db72cab562')
