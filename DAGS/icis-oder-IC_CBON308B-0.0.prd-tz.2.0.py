...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IC_CBON308B',WORKFLOW_ID='d48c73cd4d1f4ecea400406990098a95', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IC_CBON308B-0.0.prd-tz.2.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 8, 10, 10, 00, tzinfo=local_tz)
    ,'end_date': datetime(2024, 11, 8, 23, 55, 00, tzinfo=local_tz)
    ,'paused': False
    ,'max_active_runs':1
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('d48c73cd4d1f4ecea400406990098a95')
    ...
    cbon308bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '9f952b401a5849078090e762a1ccb4aa',
        ...
        'arguments':["--job.name=cbon308bJob", "requestDate=${YYYYMMDDHHMISSSSS}", "endTranDate=20240630", "pgmNm=cbon308b", "ofcCd=710571"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('d48c73cd4d1f4ecea400406990098a95')
