...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON301B',WORKFLOW_ID='c8ad31428cfd4600b7aef2d095733986', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON301B-0.0.prd-tz.5.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('c8ad31428cfd4600b7aef2d095733986')
    ...
    cbon301bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'e204f0ae344646a5ab93b37583936ab4',
        'volumes': cbon301bJob_vol,
        'volume_mounts': cbon301bJob_volMnt,
        'env_from':cbon301bJob_env,
        'task_id':'cbon301bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=cbon301bJob" , "endTranDate=20240430","ver="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('c8ad31428cfd4600b7aef2d095733986')
