...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG554B',WORKFLOW_ID='6e31aee172344f84943d598e6244c7c0', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG554B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('6e31aee172344f84943d598e6244c7c0')
    ...
    csng554bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'd9c6dbc4d6a94aa39da235672d31a78d',
    ...
    Complete = COMMON.getICISCompleteWflowTask('6e31aee172344f84943d598e6244c7c0')
