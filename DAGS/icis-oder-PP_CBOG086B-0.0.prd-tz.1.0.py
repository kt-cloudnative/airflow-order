...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOG086B',WORKFLOW_ID='cbbb9c64cc524019a503cfb6b7192919', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOG086B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('cbbb9c64cc524019a503cfb6b7192919')
    ...
    cbog086bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '258f6215e4a54c9f9363986abc432020',
    ...
    Complete = COMMON.getICISCompleteWflowTask('cbbb9c64cc524019a503cfb6b7192919')
