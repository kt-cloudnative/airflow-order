...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON301B',WORKFLOW_ID='9bc36e2d4f294354abfb49b396f491a5', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON301B-0.0.prd-tz.4.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('9bc36e2d4f294354abfb49b396f491a5')
    ...
    cbon301bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'cd06378e99d14fce93e0f52e5898cea2',
    ...
    Complete = COMMON.getICISCompleteWflowTask('9bc36e2d4f294354abfb49b396f491a5')
