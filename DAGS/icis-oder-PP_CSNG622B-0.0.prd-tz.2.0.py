...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG622B',WORKFLOW_ID='90f8ae54103b409997c6c3702d132fdd', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG622B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('90f8ae54103b409997c6c3702d132fdd')
    ...
    csng622bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '90293ce9517a443ba80ad2218049b50d',
    ...
    Complete = COMMON.getICISCompleteWflowTask('90f8ae54103b409997c6c3702d132fdd')
