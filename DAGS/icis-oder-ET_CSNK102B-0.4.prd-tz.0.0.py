...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNK102B',WORKFLOW_ID='33eaa961811744468b36a285538e461b', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNK102B-0.4.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('33eaa961811744468b36a285538e461b')
    ...
    csnk102bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'c821ad5e287b44a6867c143c68d9a3bc',
    ...
    Complete = COMMON.getICISCompleteWflowTask('33eaa961811744468b36a285538e461b')
