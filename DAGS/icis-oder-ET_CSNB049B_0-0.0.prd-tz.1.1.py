...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNB049B_0',WORKFLOW_ID='66dd7d48a52a4fd0b6833f3bff306815', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNB049B_0-0.0.prd-tz.1.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('66dd7d48a52a4fd0b6833f3bff306815')
    ...
    csnb049bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '3faff8672c3b467ea80f000282eac957',
    ...
    Complete = COMMON.getICISCompleteWflowTask('66dd7d48a52a4fd0b6833f3bff306815')
