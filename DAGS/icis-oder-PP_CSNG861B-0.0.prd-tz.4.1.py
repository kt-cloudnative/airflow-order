...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG861B',WORKFLOW_ID='78c8adba94e343fbb533c1366ef3ad7b', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG861B-0.0.prd-tz.4.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('78c8adba94e343fbb533c1366ef3ad7b')
    ...
    csng861bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '4b347678cccc48f8abf667a11cb08241',
    ...
    Complete = COMMON.getICISCompleteWflowTask('78c8adba94e343fbb533c1366ef3ad7b')
