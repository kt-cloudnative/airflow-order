...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD202B',WORKFLOW_ID='842e919263b44a36b2a682231078ca18', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD202B-0.0.prd-tz.0.2'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('842e919263b44a36b2a682231078ca18')
    ...
    cbod202bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'f3ff2426832447889bad18d776c46440',
    ...
    Complete = COMMON.getICISCompleteWflowTask('842e919263b44a36b2a682231078ca18')
