...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG653B',WORKFLOW_ID='5a26658719fa465999f8762ef97eb4dd', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG653B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('5a26658719fa465999f8762ef97eb4dd')
    ...
    csng653bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '6aa3e6bbbb364a1a8ae6dfc89e67d328',
    ...
    Complete = COMMON.getICISCompleteWflowTask('5a26658719fa465999f8762ef97eb4dd')
