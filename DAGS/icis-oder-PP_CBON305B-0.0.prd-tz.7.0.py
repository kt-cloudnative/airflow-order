...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON305B',WORKFLOW_ID='388dfc44107b479ebc7522c5947c596e', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON305B-0.0.prd-tz.7.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('388dfc44107b479ebc7522c5947c596e')
    ...
    cbon305bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '921dd24183ea4a16be48dc6af1e94aac',
        'volumes': cbon305bJob_vol,
        'volume_mounts': cbon305bJob_volMnt,
        'env_from':cbon305bJob_env,
        'task_id':'cbon305bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.7',
        'arguments':["--job.name=cbon305bJob", "endTranDate=20241129", "requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('388dfc44107b479ebc7522c5947c596e')
