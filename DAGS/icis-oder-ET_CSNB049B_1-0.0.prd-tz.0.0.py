...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNB049B_1',WORKFLOW_ID='035196d73c774353ba4600cdd306a66e', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNB049B_1-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('035196d73c774353ba4600cdd306a66e')
    ...
    csnb049bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '4615891b80b548b7b79495aa51c321cf',
    ...
    Complete = COMMON.getICISCompleteWflowTask('035196d73c774353ba4600cdd306a66e')
