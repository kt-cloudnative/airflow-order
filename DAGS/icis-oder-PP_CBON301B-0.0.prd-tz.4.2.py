...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON301B',WORKFLOW_ID='dfee3a278bec425798d004a9e1fcc425', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON301B-0.0.prd-tz.4.2'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('dfee3a278bec425798d004a9e1fcc425')
    ...
    Complete = COMMON.getICISCompleteWflowTask('dfee3a278bec425798d004a9e1fcc425')
