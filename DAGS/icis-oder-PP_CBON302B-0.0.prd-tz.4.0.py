...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON302B',WORKFLOW_ID='a1ccca2672ff4b4db7593a9d95466764', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON302B-0.0.prd-tz.4.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 21, 19, 43, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('a1ccca2672ff4b4db7593a9d95466764')
    ...
    cbon302bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '046b42956ed84697b6116881b8829e8f',
...
"endTranDate=20240529"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('a1ccca2672ff4b4db7593a9d95466764')
