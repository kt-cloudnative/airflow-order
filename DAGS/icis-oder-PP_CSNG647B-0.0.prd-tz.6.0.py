...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG647B',WORKFLOW_ID='5fd46118119941519949ef80853bc3a8', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG647B-0.0.prd-tz.6.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 29, 10, 55, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('5fd46118119941519949ef80853bc3a8')
    ...
    csng647bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '04299e7a2f184e9fa7f90a4a65f56e2f',
    ...
    Complete = COMMON.getICISCompleteWflowTask('5fd46118119941519949ef80853bc3a8')
