...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD112B',WORKFLOW_ID='b4296b63afe847adae2f603d3edc6792', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD112B-0.0.prd-tz.1.1'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 8, 13, 35, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('b4296b63afe847adae2f603d3edc6792')
    ...
    cbod112bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '2b19431476c74ae5a35625a13be50650',
    ...
    Complete = COMMON.getICISCompleteWflowTask('b4296b63afe847adae2f603d3edc6792')
