...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IN_CBOI366B',WORKFLOW_ID='7360b14a19324fab84a96a31ed1c353b', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IN_CBOI366B-0.4.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('7360b14a19324fab84a96a31ed1c353b')
    ...
    cboi366bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '960e070d69e54707bb868a9bb18f493b',
    ...
    Complete = COMMON.getICISCompleteWflowTask('7360b14a19324fab84a96a31ed1c353b')
