...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNB049B_9',WORKFLOW_ID='f209a213c43d42d680514c9163b58724', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNB049B_9-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('f209a213c43d42d680514c9163b58724')
    ...
    csnb049bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '89c0a2db1c1542f0acba3d89d24a09e0',
        ...
        'arguments':["--job.name=csnb049bJob", "workYm=${YYYYMM}", "workGb=9", "regEmpNo=91108904", "date=${YYYYMMDDHHMISS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('f209a213c43d42d680514c9163b58724')
