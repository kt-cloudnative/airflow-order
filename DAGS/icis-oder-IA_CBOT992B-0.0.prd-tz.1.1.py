...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IA_CBOT992B',WORKFLOW_ID='05e293a32eb54af1bc851abb03bf05b6', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IA_CBOT992B-0.0.prd-tz.1.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('05e293a32eb54af1bc851abb03bf05b6')
    ...
    cbot992bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '2031ca0579eb44a2a6f11b2db72128eb',
    ...
    Complete = COMMON.getICISCompleteWflowTask('05e293a32eb54af1bc851abb03bf05b6')
