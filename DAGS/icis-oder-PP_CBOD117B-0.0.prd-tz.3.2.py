...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD117B',WORKFLOW_ID='f8f674c7b5da4dde9672fd0fba12f1b2', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD117B-0.0.prd-tz.3.2'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('f8f674c7b5da4dde9672fd0fba12f1b2')
    ...
    cbod117bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '5f2455d6d5f34255b9faeb805c1a894b',
    ...
    Complete = COMMON.getICISCompleteWflowTask('f8f674c7b5da4dde9672fd0fba12f1b2')
