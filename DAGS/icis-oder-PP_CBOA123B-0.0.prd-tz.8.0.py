...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOA123B',WORKFLOW_ID='d56545dea83e400d90e5eaa1f51539d7', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOA123B-0.0.prd-tz.8.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('d56545dea83e400d90e5eaa1f51539d7')
    ...
    cboa123bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '184a2889fc0a427ca828a2394cf8e428',
    ...
    Complete = COMMON.getICISCompleteWflowTask('d56545dea83e400d90e5eaa1f51539d7')
