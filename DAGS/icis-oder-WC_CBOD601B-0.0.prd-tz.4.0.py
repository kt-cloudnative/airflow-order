...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='WC_CBOD601B',WORKFLOW_ID='0dd98957c16e4c8f89c3c6e4be58338c', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-WC_CBOD601B-0.0.prd-tz.4.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('0dd98957c16e4c8f89c3c6e4be58338c')
    ...
    cbod601bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'b214c1647cf0430696c476f7eea8afbe',
    ...
    Complete = COMMON.getICISCompleteWflowTask('0dd98957c16e4c8f89c3c6e4be58338c')
