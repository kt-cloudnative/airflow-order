...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='WC_CBON327B',WORKFLOW_ID='c2ad3e831d474bcf86dbe4e4eb8d60ee', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-WC_CBON327B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('c2ad3e831d474bcf86dbe4e4eb8d60ee')
    ...
    cbon327bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '9999026d64fd4b3881f0c941367a9b14',
        'volumes': cbon327bJob_vol,
        'volume_mounts': cbon327bJob_volMnt,
        'env_from':cbon327bJob_env,
        'task_id':'cbon327bJob',
        'image':'/icis/icis-oder-wrlincomn-batch:0.4.1.21',
        'arguments':["--job.name=cbon327bJob", "endTranDate=20181215", "testBatchRequestDate="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('c2ad3e831d474bcf86dbe4e4eb8d60ee')
