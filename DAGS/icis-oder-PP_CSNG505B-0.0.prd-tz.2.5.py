...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG505B',WORKFLOW_ID='9f264a99af7c47d381900aadb61160c8', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG505B-0.0.prd-tz.2.5'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('9f264a99af7c47d381900aadb61160c8')
    ...
    csng505bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '18b024c2265f467d953dce52480eb910',
        'volumes': csng505bJob_vol,
        'volume_mounts': csng505bJob_volMnt,
        'env_from':csng505bJob_env,
        'task_id':'csng505bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=csng505bJob","requestDate=20240430", "requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('9f264a99af7c47d381900aadb61160c8')
