...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IC_CSNJ933B',WORKFLOW_ID='c3700343fd6649958543d1e56e4874f7', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IC_CSNJ933B-0.0.prd-tz.4.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('c3700343fd6649958543d1e56e4874f7')
    ...
    csnj933bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '9544d2a4a99e4f8b940e9050fd8d2876',
        ...
        'arguments':["--job.name=csnj933bJob", "requestDate=${YYYYMMDDHHMISS}", "gszProcMonth=202411"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('c3700343fd6649958543d1e56e4874f7')
