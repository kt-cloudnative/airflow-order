...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG506B_07',WORKFLOW_ID='4842257676d54372a4f6cdc27a2cfa4e', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG506B_07-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('4842257676d54372a4f6cdc27a2cfa4e')
    ...
    csng506bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'fac6c1ac9d9a4158886213e6bb61eff2',
        'volumes': csng506bJob_vol,
        'volume_mounts': csng506bJob_volMnt,
        'env_from':csng506bJob_env,
        'task_id':'csng506bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.132',
        'arguments':["--job.name=csng506bJob", "argv2=0043", "argv3=Y", "requestDate=${YYYYMM}" , "duplPrvnDate=${YYYYMMDDHHMISSSSS}"
],
    ...
    Complete = COMMON.getICISCompleteWflowTask('4842257676d54372a4f6cdc27a2cfa4e')
