...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_PSN24061201B_2',WORKFLOW_ID='32d8c8e0d31e4bab894a0b2a0c009d4d', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_PSN24061201B_2-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('32d8c8e0d31e4bab894a0b2a0c009d4d')
    ...
    psn24061201bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '70d3fa81584d40dca7f58e32fb0929b7',
    ...
    Complete = COMMON.getICISCompleteWflowTask('32d8c8e0d31e4bab894a0b2a0c009d4d')
