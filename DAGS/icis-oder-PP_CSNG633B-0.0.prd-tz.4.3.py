...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG633B',WORKFLOW_ID='f9382115d3f944fd8c2c43a6b3b7ce97', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG633B-0.0.prd-tz.4.3'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('f9382115d3f944fd8c2c43a6b3b7ce97')
    ...
    csng633bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'f25d751a5be743d297b37ec6c6dcd7d7',
...
, "pgmNm=csng633b" ],
    ...
    Complete = COMMON.getICISCompleteWflowTask('f9382115d3f944fd8c2c43a6b3b7ce97')
