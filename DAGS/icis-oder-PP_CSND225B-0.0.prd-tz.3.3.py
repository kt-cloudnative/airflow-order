...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSND225B',WORKFLOW_ID='7075fca599d74a6c8d642b4dd72d1582', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSND225B-0.0.prd-tz.3.3'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('7075fca599d74a6c8d642b4dd72d1582')
    ...
    csnd225bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'a3ffc0c8c16e48db8f035b8f4a389b6a',
        'volumes': csnd225bJob_vol,
        'volume_mounts': csnd225bJob_volMnt,
        'env_from':csnd225bJob_env,
        'task_id':'csnd225bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=csnd225bJob",  "endTranDate=20240529" , "requestDate="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('7075fca599d74a6c8d642b4dd72d1582')
