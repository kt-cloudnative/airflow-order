...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD107B',WORKFLOW_ID='29384cd5f85840148d19502127719e1b', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD107B-0.0.prd-tz.0.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('29384cd5f85840148d19502127719e1b')
    ...
    cbod107bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '44db1df15fda409296fdec2483df5943',
    ...
    Complete = COMMON.getICISCompleteWflowTask('29384cd5f85840148d19502127719e1b')
