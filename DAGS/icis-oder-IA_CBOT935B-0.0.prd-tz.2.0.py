...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IA_CBOT935B',WORKFLOW_ID='45b8efa65d044ec0a84269900ac8caf2', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IA_CBOT935B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('45b8efa65d044ec0a84269900ac8caf2')
    ...
    cbot935bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '7b75d853e5fd42e7b10ab3aa0c1e4c72',
    ...
    Complete = COMMON.getICISCompleteWflowTask('45b8efa65d044ec0a84269900ac8caf2')
