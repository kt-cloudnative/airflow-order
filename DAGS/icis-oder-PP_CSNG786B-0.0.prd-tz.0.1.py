...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG786B',WORKFLOW_ID='a21a068bbc4e44bda0415f4b78ddd930', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG786B-0.0.prd-tz.0.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('a21a068bbc4e44bda0415f4b78ddd930')
    ...
    csng786bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'dda0186cb15c436faff6cd3ef078590b',
    ...
    Complete = COMMON.getICISCompleteWflowTask('a21a068bbc4e44bda0415f4b78ddd930')
