...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOG085B',WORKFLOW_ID='069332b548eb4b76a0eb1b9e467460e2', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOG085B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('069332b548eb4b76a0eb1b9e467460e2')
    ...
    cbog085bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'c3d27c3afd9446be957cebeec2dac974',
    ...
    Complete = COMMON.getICISCompleteWflowTask('069332b548eb4b76a0eb1b9e467460e2')
