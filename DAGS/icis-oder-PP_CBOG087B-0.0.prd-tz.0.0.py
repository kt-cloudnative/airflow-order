...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOG087B',WORKFLOW_ID='830e34a3938240aab92beab410f3bdf1', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOG087B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('830e34a3938240aab92beab410f3bdf1')
    ...
    cbog087bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '64ac240720c74ee1b6e5d267b61e5753',
    ...
    Complete = COMMON.getICISCompleteWflowTask('830e34a3938240aab92beab410f3bdf1')
