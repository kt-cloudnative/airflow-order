...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='WC_CSNL705D',WORKFLOW_ID='c27830eca0814974b97fad935814e1a7', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-WC_CSNL705D-0.0.prd-tz.2.0'
    ,'schedule_interval':'*/3 * * * *'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('c27830eca0814974b97fad935814e1a7')
    ...
    csnl705dJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '03ebfe72112c4c08882d9a7acf326e6f',
    ...
    Complete = COMMON.getICISCompleteWflowTask('c27830eca0814974b97fad935814e1a7')
