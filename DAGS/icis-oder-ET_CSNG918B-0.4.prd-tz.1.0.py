...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNG918B',WORKFLOW_ID='ae1377c92a604438ad6ff87ce8d94a2c', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNG918B-0.4.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('ae1377c92a604438ad6ff87ce8d94a2c')
    ...
    csng918bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '787c6e55f58948b2ac0e85030154f380',
    ...
    Complete = COMMON.getICISCompleteWflowTask('ae1377c92a604438ad6ff87ce8d94a2c')
