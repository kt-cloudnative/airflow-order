...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG861B',WORKFLOW_ID='d5895e6e59df465092f8b402022a812d', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG861B-0.0.prd-tz.5.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('d5895e6e59df465092f8b402022a812d')
    ...
    csng861bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '3fd2f5368ecc46a68e8824ffe76ed81f',
    ...
    Complete = COMMON.getICISCompleteWflowTask('d5895e6e59df465092f8b402022a812d')
