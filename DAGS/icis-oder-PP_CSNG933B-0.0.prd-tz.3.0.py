...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG933B',WORKFLOW_ID='966e2bef673c4b5590c6e80fda1ecf10', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG933B-0.0.prd-tz.3.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('966e2bef673c4b5590c6e80fda1ecf10')
    ...
    csng933bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'bbf8208cf04f4fda9b8b51e8d5ab8d2c',
    ...
    Complete = COMMON.getICISCompleteWflowTask('966e2bef673c4b5590c6e80fda1ecf10')
