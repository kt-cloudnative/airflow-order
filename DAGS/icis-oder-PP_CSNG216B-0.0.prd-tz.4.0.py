...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG216B',WORKFLOW_ID='86baa5d879e349d8aa6cd2a770373357', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG216B-0.0.prd-tz.4.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 21, 20, 19, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('86baa5d879e349d8aa6cd2a770373357')
    ...
    csng216bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'a91e3264c4c54700b5cfe37ba02108d6',
        'volumes': csng216bJob_vol,
        'volume_mounts': csng216bJob_volMnt,
        'env_from':csng216bJob_env,
        'task_id':'csng216bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=csng216bJob", "endTranDate=20240529", "empNo=91332365","requestDate="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('86baa5d879e349d8aa6cd2a770373357')
