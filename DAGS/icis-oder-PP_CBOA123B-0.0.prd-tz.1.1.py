...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOA123B',WORKFLOW_ID='aaabdb59646b45bba16eb831300cef88', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOA123B-0.0.prd-tz.1.1'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 4, 10, 21, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('aaabdb59646b45bba16eb831300cef88')
    ...
    cboa123bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '0ed5d6cb0c744e668265c7c23fddacea',
    ...
    Complete = COMMON.getICISCompleteWflowTask('aaabdb59646b45bba16eb831300cef88')
