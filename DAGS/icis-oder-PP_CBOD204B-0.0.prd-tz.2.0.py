...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD204B',WORKFLOW_ID='154e53b4ce654f02a28bee72dedd0af9', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD204B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('154e53b4ce654f02a28bee72dedd0af9')
    ...
    cbod204bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '501e57663b7a46e39b3e896f0b03f3a7',
...
"date=${YYYYMMDDHHMISS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('154e53b4ce654f02a28bee72dedd0af9')
