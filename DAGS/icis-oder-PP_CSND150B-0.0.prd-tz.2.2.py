...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSND150B',WORKFLOW_ID='1e40f3dbd65c457a94540d1f2452efef', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSND150B-0.0.prd-tz.2.2'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('1e40f3dbd65c457a94540d1f2452efef')
    ...
    csnd150bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'e3cd1efdb8ab4e50bcb36ea6704c26a0',
    ...
    Complete = COMMON.getICISCompleteWflowTask('1e40f3dbd65c457a94540d1f2452efef')
