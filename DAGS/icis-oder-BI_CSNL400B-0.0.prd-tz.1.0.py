...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='BI_CSNL400B',WORKFLOW_ID='7b6b03bb629e4e17a692590e8595c171', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-BI_CSNL400B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('7b6b03bb629e4e17a692590e8595c171')
    ...
    csnl400bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'ed60225275984089ad1d841101789b2e',
    ...
    Complete = COMMON.getICISCompleteWflowTask('7b6b03bb629e4e17a692590e8595c171')
