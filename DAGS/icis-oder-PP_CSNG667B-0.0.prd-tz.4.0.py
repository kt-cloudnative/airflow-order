...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG667B',WORKFLOW_ID='832a7cb33d43496c84cffc1566b27d97', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG667B-0.0.prd-tz.4.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('832a7cb33d43496c84cffc1566b27d97')
    ...
    csng667bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'e279c0b96349434385319a2ad25359e0',
        'volumes': csng667bJob_vol,
        'volume_mounts': csng667bJob_volMnt,
        'env_from':csng667bJob_env,
        'task_id':'csng667bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=csng667bJob", "fromDate=20240501", "toDate=20240529", "requestDate="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('832a7cb33d43496c84cffc1566b27d97')
