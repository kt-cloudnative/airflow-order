...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNB049B',WORKFLOW_ID='64f4b310b28d4db2ad5cf3d874377c57', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNB049B-0.4.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('64f4b310b28d4db2ad5cf3d874377c57')
    ...
    csnb049bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '365e2f20a3ca4a76b42a49a3fa555ae9',
    ...
    Complete = COMMON.getICISCompleteWflowTask('64f4b310b28d4db2ad5cf3d874377c57')
