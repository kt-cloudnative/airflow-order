...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG951B',WORKFLOW_ID='abf56806b62f48f7b880620de2147640', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG951B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('abf56806b62f48f7b880620de2147640')
    ...
    Complete = COMMON.getICISCompleteWflowTask('abf56806b62f48f7b880620de2147640')
