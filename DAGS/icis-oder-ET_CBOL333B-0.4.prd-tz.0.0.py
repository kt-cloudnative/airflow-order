...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CBOL333B',WORKFLOW_ID='66445f1103be45f3891b7712edc61078', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CBOL333B-0.4.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('66445f1103be45f3891b7712edc61078')
    ...
    cbol333bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '61bb6e9a9c134d4d97a1cd62c89459d2',
        ...
        'arguments':["--job.name=cbol333bJob", "endTranDate=${YYYYMMDD}", "ofcCd=710571", "requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('66445f1103be45f3891b7712edc61078')
