...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IA_CBOT975B',WORKFLOW_ID='a228db05af434d86aed618c79d7f21ca', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IA_CBOT975B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('a228db05af434d86aed618c79d7f21ca')
    ...
    cbot975bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '180681e710424a4885d364ccb76e8d67',
    ...
    Complete = COMMON.getICISCompleteWflowTask('a228db05af434d86aed618c79d7f21ca')
