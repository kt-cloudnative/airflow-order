...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='WC_CBOL210B',WORKFLOW_ID='e4e1e7db904446fe878fd217f80027d4', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-WC_CBOL210B-0.0.prd-tz.3.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('e4e1e7db904446fe878fd217f80027d4')
    ...
    cbol210bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'fcea74bb7b144330926624cb28c50839',
    ...
    Complete = COMMON.getICISCompleteWflowTask('e4e1e7db904446fe878fd217f80027d4')
