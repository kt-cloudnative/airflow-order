...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG207B',WORKFLOW_ID='b1ebfb5db53b4551b1c9ee83160ed131', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG207B-0.0.prd-tz.1.1'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 1, 13, 20, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('b1ebfb5db53b4551b1c9ee83160ed131')
    ...
    csng207bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '97afc8aa0c1b48ee8037a9fa86cca3c7',
    ...
    Complete = COMMON.getICISCompleteWflowTask('b1ebfb5db53b4551b1c9ee83160ed131')
