...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG187B',WORKFLOW_ID='31cbdac38e3c47e491c4ffcaf0bdc930', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG187B-0.0.prd-tz.3.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('31cbdac38e3c47e491c4ffcaf0bdc930')
    ...
    csng187bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '4cc3ed758a894e789483d3d44aa46733',
...
, "requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('31cbdac38e3c47e491c4ffcaf0bdc930')
