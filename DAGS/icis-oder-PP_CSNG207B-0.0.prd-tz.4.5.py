...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG207B',WORKFLOW_ID='91ab6c72839d4523b5deecb9f3b183ee', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG207B-0.0.prd-tz.4.5'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('91ab6c72839d4523b5deecb9f3b183ee')
    ...
    csng207bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '8ca144dac58540108a04ac2a96519f20',
        'volumes': csng207bJob_vol,
        'volume_mounts': csng207bJob_volMnt,
        'env_from':csng207bJob_env,
        'task_id':'csng207bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=csng207bJob", "endTranDate=20240430", "empNo=952794853","ver="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('91ab6c72839d4523b5deecb9f3b183ee')
