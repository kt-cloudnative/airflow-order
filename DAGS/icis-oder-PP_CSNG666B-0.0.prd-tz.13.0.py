...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG666B',WORKFLOW_ID='9a193c87e9a3425d8d2c80beae0d62bb', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG666B-0.0.prd-tz.13.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('9a193c87e9a3425d8d2c80beae0d62bb')
    ...
    csng666bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '3946e76271c342e0a79ccada95f0372f',
        'volumes': csng666bJob_vol,
        'volume_mounts': csng666bJob_volMnt,
        'env_from':csng666bJob_env,
        'task_id':'csng666bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.7',
        'arguments':["--job.name=csng666bJob", "fromDate=20250120", "toDate=20250121", "requestDate="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('9a193c87e9a3425d8d2c80beae0d62bb')
