...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG647B',WORKFLOW_ID='3e82722d269146579fa30dcaf650ff6d', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG647B-0.0.prd-tz.5.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 22, 14, 55, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('3e82722d269146579fa30dcaf650ff6d')
    ...
    csng647bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '138629c1542a4e7982706bfe2e9a2379',
    ...
    Complete = COMMON.getICISCompleteWflowTask('3e82722d269146579fa30dcaf650ff6d')
