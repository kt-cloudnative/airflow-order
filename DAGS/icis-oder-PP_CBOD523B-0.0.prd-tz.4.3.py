...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD523B',WORKFLOW_ID='ae18c7cdbb6e44e29044d63f9b9007d5', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD523B-0.0.prd-tz.4.3'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('ae18c7cdbb6e44e29044d63f9b9007d5')
    ...
    cbod523bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '248552e569eb4093ae643e15d43bac55',
        'volumes': cbod523bJob_vol,
        'volume_mounts': cbod523bJob_volMnt,
        'env_from':cbod523bJob_env,
        'task_id':'cbod523bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=cbod523bJob","endTranDate=20240529","requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('ae18c7cdbb6e44e29044d63f9b9007d5')
