...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='gnstkd',WORKFLOW_ID='e190d6cbb5f848b6a0d8f85947e81427', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-gnstkd-0.0.prd-tz.1.3'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('e190d6cbb5f848b6a0d8f85947e81427')
    ...
    tkdgns = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '166701aa227144c690ef131fcce467b6',
        'volumes': tkdgns_vol,
    ...
    Complete = COMMON.getICISCompleteWflowTask('e190d6cbb5f848b6a0d8f85947e81427')
