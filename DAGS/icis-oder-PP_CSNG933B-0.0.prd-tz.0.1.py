...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG933B',WORKFLOW_ID='d105fbeed73c431989066fc1eb053f2d', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG933B-0.0.prd-tz.0.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('d105fbeed73c431989066fc1eb053f2d')
    ...
    csng933bJob_vol.append(getVolume('t-order-ftp-pvc','t-order-ftp-pvc'))
    csng933bJob_volMnt.append(getVolumeMount('t-order-ftp-pvc','/app/order'))
    ...
    csng933bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'bfb7d8ec302249b1b5074c2392c1453b',
    ...
    Complete = COMMON.getICISCompleteWflowTask('d105fbeed73c431989066fc1eb053f2d')
