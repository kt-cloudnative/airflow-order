...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IA_CBOT937B',WORKFLOW_ID='23a6db5acf7e46aa8a17baf88d0969e4', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IA_CBOT937B-0.0.prd-tz.3.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('23a6db5acf7e46aa8a17baf88d0969e4')

    cbot937bJob_vol = []
    cbot937bJob_volMnt = []
    cbot937bJob_vol.append(getVolume('shared-volume','shared-volume'))
    cbot937bJob_volMnt.append(getVolumeMount('shared-volume','/app/order'))
    ...
    cbot937bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '57662ee5901743d7a59f3266138d46c6',
    ...
    Complete = COMMON.getICISCompleteWflowTask('23a6db5acf7e46aa8a17baf88d0969e4')
