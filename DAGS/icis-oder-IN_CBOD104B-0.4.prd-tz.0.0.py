...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IN_CBOD104B',WORKFLOW_ID='4cf573a0870842acbbbd8e1dee19c551', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IN_CBOD104B-0.4.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('4cf573a0870842acbbbd8e1dee19c551')
    ...
    cbod104bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '699bce32217b4018ab4b2ecc221a5ebf',
    ...
    Complete = COMMON.getICISCompleteWflowTask('4cf573a0870842acbbbd8e1dee19c551')
