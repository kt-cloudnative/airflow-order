...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSND114B',WORKFLOW_ID='bc216251eacb4dd8a1a111a7aa22cee9', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSND114B-0.0.prd-tz.3.1'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 22, 15, 38, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('bc216251eacb4dd8a1a111a7aa22cee9')
    ...
    csnd114bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '5d66b49893e84304b6e44f441e0b14e4',
        'volumes': csnd114bJob_vol,
        'volume_mounts': csnd114bJob_volMnt,
        'env_from':csnd114bJob_env,
        'task_id':'csnd114bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.78',
        'arguments':["--job.name=csnd114bJob", "workDate=20240530", "workEmpNo=91348440", "testRequestDate=${YYYYMMDDHHMISS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('bc216251eacb4dd8a1a111a7aa22cee9')
