...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOA123B',WORKFLOW_ID='c73cd6f149264803b54e6c86fecebc62', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOA123B-0.0.prd-tz.9.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('c73cd6f149264803b54e6c86fecebc62')
    ...
    cboa123bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '54181d5c2b064b4a9c469a5686d88ac2',
    ...
    Complete = COMMON.getICISCompleteWflowTask('c73cd6f149264803b54e6c86fecebc62')
