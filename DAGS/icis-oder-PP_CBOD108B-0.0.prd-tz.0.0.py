...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD108B',WORKFLOW_ID='14322a63f295407fbaa7b394c27ad4fe', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD108B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('14322a63f295407fbaa7b394c27ad4fe')
    ...
    cbod108bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '3d540ba090ad4805b16a58fe912f7278',
        'volumes': cbod108bJob_vol,
        'volume_mounts': cbod108bJob_volMnt,
        'env_from':cbod108bJob_env,
        'task_id':'cbod108bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.45',
        'arguments':["--job.name=cbod108bJob", "workDate=${YYYYMMDD}", "saveSaId=11778599831","saveOrdNo=23002AT03694092"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('14322a63f295407fbaa7b394c27ad4fe')
