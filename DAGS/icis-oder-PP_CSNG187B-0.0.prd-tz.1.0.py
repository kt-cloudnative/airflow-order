...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG187B',WORKFLOW_ID='36ab5f94ff69495c9f9d77838a14fe17', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG187B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('36ab5f94ff69495c9f9d77838a14fe17')
    ...
    csng187bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '7c953f8bd0e1432ca020d43fdcc54ea1',
...
, "requestDate=${YYYYMMDDHHMISSSSS}" ],
    ...
    Complete = COMMON.getICISCompleteWflowTask('36ab5f94ff69495c9f9d77838a14fe17')
