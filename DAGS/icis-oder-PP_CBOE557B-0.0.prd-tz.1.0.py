...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOE557B',WORKFLOW_ID='dec8a656a4d446d1aff780dc6841e9d5', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOE557B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('dec8a656a4d446d1aff780dc6841e9d5')
    ...
    cboe557bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '405ce9c947764224a11b739f36474365',
    ...
    Complete = COMMON.getICISCompleteWflowTask('dec8a656a4d446d1aff780dc6841e9d5')
