...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD107B',WORKFLOW_ID='9a51c1460a8f4ffaa0adfa6a0677ada8', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD107B-0.0.prd-tz.2.3'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('9a51c1460a8f4ffaa0adfa6a0677ada8')
    ...
    cbod107bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'f05eaa4c84cc4b7c83155221d031529a',
        'volumes': cbod107bJob_vol,
        'volume_mounts': cbod107bJob_volMnt,
        'env_from':cbod107bJob_env,
        'task_id':'cbod107bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=cbod107bJob", "workDate=20240529","requestDate=${YYYYMMDDHHMISS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('9a51c1460a8f4ffaa0adfa6a0677ada8')
