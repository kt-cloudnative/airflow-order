...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='WC_CBOL207B',WORKFLOW_ID='c91898d419114076b0d5db398305a01b', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-WC_CBOL207B-0.0.prd-tz.0.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 1, 23, 0, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('c91898d419114076b0d5db398305a01b')
    ...
    cbol207bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '38301be9d55241c5a8813cea279c9fd2',
    ...
    Complete = COMMON.getICISCompleteWflowTask('c91898d419114076b0d5db398305a01b')
