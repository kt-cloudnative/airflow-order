...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG933B',WORKFLOW_ID='8decacfaa48d4374bd20113881b78ae7', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG933B-0.0.prd-tz.1.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 6, 15, 0, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('8decacfaa48d4374bd20113881b78ae7')
    ...
    csng933bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '04ef332554674da59108ce005cea2815',
    ...
    Complete = COMMON.getICISCompleteWflowTask('8decacfaa48d4374bd20113881b78ae7')
