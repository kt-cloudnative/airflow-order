...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG632B',WORKFLOW_ID='fb28da1f05e84c618876eb09b77b07f9', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG632B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('fb28da1f05e84c618876eb09b77b07f9')
    ...
    csng632bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'c90e9d863cf940aabd91c0ff3cf3f5b6',
...
, "endTranDate="+str(datetime.now().strftime("${YYYYMM}")),"pgmNm=csng632b"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('fb28da1f05e84c618876eb09b77b07f9')
