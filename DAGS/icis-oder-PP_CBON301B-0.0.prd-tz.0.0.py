...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON301B',WORKFLOW_ID='a620d54ebc184abb8f3c6e3170806f7c', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON301B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('a620d54ebc184abb8f3c6e3170806f7c')
    ...
    Complete = COMMON.getICISCompleteWflowTask('a620d54ebc184abb8f3c6e3170806f7c')
