...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='WC_CBOL207B',WORKFLOW_ID='70eedf8545164a5b8a3748da9311c00d', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-WC_CBOL207B-0.0.prd-tz.5.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('70eedf8545164a5b8a3748da9311c00d')
    ...
    cbol207bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '70e438a952fb451390ab0fa3c0a1c62e',
    ...
    Complete = COMMON.getICISCompleteWflowTask('70eedf8545164a5b8a3748da9311c00d')
