...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG122B',WORKFLOW_ID='632629297cc44bb8806829730dad9c2e', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG122B-0.0.prd-tz.5.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 22, 14, 59, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('632629297cc44bb8806829730dad9c2e')
    ...
    csng122bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'b8cd88eb5f6c4a32924dd286eb10e612',
        'volumes': csng122bJob_vol,
        'volume_mounts': csng122bJob_volMnt,
        'env_from':csng122bJob_env,
        'task_id':'csng122bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=csng122bJob", "duplPrvnDate=${YYYYMMDDHHMISSSSS}", "workDay=20240530"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('632629297cc44bb8806829730dad9c2e')
