...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG207B',WORKFLOW_ID='6ed7122f3ee0440bb0c745e184a116df', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG207B-0.0.prd-tz.4.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 8, 17, 36, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('6ed7122f3ee0440bb0c745e184a116df')
    ...
    csng207bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'b956ba4074a04d269ec117eef785200f',
    ...
    Complete = COMMON.getICISCompleteWflowTask('6ed7122f3ee0440bb0c745e184a116df')
