...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG652B',WORKFLOW_ID='ed501c9d7dd4472ea517aea501f4e59a', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG652B-0.0.prd-tz.0.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('ed501c9d7dd4472ea517aea501f4e59a')
    ...
    csng652bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'c1542bf1b9ac47d895bfee1a3b8687ac',
        'volumes': csng652bJob_vol,
        'volume_mounts': csng652bJob_volMnt,
        'env_from':csng652bJob_env,
        'task_id':'csng652bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.45',
        'arguments':["--job.name=csng652bJob","fromDate=20240731", "toDate=20240731", "ver="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('ed501c9d7dd4472ea517aea501f4e59a')
