...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IC_CSNJ933B',WORKFLOW_ID='2f92ca49cc5c45ef9a77199099faaf82', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IC_CSNJ933B-0.0.prd-tz.4.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2025, 1, 10, 14, 21, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
    ,'max_active_runs':1
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('2f92ca49cc5c45ef9a77199099faaf82')
    ...
    csnj933bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '2ac70b7ed8794c13894056f8683a7284',
    ...
    Complete = COMMON.getICISCompleteWflowTask('2f92ca49cc5c45ef9a77199099faaf82')
