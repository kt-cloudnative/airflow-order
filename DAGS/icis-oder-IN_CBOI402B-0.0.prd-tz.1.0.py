...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IN_CBOI402B',WORKFLOW_ID='23849389fcbf49d9aa8e137a64149a8f', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IN_CBOI402B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('23849389fcbf49d9aa8e137a64149a8f')
    ...
    cboi402bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '69924bdefdac4040a27813d1fec2a6b9',
    ...
    Complete = COMMON.getICISCompleteWflowTask('23849389fcbf49d9aa8e137a64149a8f')
