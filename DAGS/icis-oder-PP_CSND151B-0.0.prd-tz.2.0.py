...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSND151B',WORKFLOW_ID='8e90be5699104db88cdcd57b8d0a98e7', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSND151B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('8e90be5699104db88cdcd57b8d0a98e7')
    ...
    csnd151bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '43dbfa2b2ca44fae834330e69e9f13a5',
    ...
    Complete = COMMON.getICISCompleteWflowTask('8e90be5699104db88cdcd57b8d0a98e7')
