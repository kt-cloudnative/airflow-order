...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IA_CBOT940B',WORKFLOW_ID='729c6cfdd2ae4616a2b7ae17fdd0fef7', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IA_CBOT940B-0.0.prd-tz.2.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('729c6cfdd2ae4616a2b7ae17fdd0fef7')

    cbot940bJob_vol = []
    cbot940bJob_volMnt = []
    cbot940bJob_vol.append(getVolume('shared-volume','shared-volume'))
    cbot940bJob_volMnt.append(getVolumeMount('shared-volume','/app/order'))
    ...
    cbot940bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '6335569fab7c4d9bb47f916c00a6ef1c',
        ...
        'arguments':["--job.name=cbot940bJob", "requestDate="+str(datetime.now()), "procDate=20241129"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('729c6cfdd2ae4616a2b7ae17fdd0fef7')
