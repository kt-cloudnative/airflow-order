...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG633B',WORKFLOW_ID='981321c182be40aa97961fc2d6ce4d0b', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG633B-0.0.prd-tz.4.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('981321c182be40aa97961fc2d6ce4d0b')
    ...
    csng633bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'c339c49a58f9403d9201f0540cd10b56',
...
, "pgmNm=csng633b" ],
    ...
    Complete = COMMON.getICISCompleteWflowTask('981321c182be40aa97961fc2d6ce4d0b')
