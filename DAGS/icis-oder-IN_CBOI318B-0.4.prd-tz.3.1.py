...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IN_CBOI318B',WORKFLOW_ID='583d6311a58a4c3a90eafed7d77a7875', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IN_CBOI318B-0.4.prd-tz.3.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('583d6311a58a4c3a90eafed7d77a7875')
    ...
    cboi318bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'ca2d83e060e642969286ac71cf2b2f70',
    ...
    Complete = COMMON.getICISCompleteWflowTask('583d6311a58a4c3a90eafed7d77a7875')
