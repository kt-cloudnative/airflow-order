...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='BI_CSAB802B',WORKFLOW_ID='eae3e1d4299d48cda32a7ace60fd55fb', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-BI_CSAB802B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('eae3e1d4299d48cda32a7ace60fd55fb')
    ...
    csab802bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '6d3591077c0c46158a1fd546eb339bfe',
    ...
    Complete = COMMON.getICISCompleteWflowTask('eae3e1d4299d48cda32a7ace60fd55fb')
