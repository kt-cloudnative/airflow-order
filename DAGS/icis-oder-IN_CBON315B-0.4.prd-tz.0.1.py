...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IN_CBON315B',WORKFLOW_ID='cd8d64fb65a146f387f81ae6c9549bba', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IN_CBON315B-0.4.prd-tz.0.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('cd8d64fb65a146f387f81ae6c9549bba')
    ...
    cbon315bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '87aaf79b759643959d35325cf79289ef',
        ...
        'arguments':["--job.name=cbon315bJob", "endTranDate=20240731", "ofcCd=710571", "date=${YYYYMMDDHHMISS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('cd8d64fb65a146f387f81ae6c9549bba')
