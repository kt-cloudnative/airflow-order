...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG647B',WORKFLOW_ID='9065ef47a95d4fa6b835467559cdf147', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG647B-0.0.prd-tz.7.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 12, 30, 0, 0, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
    ,'max_active_runs': 16
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('9065ef47a95d4fa6b835467559cdf147')
    ...
    csng647bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '968e00049c27409980146e38a8be573b',
    ...
    Complete = COMMON.getICISCompleteWflowTask('9065ef47a95d4fa6b835467559cdf147')
