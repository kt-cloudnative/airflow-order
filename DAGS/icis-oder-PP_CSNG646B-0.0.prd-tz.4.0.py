...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG646B',WORKFLOW_ID='9a771e4f3fcb4a30ae1b5e5080665168', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG646B-0.0.prd-tz.4.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('9a771e4f3fcb4a30ae1b5e5080665168')
    ...
    csng646bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '928205248b344263994fd4756808f436',
        'volumes': csng646bJob_vol,
        'volume_mounts': csng646bJob_volMnt,
        'env_from':csng646bJob_env,
        'task_id':'csng646bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.7',
        'arguments':["--job.name=csng646bJob", "procDay=20241129", "requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('9a771e4f3fcb4a30ae1b5e5080665168')
