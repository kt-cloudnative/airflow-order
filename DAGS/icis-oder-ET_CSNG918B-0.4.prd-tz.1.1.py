...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNG918B',WORKFLOW_ID='8e1e03958af248009c10716c14847204', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNG918B-0.4.prd-tz.1.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('8e1e03958af248009c10716c14847204')
    ...
    csng918bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'fa1fd01f247e4e76b2fc4313c24f697c',
        ...
        'arguments':["--job.name=csng918bJob", "invMonth=${YYYYMM}", "subSaId=R", "date=${YYYYMMDDHHMISS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('8e1e03958af248009c10716c14847204')
