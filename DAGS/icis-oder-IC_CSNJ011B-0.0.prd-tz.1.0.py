...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IC_CSNJ011B',WORKFLOW_ID='cb168b024ab14c60977559870a79e45c', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IC_CSNJ011B-0.0.prd-tz.1.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2025, 1, 13, 17, 5, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
    ,'max_active_runs': 16
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('cb168b024ab14c60977559870a79e45c')
    ...
    csnj011bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '663cbec1eee14c8dbd230c3ea2921a0b',
    ...
    Complete = COMMON.getICISCompleteWflowTask('cb168b024ab14c60977559870a79e45c')
