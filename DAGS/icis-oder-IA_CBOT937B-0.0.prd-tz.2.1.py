...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IA_CBOT937B',WORKFLOW_ID='ec358d9fe23243fa8260e9777d2ee4fa', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IA_CBOT937B-0.0.prd-tz.2.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('ec358d9fe23243fa8260e9777d2ee4fa')
    ...
    cbot937bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'fcd24ab7cf254f71a735a0c0979a6012',
    ...
    Complete = COMMON.getICISCompleteWflowTask('ec358d9fe23243fa8260e9777d2ee4fa')
