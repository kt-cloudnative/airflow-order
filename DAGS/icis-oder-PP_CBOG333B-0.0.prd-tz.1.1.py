...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOG333B',WORKFLOW_ID='9cf9a2223ffd4269ba13ed75134f63fe', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOG333B-0.0.prd-tz.1.1'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 4, 10, 0, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('9cf9a2223ffd4269ba13ed75134f63fe')
    ...
    cbog333bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'fd995492f52f48ce9789ef55765a9f37',
    ...
    Complete = COMMON.getICISCompleteWflowTask('9cf9a2223ffd4269ba13ed75134f63fe')
