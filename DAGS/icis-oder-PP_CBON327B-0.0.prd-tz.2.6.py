...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON327B',WORKFLOW_ID='4564e3cd98f444f09401dd29004218a5', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON327B-0.0.prd-tz.2.6'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 29, 14, 50, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('4564e3cd98f444f09401dd29004218a5')
    ...
    cbon327bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '324df76e9f784094a304a1e81bb75e36',
    ...
    Complete = COMMON.getICISCompleteWflowTask('4564e3cd98f444f09401dd29004218a5')
