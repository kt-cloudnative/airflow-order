...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG949B',WORKFLOW_ID='2f6e2c51edc3422e8a1d152b5a76a21c', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG949B-0.0.prd-tz.8.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('2f6e2c51edc3422e8a1d152b5a76a21c')
    ...
    csng949bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'd73d7ec923ae4ef2a9ec4786e18b70bb',
...
"requestDate=${YYYYMMDDHHMISS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('2f6e2c51edc3422e8a1d152b5a76a21c')
