...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IC_CSNJ187B',WORKFLOW_ID='ad56e7646ea44a798fa21f58d39164e2', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IC_CSNJ187B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('ad56e7646ea44a798fa21f58d39164e2')
    ...
    csnj187bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '0906e3cf2bd14279896f8affa2768938',
    ...
    Complete = COMMON.getICISCompleteWflowTask('ad56e7646ea44a798fa21f58d39164e2')
