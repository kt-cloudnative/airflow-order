...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNG918B_4',WORKFLOW_ID='b7dd66ed30dd4e70833177adc00afbc8', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNG918B_4-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('b7dd66ed30dd4e70833177adc00afbc8')
    ...
    csng918bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'fd555ad5314f49cbba57804b31064db6',
    ...
    Complete = COMMON.getICISCompleteWflowTask('b7dd66ed30dd4e70833177adc00afbc8')
