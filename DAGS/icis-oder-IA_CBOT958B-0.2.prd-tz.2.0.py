...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IA_CBOT958B',WORKFLOW_ID='067ae88ac3b14376b36c0eceeb420e5d', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IA_CBOT958B-0.2.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('067ae88ac3b14376b36c0eceeb420e5d')
    ...
    cbot958bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '50cd003951db4c68af9a1b696a40c785',
    ...
    Complete = COMMON.getICISCompleteWflowTask('067ae88ac3b14376b36c0eceeb420e5d')
