...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSND269B',WORKFLOW_ID='aa4f2bf8479647bda34d1113cfa739e7', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSND269B-0.0.prd-tz.2.5'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('aa4f2bf8479647bda34d1113cfa739e7')
    ...
    csnd269bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '68b0e37bf4e149d697c98a4e2b23f393',
    ...
    Complete = COMMON.getICISCompleteWflowTask('aa4f2bf8479647bda34d1113cfa739e7')
