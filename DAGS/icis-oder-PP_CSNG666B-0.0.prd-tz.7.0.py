...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG666B',WORKFLOW_ID='1d65fa6457214b50874f08eb6cc1320c', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG666B-0.0.prd-tz.7.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('1d65fa6457214b50874f08eb6cc1320c')
    ...
    csng666bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '805345bfcfe7492396b01742459cf453',
        'volumes': csng666bJob_vol,
        'volume_mounts': csng666bJob_volMnt,
        'env_from':csng666bJob_env,
        'task_id':'csng666bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.132',
        'arguments':["--job.name=csng666bJob", "fromDate=${YYYYMMDD}", "toDate=${YYYYMMDD}", "requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('1d65fa6457214b50874f08eb6cc1320c')
