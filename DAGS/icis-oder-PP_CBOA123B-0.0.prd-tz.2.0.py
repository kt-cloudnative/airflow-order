...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOA123B',WORKFLOW_ID='e754d9d7b2224c01a647fa45b75e1896', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOA123B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('e754d9d7b2224c01a647fa45b75e1896')
    ...
    cboa123bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '91c9b412fce84563a8538f105f337783',
    ...
    Complete = COMMON.getICISCompleteWflowTask('e754d9d7b2224c01a647fa45b75e1896')
