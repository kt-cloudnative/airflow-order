...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG652B',WORKFLOW_ID='5d02ec3974a942e28ccf1503cc689b95', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG652B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('5d02ec3974a942e28ccf1503cc689b95')
    ...
    csng652bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'e0c2c18e18e74989b0b872596d713e0c',
    ...
    Complete = COMMON.getICISCompleteWflowTask('5d02ec3974a942e28ccf1503cc689b95')
