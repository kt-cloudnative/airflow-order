...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON302B',WORKFLOW_ID='e28a8759d04f4427bc8dda3dca42483d', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON302B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('e28a8759d04f4427bc8dda3dca42483d')
    ...
    cbon302bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '42d44a7f6c6044358d3eaf2a16b9d796',
...
"endTranDate=20240628"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('e28a8759d04f4427bc8dda3dca42483d')
