...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON327B',WORKFLOW_ID='33ff402e9e48453ebe94f6ecac650f71', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON327B-0.0.prd-tz.2.3'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 21, 20, 56, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('33ff402e9e48453ebe94f6ecac650f71')
    ...
    cbon327bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '3654c2bee0b14fb28909a327b875775a',
        'volumes': cbon327bJob_vol,
        'volume_mounts': cbon327bJob_volMnt,
        'env_from':cbon327bJob_env,
        'task_id':'cbon327bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=cbon327bJob", "endTranDate=20240529","ver="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('33ff402e9e48453ebe94f6ecac650f71')
