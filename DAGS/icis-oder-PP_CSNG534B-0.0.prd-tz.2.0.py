...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG534B',WORKFLOW_ID='1721b90f6e7242f09879e71dd9623545', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG534B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('1721b90f6e7242f09879e71dd9623545')
    ...
    csng534bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'db212b1b85d3486faa33aa5f1eb0757e',
    ...
    Complete = COMMON.getICISCompleteWflowTask('1721b90f6e7242f09879e71dd9623545')
