...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG893B',WORKFLOW_ID='17ce9827845f493983b6f67c3164f661', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG893B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('17ce9827845f493983b6f67c3164f661')
    ...
    csng893bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '5f6ade3016a944a9bf430da6df7fd34a',
    ...
    Complete = COMMON.getICISCompleteWflowTask('17ce9827845f493983b6f67c3164f661')
