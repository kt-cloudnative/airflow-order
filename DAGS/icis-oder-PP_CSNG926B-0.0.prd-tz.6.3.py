...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG926B',WORKFLOW_ID='4cf9d45194454cdb968f4f9d573a9fe2', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG926B-0.0.prd-tz.6.3'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('4cf9d45194454cdb968f4f9d573a9fe2')
    ...
    csng926bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '8b703f244adb47aebb2b0b29d6245234',
    ...
    Complete = COMMON.getICISCompleteWflowTask('4cf9d45194454cdb968f4f9d573a9fe2')
