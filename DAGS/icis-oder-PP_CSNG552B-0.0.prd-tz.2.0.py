...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG552B',WORKFLOW_ID='60e59272055b446185457b69287a17fb', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG552B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('60e59272055b446185457b69287a17fb')
    ...
    csng552bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'e191f770b40648d8bc7402b89dcf4367',
    ...
    Complete = COMMON.getICISCompleteWflowTask('60e59272055b446185457b69287a17fb')
