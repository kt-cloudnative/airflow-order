...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG125B',WORKFLOW_ID='15e3557be2e34682b852036e9e2bbbe0', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG125B-0.0.prd-tz.0.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('15e3557be2e34682b852036e9e2bbbe0')
    ...
    csng125bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '1dfcaf4db4b44f9ea80eab9acfc68360',
    ...
    Complete = COMMON.getICISCompleteWflowTask('15e3557be2e34682b852036e9e2bbbe0')
