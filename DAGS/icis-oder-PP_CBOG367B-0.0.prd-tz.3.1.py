...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOG367B',WORKFLOW_ID='aa92fa1ccc2346d1abc1d045e1e0722b', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOG367B-0.0.prd-tz.3.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('aa92fa1ccc2346d1abc1d045e1e0722b')
    ...
    cbog367bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '5d7059bbf6324a909cccd634d23f0c3d',
    ...
    Complete = COMMON.getICISCompleteWflowTask('aa92fa1ccc2346d1abc1d045e1e0722b')
