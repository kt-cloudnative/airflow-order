...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD108B',WORKFLOW_ID='b5dde55f1e004c349a4bfb0106699c50', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD108B-0.0.prd-tz.2.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('b5dde55f1e004c349a4bfb0106699c50')
    ...
    cbod108bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '998a7e7968184c6088d0d8060a5d40dd',
        'volumes': cbod108bJob_vol,
        'volume_mounts': cbod108bJob_volMnt,
        'env_from':cbod108bJob_env,
        'task_id':'cbod108bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=cbod108bJob", "workDate=20240528", "saveSaId=11778599831","saveOrdNo=23002AT03694092",  "requestDate="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('b5dde55f1e004c349a4bfb0106699c50')
