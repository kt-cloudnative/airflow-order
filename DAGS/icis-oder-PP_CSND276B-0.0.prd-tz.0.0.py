...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSND276B',WORKFLOW_ID='b3150b5e752f4e7b9f8798534ca462fb', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSND276B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('b3150b5e752f4e7b9f8798534ca462fb')
    ...
    csnd276bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '6b619e6c6be94dd0b2970b09470c4caf',
    ...
    Complete = COMMON.getICISCompleteWflowTask('b3150b5e752f4e7b9f8798534ca462fb')
