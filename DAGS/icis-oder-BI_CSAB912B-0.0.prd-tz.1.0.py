...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='BI_CSAB912B',WORKFLOW_ID='d5de5dee801f44df933e66186f018288', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-BI_CSAB912B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('d5de5dee801f44df933e66186f018288')
    ...
    csab912bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'ebdf5d6e565e44749b3fd4a213889edf',
    ...
    Complete = COMMON.getICISCompleteWflowTask('d5de5dee801f44df933e66186f018288')
