...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IC_CSNJ187B',WORKFLOW_ID='68fcbfbb50c5426eb0595703cefcd9d7', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IC_CSNJ187B-0.0.prd-tz.3.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('68fcbfbb50c5426eb0595703cefcd9d7')
    ...
    csnj187bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '3efb8117c2b84b17b537a247e4f9e921',
    ...
    Complete = COMMON.getICISCompleteWflowTask('68fcbfbb50c5426eb0595703cefcd9d7')
