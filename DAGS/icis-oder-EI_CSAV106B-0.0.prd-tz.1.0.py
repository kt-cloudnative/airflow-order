...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='EI_CSAV106B',WORKFLOW_ID='2818d3a67fde4d6cab3d21089996ffd2', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-EI_CSAV106B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('2818d3a67fde4d6cab3d21089996ffd2')
    ...
    csav106bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '4236c6d4c29544af8348ce41e39b0ed6',
    ...
    inareainetAutoTrmnTrtJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '7459adfce7634da5851f89fc2b8c1616',
    ...
    Complete = COMMON.getICISCompleteWflowTask('2818d3a67fde4d6cab3d21089996ffd2')
