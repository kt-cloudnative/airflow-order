...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG207B',WORKFLOW_ID='45da2172d2bd4984ba5f23a35d7f1e0f', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG207B-0.0.prd-tz.6.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('45da2172d2bd4984ba5f23a35d7f1e0f')
    ...
    csng207bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'ae51fbe6658744d5a17df1f40651d5f2',
        'volumes': csng207bJob_vol,
        'volume_mounts': csng207bJob_volMnt,
        'env_from':csng207bJob_env,
        'task_id':'csng207bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.7',
        'arguments':["--job.name=csng207bJob", "endTranDate=20241129", "empNo=952794853","ver="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('45da2172d2bd4984ba5f23a35d7f1e0f')
