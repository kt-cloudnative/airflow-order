...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD108B',WORKFLOW_ID='373de757fefa4f6d993f4b3fcfee9b55', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD108B-0.0.prd-tz.2.2'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('373de757fefa4f6d993f4b3fcfee9b55')
    ...
    cbod108bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'd1ed9ecbf58a43da99e97aa8d6157c4a',
    ...
    Complete = COMMON.getICISCompleteWflowTask('373de757fefa4f6d993f4b3fcfee9b55')
