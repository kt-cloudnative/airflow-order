...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG633B',WORKFLOW_ID='2a4497778e69487eb5521a66de82e2dd', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG633B-0.0.prd-tz.4.2'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('2a4497778e69487eb5521a66de82e2dd')
    ...
    csng633bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '58d1e8696588423d9ce5923989cb4994',
...
, "pgmNm=csng633b" ],
    ...
    Complete = COMMON.getICISCompleteWflowTask('2a4497778e69487eb5521a66de82e2dd')
