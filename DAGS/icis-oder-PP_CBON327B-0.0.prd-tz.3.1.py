...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON327B',WORKFLOW_ID='88805f5b07b543dc88b18a5ce8d14cb6', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON327B-0.0.prd-tz.3.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('88805f5b07b543dc88b18a5ce8d14cb6')
    ...
    cbon327bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'd4c8d345111f429cb741181284876235',
    ...
    Complete = COMMON.getICISCompleteWflowTask('88805f5b07b543dc88b18a5ce8d14cb6')
