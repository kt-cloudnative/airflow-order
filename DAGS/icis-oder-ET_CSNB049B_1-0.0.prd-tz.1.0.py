...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNB049B_1',WORKFLOW_ID='8ebc6439de4e47c5b4e09464e5b6bc63', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNB049B_1-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('8ebc6439de4e47c5b4e09464e5b6bc63')
    ...
    csnb049bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'd73c3c041d1540eb92ba737d0f42ed90',
    ...
    Complete = COMMON.getICISCompleteWflowTask('8ebc6439de4e47c5b4e09464e5b6bc63')
