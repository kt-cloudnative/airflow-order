...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSND222B',WORKFLOW_ID='109c09a24d62454d907ce33ee26db6cc', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSND222B-0.0.prd-tz.4.0'
    ,'schedule_interval':'00 21 * * *'
    ,'start_date': datetime(2024, 7, 3, 0, 0, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
    ,'max_active_runs': 16
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('109c09a24d62454d907ce33ee26db6cc')

    csnd222bJob_vol = []
    csnd222bJob_volMnt = []
    csnd222bJob_vol.append(getVolume('t-order-ftp-pvc','t-order-ftp-pvc'))
    csnd222bJob_volMnt.append(getVolumeMount('t-order-ftp-pvc','/app/order'))
    ...
    csnd222bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'edd3a935f1b64bf79496c1c85a35307c',
    ...
    Complete = COMMON.getICISCompleteWflowTask('109c09a24d62454d907ce33ee26db6cc')
