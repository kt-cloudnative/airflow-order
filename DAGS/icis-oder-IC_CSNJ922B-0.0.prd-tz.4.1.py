...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IC_CSNJ922B',WORKFLOW_ID='dc8d64093fd44918943397d144c567f3', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IC_CSNJ922B-0.0.prd-tz.4.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('dc8d64093fd44918943397d144c567f3')
    ...
    csnj922bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'fc1be44850ef4f4fa61c621152148640',
    ...
    Complete = COMMON.getICISCompleteWflowTask('dc8d64093fd44918943397d144c567f3')
