...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNB041B',WORKFLOW_ID='d943d52e60e642aca04d86d6bb5ea0c4', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNB041B-0.4.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('d943d52e60e642aca04d86d6bb5ea0c4')
    ...
    csnb041bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'b6a8267acd32413a9fcf9ffe4fe2c16f',
    ...
    Complete = COMMON.getICISCompleteWflowTask('d943d52e60e642aca04d86d6bb5ea0c4')
