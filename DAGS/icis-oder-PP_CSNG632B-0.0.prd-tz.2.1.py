...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG632B',WORKFLOW_ID='330519a7da994553b6a098d57dccd3a3', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG632B-0.0.prd-tz.2.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('330519a7da994553b6a098d57dccd3a3')
    ...
    csng632bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '495049110e2542b2b80ed945a8b113bb',
...
, "endTranDate=${YYYYMM}","pgmNm=csng632b"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('330519a7da994553b6a098d57dccd3a3')
