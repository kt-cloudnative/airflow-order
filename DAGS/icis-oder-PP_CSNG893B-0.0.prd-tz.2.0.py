...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG893B',WORKFLOW_ID='68884b59eaf24b5d8112fc45758fafac', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG893B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('68884b59eaf24b5d8112fc45758fafac')

    csng893bJob_vol = []
    csng893bJob_volMnt = []
    csng893bJob_vol.append(getVolume('shared-volume','shared-volume'))
    csng893bJob_volMnt.append(getVolumeMount('shared-volume','/app/order'))
    ...
    csng893bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '32d3225bfcc54d1488ce084523c0a619',
        'volumes': csng893bJob_vol,
        'volume_mounts': csng893bJob_volMnt,
        'env_from':csng893bJob_env,
        'task_id':'csng893bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.7',
        'arguments':["--job.name=csng893bJob"," endTranDate=202411", "requestDate="+str(datetime.now())	],
    ...
    Complete = COMMON.getICISCompleteWflowTask('68884b59eaf24b5d8112fc45758fafac')
