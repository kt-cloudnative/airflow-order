...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD206B',WORKFLOW_ID='3857989bb1834c6ba4aced96c5e89639', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD206B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('3857989bb1834c6ba4aced96c5e89639')
    ...
    cbod206bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '16086219f83b43cf861d2c8881d60062',
    ...
    Complete = COMMON.getICISCompleteWflowTask('3857989bb1834c6ba4aced96c5e89639')
