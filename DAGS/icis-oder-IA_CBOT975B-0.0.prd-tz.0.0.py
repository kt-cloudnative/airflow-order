...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IA_CBOT975B',WORKFLOW_ID='185ca8827c354d01a35763f67222e77b', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IA_CBOT975B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('185ca8827c354d01a35763f67222e77b')
    ...
    cbot975bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'e4ca8b0c57764b349c75ca6539311cc3',
        'volumes': cbot975bJob_vol,
        'volume_mounts': cbot975bJob_volMnt,
        'env_from':cbot975bJob_env,
        'task_id':'cbot975bJob',
        'image':'/icis/icis-oder-inetaplca-batch:0.4.1.7',
    ...
    Complete = COMMON.getICISCompleteWflowTask('185ca8827c354d01a35763f67222e77b')
