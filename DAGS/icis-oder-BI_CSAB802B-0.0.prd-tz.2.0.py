...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='BI_CSAB802B',WORKFLOW_ID='1d7b38c1fcfd44a7843cffe5e8cd76f9', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-BI_CSAB802B-0.0.prd-tz.2.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 8, 17, 12, 10, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
    ,'max_active_runs': 16
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('1d7b38c1fcfd44a7843cffe5e8cd76f9')
    ...
    csab802bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'c64a7a84de6e44d6a13a7bcd1d0b725b',
        ...
        'arguments':["--job.name=csab802bJob", "requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('1d7b38c1fcfd44a7843cffe5e8cd76f9')
