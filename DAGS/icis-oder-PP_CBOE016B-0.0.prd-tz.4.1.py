...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOE016B',WORKFLOW_ID='536aaa7b3caa40d081dceb1ddcb6d115', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOE016B-0.0.prd-tz.4.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('536aaa7b3caa40d081dceb1ddcb6d115')
    ...
    cboe016bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '51abfe95258f4a618e8c2e3b31e92c00',
...
, "yyyyMm=${YYYYMM}", "svcName=cboe016bJob"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('536aaa7b3caa40d081dceb1ddcb6d115')
