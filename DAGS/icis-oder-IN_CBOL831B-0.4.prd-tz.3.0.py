...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IN_CBOL831B',WORKFLOW_ID='613b58c5bbd64eb4aeb2df1a7e63e763', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IN_CBOL831B-0.4.prd-tz.3.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('613b58c5bbd64eb4aeb2df1a7e63e763')
    ...
    cbol831bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'db72f168f405440387bbc2a6503a9d37',
    ...
    Complete = COMMON.getICISCompleteWflowTask('613b58c5bbd64eb4aeb2df1a7e63e763')
