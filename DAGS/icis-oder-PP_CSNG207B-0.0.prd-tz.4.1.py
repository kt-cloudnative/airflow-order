...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG207B',WORKFLOW_ID='2e0b02a8d0334fab961a32b1cdc9c690', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG207B-0.0.prd-tz.4.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('2e0b02a8d0334fab961a32b1cdc9c690')
    ...
    csng207bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '21226b9fcc554054adde66c497b44ecd',
        'volumes': csng207bJob_vol,
        'volume_mounts': csng207bJob_volMnt,
        'env_from':csng207bJob_env,
        'task_id':'csng207bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=csng207bJob", "endTranDate=20240528", "empNo=952794853","ver="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('2e0b02a8d0334fab961a32b1cdc9c690')
