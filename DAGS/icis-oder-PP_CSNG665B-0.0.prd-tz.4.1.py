...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG665B',WORKFLOW_ID='6beca30b0b34477ab40bb2d621e4be76', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG665B-0.0.prd-tz.4.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('6beca30b0b34477ab40bb2d621e4be76')
    ...
    csng665bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '486dc784ff9b4268bd7e30c8ff7ce9d0',
    ...
    Complete = COMMON.getICISCompleteWflowTask('6beca30b0b34477ab40bb2d621e4be76')
