...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD202B',WORKFLOW_ID='a6946855debf4537b8d9f6a466ae8573', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD202B-0.0.prd-tz.5.1'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 29, 10, 29, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('a6946855debf4537b8d9f6a466ae8573')
    ...
    cbod202bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'dfec8506f6d340db9423b97daae67f23',
        'volumes': cbod202bJob_vol,
        'volume_mounts': cbod202bJob_volMnt,
        'env_from':cbod202bJob_env,
        'task_id':'cbod202bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=cbod202bJob", "endTranDate=20240430", "fromTime=00", "toTime=13", "requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('a6946855debf4537b8d9f6a466ae8573')
