...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IA_CBOT957B',WORKFLOW_ID='83613b9b98ce40508c9715859b793f9c', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IA_CBOT957B-0.0.prd-tz.3.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('83613b9b98ce40508c9715859b793f9c')
    ...
    cbot957bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'eafbcc2cff774d9894269b2241f5db68',
    ...
    Complete = COMMON.getICISCompleteWflowTask('83613b9b98ce40508c9715859b793f9c')
