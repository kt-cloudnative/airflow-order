...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='EI_CBOT315B',WORKFLOW_ID='2c6d919c59594d5494133c40881ae720', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-EI_CBOT315B-0.0.prd-tz.1.1'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 1, 1, 12, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
    ,'max_active_runs':1
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('2c6d919c59594d5494133c40881ae720')
    ...
    cbot315bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '334719ff1be349a8a22e75852153f70e',
    ...
    cbod445bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '6d7ef1fcf8dd4962a88f32bebdd5333d',
    ...
    Complete = COMMON.getICISCompleteWflowTask('2c6d919c59594d5494133c40881ae720')
