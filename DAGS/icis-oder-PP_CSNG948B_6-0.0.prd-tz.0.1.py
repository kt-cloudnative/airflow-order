...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG948B_6',WORKFLOW_ID='82734ba61d7b4d8ebc0d061cc4b9ec98', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG948B_6-0.0.prd-tz.0.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('82734ba61d7b4d8ebc0d061cc4b9ec98')
    ...
    csng948bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'dbf3cbdef7684fd2b28a1fa5540a0f23',
        'volumes': csng948bJob_vol,
        'volume_mounts': csng948bJob_volMnt,
        'env_from':csng948bJob_env,
        'task_id':'csng948bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.5',
        'arguments':["--job.name=csng948bJob", "applyDate=${YYYYMM}", "saIdSecEnum=6"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('82734ba61d7b4d8ebc0d061cc4b9ec98')
