...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG622B',WORKFLOW_ID='cd6a05aaba0b481a9b58c1097a7288b1', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG622B-0.0.prd-tz.3.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('cd6a05aaba0b481a9b58c1097a7288b1')
    ...
    Complete = COMMON.getICISCompleteWflowTask('cd6a05aaba0b481a9b58c1097a7288b1')
