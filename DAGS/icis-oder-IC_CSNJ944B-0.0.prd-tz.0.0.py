...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IC_CSNJ944B',WORKFLOW_ID='77dcd09da1a945b38a481721368b9db4', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IC_CSNJ944B-0.0.prd-tz.0.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2025, 1, 10, 14, 26, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
    ,'max_active_runs':1
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('77dcd09da1a945b38a481721368b9db4')
    ...
    csnj944bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '5286176569714fddacfd099f569caa57',
    ...
    Complete = COMMON.getICISCompleteWflowTask('77dcd09da1a945b38a481721368b9db4')
