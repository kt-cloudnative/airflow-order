...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNG918B_2',WORKFLOW_ID='c363438cc90e49129c33fafc7ec63946', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNG918B_2-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('c363438cc90e49129c33fafc7ec63946')
    ...
    csng918bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '5d78f881eaa34f419d7f82a435d1e359',
    ...
    Complete = COMMON.getICISCompleteWflowTask('c363438cc90e49129c33fafc7ec63946')
