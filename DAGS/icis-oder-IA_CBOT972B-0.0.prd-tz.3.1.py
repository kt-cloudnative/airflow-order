...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IA_CBOT972B',WORKFLOW_ID='38a7274eff054d5ea9e110d000124695', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IA_CBOT972B-0.0.prd-tz.3.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('38a7274eff054d5ea9e110d000124695')
    ...
    cbot972bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'e54000a5d2f940af881fc8f6ca6b1593',
    ...
    Complete = COMMON.getICISCompleteWflowTask('38a7274eff054d5ea9e110d000124695')
