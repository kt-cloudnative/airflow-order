...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IC_CBON308B',WORKFLOW_ID='a2dfebf917d541fab7c14d8dfe2005d3', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IC_CBON308B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('a2dfebf917d541fab7c14d8dfe2005d3')

    cbon308bJob_vol = []
    cbon308bJob_volMnt = []
    cbon308bJob_vol.append(getVolume('shared-volume','shared-volume'))
    cbon308bJob_volMnt.append(getVolumeMount('shared-volume',''))
    ...
    cbon308bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '74c6099a13cb4fffbcc7945305af1d44',
    ...
    Complete = COMMON.getICISCompleteWflowTask('a2dfebf917d541fab7c14d8dfe2005d3')
