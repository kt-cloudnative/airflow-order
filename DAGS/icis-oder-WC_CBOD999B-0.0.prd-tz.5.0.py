...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='WC_CBOD999B',WORKFLOW_ID='f9ca040b4b2445938aa4a910a951875b', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-WC_CBOD999B-0.0.prd-tz.5.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 7, 20, 10, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
    ,'max_active_runs': 16
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('f9ca040b4b2445938aa4a910a951875b')
    ...
    cbod999bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '193b4380fc204830aa2681c1b1300166',
    ...
    Complete = COMMON.getICISCompleteWflowTask('f9ca040b4b2445938aa4a910a951875b')
