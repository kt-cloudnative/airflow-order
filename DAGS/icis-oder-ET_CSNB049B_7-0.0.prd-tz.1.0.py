...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNB049B_7',WORKFLOW_ID='f70bef43f0ba4f268d035965946f6cc4', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNB049B_7-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('f70bef43f0ba4f268d035965946f6cc4')
    ...
    csnb049bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '67b941a6e25345f18126b61564be912c',
    ...
    Complete = COMMON.getICISCompleteWflowTask('f70bef43f0ba4f268d035965946f6cc4')
