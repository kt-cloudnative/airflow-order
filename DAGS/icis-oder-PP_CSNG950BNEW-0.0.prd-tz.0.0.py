...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG950BNEW',WORKFLOW_ID='738d6dc498014caaa2e0353a977e7f32', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG950BNEW-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('738d6dc498014caaa2e0353a977e7f32')
    ...
    csng950bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'de5020bb88f44b80887621cf87fa1901',
    ...
    Complete = COMMON.getICISCompleteWflowTask('738d6dc498014caaa2e0353a977e7f32')
