...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='BI_CBOL411B',WORKFLOW_ID='48f93804e5334a649fd88639e6b7e2e6', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-BI_CBOL411B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('48f93804e5334a649fd88639e6b7e2e6')
    ...
    cbol411bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '54faa1b9bac8405e9944651d4a5d139d',
    ...
    Complete = COMMON.getICISCompleteWflowTask('48f93804e5334a649fd88639e6b7e2e6')
