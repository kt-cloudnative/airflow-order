...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD703B',WORKFLOW_ID='49164ffe4bae479f8b4875332a871606', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD703B-0.0.prd-tz.3.2'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('49164ffe4bae479f8b4875332a871606')
    ...
    cbod703bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'be91e7e11ac6484d9d8c15f73937ce0e',
    ...
    Complete = COMMON.getICISCompleteWflowTask('49164ffe4bae479f8b4875332a871606')
