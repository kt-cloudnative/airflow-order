...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD117B',WORKFLOW_ID='68f459895cb3485fa2bb789f38153e9f', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD117B-0.0.prd-tz.1.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 4, 9, 22, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('68f459895cb3485fa2bb789f38153e9f')
    ...
    cbod117bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '22fc2bac444447be8a43cbd9d983856d',
        'volumes': cbod117bJob_vol,
        'volume_mounts': cbod117bJob_volMnt,
        'env_from':cbod117bJob_env,
        'task_id':'cbod117bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.49',
        'arguments':["--job.name=cbod117bJob", "endTranDate=20240731", "fromTime=14","toTime=24" , "requestDate=${YYYYMMDDHHMISS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('68f459895cb3485fa2bb789f38153e9f')
