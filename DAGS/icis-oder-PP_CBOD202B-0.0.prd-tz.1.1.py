...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD202B',WORKFLOW_ID='0253f994766e42698a4c4187deac826d', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD202B-0.0.prd-tz.1.1'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 4, 12, 0, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('0253f994766e42698a4c4187deac826d')
    ...
    cbod202bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '34cdb9378d78465d8c384691457ae17e',
    ...
    Complete = COMMON.getICISCompleteWflowTask('0253f994766e42698a4c4187deac826d')
