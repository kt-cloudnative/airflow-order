...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON313B',WORKFLOW_ID='54aa6fba35094fdd8c42fb6fc80a8f09', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON313B-0.0.prd-tz.3.3'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('54aa6fba35094fdd8c42fb6fc80a8f09')
    ...
    cbon313bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'b264bf06338242aa8aa1a9ff95565835',
        'volumes': cbon313bJob_vol,
        'volume_mounts': cbon313bJob_volMnt,
        'env_from':cbon313bJob_env,
        'task_id':'cbon313bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=cbon313bJob","endTranDate=20240529","requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('54aa6fba35094fdd8c42fb6fc80a8f09')
