...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IA_CBOT937B',WORKFLOW_ID='060d7ff5d9504cbd8a997b06ce0d55bb', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IA_CBOT937B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('060d7ff5d9504cbd8a997b06ce0d55bb')
    ...
    cbot937bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '5133570f6c2949669f096733b07514b4',
    ...
    Complete = COMMON.getICISCompleteWflowTask('060d7ff5d9504cbd8a997b06ce0d55bb')
