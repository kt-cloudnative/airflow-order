...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IN_CBON323B',WORKFLOW_ID='1c48380d736443febde32978c4ac2f98', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IN_CBON323B-0.4.prd-tz.3.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('1c48380d736443febde32978c4ac2f98')

    cbon323bJob_vol = []
    cbon323bJob_volMnt = []
    cbon323bJob_vol.append(getVolume('t-order-ftp-pvc','t-order-ftp-pvc'))
    cbon323bJob_volMnt.append(getVolumeMount('t-order-ftp-pvc','/app/order'))
    ...
    cbon323bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '9a3cf35bd9af4c61bf2d2fba4d8a6bba',
    ...
    Complete = COMMON.getICISCompleteWflowTask('1c48380d736443febde32978c4ac2f98')
