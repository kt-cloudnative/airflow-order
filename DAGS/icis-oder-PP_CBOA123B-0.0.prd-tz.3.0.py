...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOA123B',WORKFLOW_ID='27a621315d314149876b5daaa317dda4', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOA123B-0.0.prd-tz.3.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('27a621315d314149876b5daaa317dda4')
    ...
    cboa123bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '6c13e32e40104b838a884e1f180e00b0',
    ...
    Complete = COMMON.getICISCompleteWflowTask('27a621315d314149876b5daaa317dda4')
