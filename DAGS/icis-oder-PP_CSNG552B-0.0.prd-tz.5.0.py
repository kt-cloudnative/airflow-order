...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG552B',WORKFLOW_ID='f1b863e654754df09b740d886d3bcbfd', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG552B-0.0.prd-tz.5.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('f1b863e654754df09b740d886d3bcbfd')
    ...
    Complete = COMMON.getICISCompleteWflowTask('f1b863e654754df09b740d886d3bcbfd')
