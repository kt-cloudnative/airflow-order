...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNG466B',WORKFLOW_ID='c5f6b785f9634ad4ae95bce1a01a14e8', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNG466B-0.4.prd-tz.0.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('c5f6b785f9634ad4ae95bce1a01a14e8')
    ...
    csng466bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '9423c6af36a84990ae8f81cc617940d0',
        ...
        'arguments':["--job.name=csng466bJob", "procDate=20240731", "regOfcCd=999999", "regEmpNo=99999999", "regEmpName=test9999", "requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('c5f6b785f9634ad4ae95bce1a01a14e8')
