...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOX001B',WORKFLOW_ID='1402d2b3284540e283d204d328e05b7f', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOX001B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('1402d2b3284540e283d204d328e05b7f')

    cbox001bJob_vol = []
    cbox001bJob_volMnt = []
    cbox001bJob_vol.append(getVolume('shared-volume','shared-volume'))
    cbox001bJob_volMnt.append(getVolumeMount('shared-volume','/app/order'))
    ...
    cbox001bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'd5b40f6919f54eb896531085b1107f4f',
        'volumes': cbox001bJob_vol,
        'volume_mounts': cbox001bJob_volMnt,
        'env_from':cbox001bJob_env,
        'task_id':'cbox001bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.7',
        'arguments':["--job.name=cbox001bJob", "requestDate="+str(datetime.now()), "procDate=20241129"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('1402d2b3284540e283d204d328e05b7f')
