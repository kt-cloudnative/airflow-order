...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD112B',WORKFLOW_ID='07f95ab69f4f40d9b30087ef8027824d', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD112B-0.0.prd-tz.2.1'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 19, 22, 0, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('07f95ab69f4f40d9b30087ef8027824d')
    ...
    cbod112bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'a966d39f1f654a1c8e647b4773f7732f',
    ...
    Complete = COMMON.getICISCompleteWflowTask('07f95ab69f4f40d9b30087ef8027824d')
