...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG917B',WORKFLOW_ID='82a6778fa3024f15a13e5df9eedbd2f7', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG917B-0.0.prd-tz.3.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('82a6778fa3024f15a13e5df9eedbd2f7')
    ...
    Complete = COMMON.getICISCompleteWflowTask('82a6778fa3024f15a13e5df9eedbd2f7')
