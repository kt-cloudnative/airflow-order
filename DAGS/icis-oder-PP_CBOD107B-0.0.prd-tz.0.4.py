...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD107B',WORKFLOW_ID='8f994e79e9a34dd2a653a3bde8a60a37', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD107B-0.0.prd-tz.0.4'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 4, 9, 25, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('8f994e79e9a34dd2a653a3bde8a60a37')
    ...
    cbod107bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '5d2084f7e7794428a1a0788055266792',
    ...
    Complete = COMMON.getICISCompleteWflowTask('8f994e79e9a34dd2a653a3bde8a60a37')
