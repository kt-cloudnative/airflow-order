...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG506B_06',WORKFLOW_ID='28c17464a7c8498baaef632739aa971e', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG506B_06-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('28c17464a7c8498baaef632739aa971e')
    ...
    csng506bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '43237acfb8b44e1f9b323e3341041a08',
        'volumes': csng506bJob_vol,
        'volume_mounts': csng506bJob_volMnt,
        'env_from':csng506bJob_env,
        'task_id':'csng506bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.132',
        'arguments':["--job.name=csng506bJob", "argv2=0042", "argv3=Y", "requestDate=${YYYYMM}" , "duplPrvnDate=${YYYYMMDDHHMISSSSS}"
],
    ...
    Complete = COMMON.getICISCompleteWflowTask('28c17464a7c8498baaef632739aa971e')
