...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IA_CBOT964B',WORKFLOW_ID='5b066bac83844680943bf4a8757f177c', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IA_CBOT964B-0.2.prd-tz.3.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('5b066bac83844680943bf4a8757f177c')
    ...
    cbot964bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '7f74ab1a21dd453396ac3c8171e4397d',
    ...
    Complete = COMMON.getICISCompleteWflowTask('5b066bac83844680943bf4a8757f177c')
