...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IN_CBON323B',WORKFLOW_ID='e7ac729d768944a58281b3dcdd4e8eba', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IN_CBON323B-0.4.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('e7ac729d768944a58281b3dcdd4e8eba')
    ...
    cbon323bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '700c4d0dbc6c4093a3afe5f91c350341',
    ...
    Complete = COMMON.getICISCompleteWflowTask('e7ac729d768944a58281b3dcdd4e8eba')
