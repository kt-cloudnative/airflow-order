...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG030B',WORKFLOW_ID='ae478c4ec4c54ab7906111855adc73c9', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG030B-0.0.prd-tz.0.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 7, 26, 0, 0, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
    ,'max_active_runs': 16
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('ae478c4ec4c54ab7906111855adc73c9')
    ...
    csng030bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '6bad1cc5b2fd4352a102c71a1cb39d06',
        'volumes': csng030bJob_vol,
        'volume_mounts': csng030bJob_volMnt,
        'env_from':csng030bJob_env,
        'task_id':'csng030bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.5',
        'arguments':["--job.name=csng030bJob","argv1=${YYYYMM}", "testRequestDate=${YYYYMMDDHHMISS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('ae478c4ec4c54ab7906111855adc73c9')
