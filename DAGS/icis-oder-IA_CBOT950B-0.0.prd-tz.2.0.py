...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IA_CBOT950B',WORKFLOW_ID='d166a1466c3f42d89c57890433440382', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IA_CBOT950B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('d166a1466c3f42d89c57890433440382')
    ...
    cbot950bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '16233842515e4e19ac0fa2c8c07de4a8',
    ...
    Complete = COMMON.getICISCompleteWflowTask('d166a1466c3f42d89c57890433440382')
