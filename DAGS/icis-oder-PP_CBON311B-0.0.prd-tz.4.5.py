...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON311B',WORKFLOW_ID='cd4b6123c75b4f5688fc07a4d473f370', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON311B-0.0.prd-tz.4.5'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('cd4b6123c75b4f5688fc07a4d473f370')
    ...
    cbon311bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '57c325b68cda4c1dbd38591d22f989a7',
        'volumes': cbon311bJob_vol,
        'volume_mounts': cbon311bJob_volMnt,
        'env_from':cbon311bJob_env,
        'task_id':'cbon311bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=cbon311bJob", "endTranDate=20240430", "ver="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('cd4b6123c75b4f5688fc07a4d473f370')
