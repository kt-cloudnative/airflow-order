...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG506B_15',WORKFLOW_ID='42bbd28ada6344ccb76af4186dc18f85', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG506B_15-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('42bbd28ada6344ccb76af4186dc18f85')
    ...
    csng506bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '285f5b31a5b64ceb9f22e986ef703490',
        'volumes': csng506bJob_vol,
        'volume_mounts': csng506bJob_volMnt,
        'env_from':csng506bJob_env,
        'task_id':'csng506bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.132',
        'arguments':["--job.name=csng506bJob", "argv2=0062", "argv3=Y", "requestDate=${YYYYMM}" , "duplPrvnDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('42bbd28ada6344ccb76af4186dc18f85')
