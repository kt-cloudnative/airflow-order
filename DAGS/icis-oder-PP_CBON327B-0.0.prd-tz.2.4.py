...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON327B',WORKFLOW_ID='3bfef425ab4c4394973694d454821583', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON327B-0.0.prd-tz.2.4'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 22, 15, 56, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('3bfef425ab4c4394973694d454821583')
    ...
    cbon327bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'a967cb2b616d43a095a4df7ee32a7fd5',
        'volumes': cbon327bJob_vol,
        'volume_mounts': cbon327bJob_volMnt,
        'env_from':cbon327bJob_env,
        'task_id':'cbon327bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=cbon327bJob", "endTranDate=20240530","ver="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('3bfef425ab4c4394973694d454821583')
