...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IA_CBOT950B',WORKFLOW_ID='36ec381d35ce483198edfc7fd805f06b', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IA_CBOT950B-0.0.prd-tz.6.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('36ec381d35ce483198edfc7fd805f06b')
    ...
    cbot950bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'f5766932f8d9467e8eaed1c9345bd261',
    ...
    Complete = COMMON.getICISCompleteWflowTask('36ec381d35ce483198edfc7fd805f06b')
