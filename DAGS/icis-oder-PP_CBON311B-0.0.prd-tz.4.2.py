...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON311B',WORKFLOW_ID='41891b0123d24c498fbdf71bcbeeefb0', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON311B-0.0.prd-tz.4.2'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('41891b0123d24c498fbdf71bcbeeefb0')
    ...
    cbon311bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'f478218bb5f34bed8a964583ac9a29fa',
    ...
    Complete = COMMON.getICISCompleteWflowTask('41891b0123d24c498fbdf71bcbeeefb0')
