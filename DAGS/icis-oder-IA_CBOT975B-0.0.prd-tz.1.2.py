...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IA_CBOT975B',WORKFLOW_ID='2b8ec84efb19401d8e061c9e194d90a3', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IA_CBOT975B-0.0.prd-tz.1.2'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('2b8ec84efb19401d8e061c9e194d90a3')
    ...
    cbot975bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '7fb5b625847a48f5831aeed045f2e7de',
    ...
    Complete = COMMON.getICISCompleteWflowTask('2b8ec84efb19401d8e061c9e194d90a3')
