...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD106B',WORKFLOW_ID='8eb1a2f3568549b0814fae047365a1e6', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD106B-0.0.prd-tz.3.5'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('8eb1a2f3568549b0814fae047365a1e6')
    ...
    cbod106bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '7d6ad8718edd4a03a52ea18783885185',
        'volumes': cbod106bJob_vol,
        'volume_mounts': cbod106bJob_volMnt,
        'env_from':cbod106bJob_env,
        'task_id':'cbod106bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=cbod106bJob", "workDate=20240430", "saveSaId=24994981504","saveOrdNo=24268GH21545893", "requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('8eb1a2f3568549b0814fae047365a1e6')
