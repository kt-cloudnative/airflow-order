...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON311B',WORKFLOW_ID='480cdec0ae5046428143e67514a14f98', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON311B-0.0.prd-tz.7.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('480cdec0ae5046428143e67514a14f98')
    ...
    cbon311bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '21c470d192e848569983fa8a7be67ae6',
        'volumes': cbon311bJob_vol,
        'volume_mounts': cbon311bJob_volMnt,
        'env_from':cbon311bJob_env,
        'task_id':'cbon311bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.7',
        'arguments':["--job.name=cbon311bJob", "endTranDate=20241129, "requestDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('480cdec0ae5046428143e67514a14f98')
