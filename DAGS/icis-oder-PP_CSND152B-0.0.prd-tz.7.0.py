...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSND152B',WORKFLOW_ID='6948db4968e14939b7cc059f6e6bf143', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSND152B-0.0.prd-tz.7.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('6948db4968e14939b7cc059f6e6bf143')
    ...
    Complete = COMMON.getICISCompleteWflowTask('6948db4968e14939b7cc059f6e6bf143')
