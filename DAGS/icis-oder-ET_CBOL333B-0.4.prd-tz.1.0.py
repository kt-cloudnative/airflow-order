...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CBOL333B',WORKFLOW_ID='a98056b2487c404ca5c75ebb7ffaa7dd', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CBOL333B-0.4.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('a98056b2487c404ca5c75ebb7ffaa7dd')
    ...
    cbol333bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'cc6830e744ff4c0b9b4bd946f37d7535',
    ...
    Complete = COMMON.getICISCompleteWflowTask('a98056b2487c404ca5c75ebb7ffaa7dd')
