...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IC_CSNJ921B',WORKFLOW_ID='d358efa83edf4454bf87aa170a54e7e0', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IC_CSNJ921B-0.0.prd-tz.4.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('d358efa83edf4454bf87aa170a54e7e0')
    ...
    csnj921bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '6985cc457cf14fddbcb1f3ae79da5f5c',
    ...
    Complete = COMMON.getICISCompleteWflowTask('d358efa83edf4454bf87aa170a54e7e0')
