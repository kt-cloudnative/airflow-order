...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOA123B',WORKFLOW_ID='3a61c9cf326c4c14b0dff6d1614e95e4', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOA123B-0.0.prd-tz.1.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 1, 18, 42, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('3a61c9cf326c4c14b0dff6d1614e95e4')
    ...
    cboa123bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '7f5f129c99de4dda8124555acff21774',
    ...
    Complete = COMMON.getICISCompleteWflowTask('3a61c9cf326c4c14b0dff6d1614e95e4')
