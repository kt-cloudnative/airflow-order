...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG110B',WORKFLOW_ID='09d743eed0854a288ff9fe5cea316575', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG110B-0.1.prd-tz.6.0'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 29, 10, 49, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('09d743eed0854a288ff9fe5cea316575')
    ...
    csng110bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '908aed7c57e946e9acd274285e3bb183',
        'volumes': csng110bJob_vol,
        'volume_mounts': csng110bJob_volMnt,
        'env_from':csng110bJob_env,
        'task_id':'csng110bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=csng110bJob", "workDay=20240430", "empNo=91326888", "requestDate="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('09d743eed0854a288ff9fe5cea316575')
