...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNC130B',WORKFLOW_ID='260f607da80a4645bd92fbad80d5f940', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNC130B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('260f607da80a4645bd92fbad80d5f940')
    ...
    csnc130bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'a09b7b925cba4ef4ab70363043168f8b',
    ...
    Complete = COMMON.getICISCompleteWflowTask('260f607da80a4645bd92fbad80d5f940')
