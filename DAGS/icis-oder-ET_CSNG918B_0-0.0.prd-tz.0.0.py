...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNG918B_0',WORKFLOW_ID='33d6623d133b4bc08014b19c8c950bad', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNG918B_0-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('33d6623d133b4bc08014b19c8c950bad')
    ...
    csng918bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'b172f53cb3fe49a99ca752e275eb7dcc',
    ...
    Complete = COMMON.getICISCompleteWflowTask('33d6623d133b4bc08014b19c8c950bad')
