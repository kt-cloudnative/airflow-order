...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IA_CBOT961B',WORKFLOW_ID='a4972d77974543c3ac45bcd72ae22ba9', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IA_CBOT961B-0.2.prd-tz.2.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('a4972d77974543c3ac45bcd72ae22ba9')
    ...
    cbot961bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '1eed1a9824a544ad82af1b3fc6124cae',
    ...
    Complete = COMMON.getICISCompleteWflowTask('a4972d77974543c3ac45bcd72ae22ba9')
