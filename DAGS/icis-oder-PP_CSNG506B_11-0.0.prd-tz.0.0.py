...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG506B_11',WORKFLOW_ID='01436c61058743b781628289a248f5f1', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG506B_11-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('01436c61058743b781628289a248f5f1')
    ...
    csng506bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '3c2bf7ae6c5f45fe959248dcf817e7a0',
        'volumes': csng506bJob_vol,
        'volume_mounts': csng506bJob_volMnt,
        'env_from':csng506bJob_env,
        'task_id':'csng506bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.132',
        'arguments':["--job.name=csng506bJob", "argv2=0053", "argv3=Y", "requestDate=${YYYYMM}" , "duplPrvnDate=${YYYYMMDDHHMISSSSS}"
],
    ...
    Complete = COMMON.getICISCompleteWflowTask('01436c61058743b781628289a248f5f1')
