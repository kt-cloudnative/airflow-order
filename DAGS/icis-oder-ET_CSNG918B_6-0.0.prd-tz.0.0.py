...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNG918B_6',WORKFLOW_ID='e7904a29257644868ada825b6756b9fd', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNG918B_6-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('e7904a29257644868ada825b6756b9fd')
    ...
    csng918bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '18026749f2e84597ad9d7f21db830e1f',
    ...
    Complete = COMMON.getICISCompleteWflowTask('e7904a29257644868ada825b6756b9fd')
