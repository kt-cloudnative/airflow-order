...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG949B',WORKFLOW_ID='041b4101aea34c9bb0dbdd7fc07bb2e2', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG949B-0.0.prd-tz.3.3'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('041b4101aea34c9bb0dbdd7fc07bb2e2')
    ...
    csng949bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'd9debde4a21e488086a0a42f1ea70e04',
...
"date="+str(datetime.now().strftime("%Y%m%d%H%M%S"))],
    ...
    Complete = COMMON.getICISCompleteWflowTask('041b4101aea34c9bb0dbdd7fc07bb2e2')
