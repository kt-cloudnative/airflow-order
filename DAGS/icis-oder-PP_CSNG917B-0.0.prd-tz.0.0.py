...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG917B',WORKFLOW_ID='42e8c0c4afcd402888f8a9e43319d61d', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG917B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('42e8c0c4afcd402888f8a9e43319d61d')
    ...
    csng917bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '8360419dcc93433394446414fed3fd40',
    ...
    Complete = COMMON.getICISCompleteWflowTask('42e8c0c4afcd402888f8a9e43319d61d')
