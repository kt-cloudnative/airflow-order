...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG534B',WORKFLOW_ID='c5ccb61145f742dfa37549d4854b47e5', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG534B-0.0.prd-tz.2.4'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('c5ccb61145f742dfa37549d4854b47e5')
    ...
    csng534bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '09408ca3a1e94d62ba052e2713377f01',
        'volumes': csng534bJob_vol,
        'volume_mounts': csng534bJob_volMnt,
        'env_from':csng534bJob_env,
        'task_id':'csng534bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.3',
        'arguments':["--job.name=csng534bJob", "inputDate=20240530","requestDate="+str(datetime.now())
],
    ...
    Complete = COMMON.getICISCompleteWflowTask('c5ccb61145f742dfa37549d4854b47e5')
