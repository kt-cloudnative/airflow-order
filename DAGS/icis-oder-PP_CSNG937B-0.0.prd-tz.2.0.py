...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG937B',WORKFLOW_ID='919ce637d83f4d8d80c4193a8583b5d6', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG937B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('919ce637d83f4d8d80c4193a8583b5d6')

    csng937bJob_vol = []
    csng937bJob_volMnt = []
    csng937bJob_vol.append(getVolume('shared-volume','shared-volume'))
    csng937bJob_volMnt.append(getVolumeMount('shared-volume','/app/order'))
    ...
    csng937bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '67a6c20b0096485199a4e084f6fcffe4',
        'volumes': csng937bJob_vol,
        'volume_mounts': csng937bJob_volMnt,
        'env_from':csng937bJob_env,
        'task_id':'csng937bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.7',
        'arguments':["--job.name=csng937bJob", "workDate=20241129", "duplExePram=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('919ce637d83f4d8d80c4193a8583b5d6')
