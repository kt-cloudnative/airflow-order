...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSND225B',WORKFLOW_ID='d45e73a4d11c4951aec052e3076f086f', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSND225B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('d45e73a4d11c4951aec052e3076f086f')
    ...
    csnd225bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '055dad7b1fb848deb3839207ed986b32',
    ...
    Complete = COMMON.getICISCompleteWflowTask('d45e73a4d11c4951aec052e3076f086f')
