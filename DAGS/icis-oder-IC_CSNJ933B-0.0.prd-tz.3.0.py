...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IC_CSNJ933B',WORKFLOW_ID='4e0b140c2abc4149be51237a8b59d7bc', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IC_CSNJ933B-0.0.prd-tz.3.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('4e0b140c2abc4149be51237a8b59d7bc')
    ...
    csnj933bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'd5e57eba6cab4561b974427d93adb70b',
    ...
    Complete = COMMON.getICISCompleteWflowTask('4e0b140c2abc4149be51237a8b59d7bc')
