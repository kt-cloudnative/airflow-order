...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IN_CBOI146B',WORKFLOW_ID='3c4c1dccab4a447f8abec4bb7a248120', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IN_CBOI146B-0.4.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('3c4c1dccab4a447f8abec4bb7a248120')
    ...
    cboi146bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'b1bee62e36a146178497c3273c8650d5',
    ...
    Complete = COMMON.getICISCompleteWflowTask('3c4c1dccab4a447f8abec4bb7a248120')
