...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNB049B_2',WORKFLOW_ID='e2b7305bc2354f2e99388cec840c87cc', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNB049B_2-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('e2b7305bc2354f2e99388cec840c87cc')
    ...
    csnb049bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '9e2b81e21b9342ff96009ac6c584a8ff',
    ...
    Complete = COMMON.getICISCompleteWflowTask('e2b7305bc2354f2e99388cec840c87cc')
