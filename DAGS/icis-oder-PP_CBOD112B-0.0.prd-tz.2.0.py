...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD112B',WORKFLOW_ID='4b8a811c960c4d85adbc053f3291ea83', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD112B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('4b8a811c960c4d85adbc053f3291ea83')
    ...
    cbod112bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '9f7109d5427141e997096f08bebc2006',
    ...
    Complete = COMMON.getICISCompleteWflowTask('4b8a811c960c4d85adbc053f3291ea83')
