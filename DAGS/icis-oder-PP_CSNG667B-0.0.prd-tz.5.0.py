...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG667B',WORKFLOW_ID='2cd65a9ddc2248b9b2d6ecd45e4203c6', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG667B-0.0.prd-tz.5.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('2cd65a9ddc2248b9b2d6ecd45e4203c6')
    ...
    csng667bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'e754e4f59fb544d197f986efb21cf2e5',
        'volumes': csng667bJob_vol,
        'volume_mounts': csng667bJob_volMnt,
        'env_from':csng667bJob_env,
        'task_id':'csng667bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.79',
        'arguments':["--job.name=csng667bJob", "fromDate=20240501", "toDate=20240530", "requestDate="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('2cd65a9ddc2248b9b2d6ecd45e4203c6')
