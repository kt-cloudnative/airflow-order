...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSND152B',WORKFLOW_ID='e1ae4b1d79e84425a768b4698902c065', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSND152B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('e1ae4b1d79e84425a768b4698902c065')
    ...
    Complete = COMMON.getICISCompleteWflowTask('e1ae4b1d79e84425a768b4698902c065')
