...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNB049B_3',WORKFLOW_ID='603003659f424bde9f2b9a94ba76e573', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNB049B_3-0.0.prd-tz.1.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('603003659f424bde9f2b9a94ba76e573')
    ...
    csnb049bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'a071ded3a18f44388780c4b6f7915065',
    ...
    Complete = COMMON.getICISCompleteWflowTask('603003659f424bde9f2b9a94ba76e573')
