...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG122B',WORKFLOW_ID='07aae59643cf4989b984b8d9b109affe', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG122B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('07aae59643cf4989b984b8d9b109affe')
    ...
    csng122bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'd4b48c8244c3446eaa42bc334536115b',
    ...
    Complete = COMMON.getICISCompleteWflowTask('07aae59643cf4989b984b8d9b109affe')
