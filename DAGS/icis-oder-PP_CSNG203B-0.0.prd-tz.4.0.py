...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG203B',WORKFLOW_ID='cb1b40f3f00d4451bca72c3728e64dd1', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG203B-0.0.prd-tz.4.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('cb1b40f3f00d4451bca72c3728e64dd1')
    ...
    csng203bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'be645bba7d154d8a9ea4886b2767712e',
        'volumes': csng203bJob_vol,
        'volume_mounts': csng203bJob_volMnt,
        'env_from':csng203bJob_env,
        'task_id':'csng203bJob',
        'image':'/icis/icis-oder-ppon-batch:0.7.1.7',
        'arguments':["--job.name=csng203bJob", "workMonth=202411", "ver="+str(datetime.now())],
    ...
    Complete = COMMON.getICISCompleteWflowTask('cb1b40f3f00d4451bca72c3728e64dd1')
