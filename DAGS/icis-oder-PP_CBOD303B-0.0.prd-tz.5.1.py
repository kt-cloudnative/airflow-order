...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD303B',WORKFLOW_ID='afe7036204d14fdb97821cd1f3bf5911', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD303B-0.0.prd-tz.5.1'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 29, 10, 45, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('afe7036204d14fdb97821cd1f3bf5911')
    ...
    cbod303bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '43de3b99224d4296b221fe9cf8dab3f8',
...
"endTranDate=20240430"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('afe7036204d14fdb97821cd1f3bf5911')
