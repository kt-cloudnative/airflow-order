...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG506B_17',WORKFLOW_ID='12507c1e8b15442a971330db9dc5cfb9', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG506B_17-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('12507c1e8b15442a971330db9dc5cfb9')
    ...
    csng506bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '1ec16ea14114472f97728a57a4e78da9',
        'volumes': csng506bJob_vol,
        'volume_mounts': csng506bJob_volMnt,
        'env_from':csng506bJob_env,
        'task_id':'csng506bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.132',
        'arguments':["--job.name=csng506bJob", "argv2=0031", "argv3=Y", "requestDate=${YYYYMM}" , "duplPrvnDate=${YYYYMMDDHHMISSSSS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('12507c1e8b15442a971330db9dc5cfb9')
