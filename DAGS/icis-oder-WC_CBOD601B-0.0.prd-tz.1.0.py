...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='WC_CBOD601B',WORKFLOW_ID='97b6f73220d14eb383d5cf9661ba7deb', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-WC_CBOD601B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('97b6f73220d14eb383d5cf9661ba7deb')
    ...
    cbod601bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'deb6a550c4284f569e1e9dc03e17fd85',
        'volumes': cbod601bJob_vol,
        'volume_mounts': cbod601bJob_volMnt,
        'env_from':cbod601bJob_env,
        'task_id':'cbod601bJob',
        'image':'/icis/icis-oder-wrlincomn-batch:0.4.1.16',
    ...
    Complete = COMMON.getICISCompleteWflowTask('97b6f73220d14eb383d5cf9661ba7deb')
