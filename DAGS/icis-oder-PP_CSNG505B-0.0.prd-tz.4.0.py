...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG505B',WORKFLOW_ID='3e63cb47a4614779ae84980e684b8819', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG505B-0.0.prd-tz.4.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('3e63cb47a4614779ae84980e684b8819')
    ...
    csng505bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '1be3c7ab74f04dfd86d0a3332f3416b0',
    ...
    Complete = COMMON.getICISCompleteWflowTask('3e63cb47a4614779ae84980e684b8819')
