...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG552B',WORKFLOW_ID='d9ace9cf3f3c4a909b1868dd5a5b57fe', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG552B-0.0.prd-tz.4.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('d9ace9cf3f3c4a909b1868dd5a5b57fe')
    ...
    csng552bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '3ffe051f7a4c41b486415a93f661f520',
    ...
    Complete = COMMON.getICISCompleteWflowTask('d9ace9cf3f3c4a909b1868dd5a5b57fe')
