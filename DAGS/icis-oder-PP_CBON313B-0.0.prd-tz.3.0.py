...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON313B',WORKFLOW_ID='5f2f21fe3df244cda4ea0c61908b2ff6', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON313B-0.0.prd-tz.3.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('5f2f21fe3df244cda4ea0c61908b2ff6')
    ...
    cbon313bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '76dc642da4d645b6a7dd21405aeb824f',
    ...
    Complete = COMMON.getICISCompleteWflowTask('5f2f21fe3df244cda4ea0c61908b2ff6')
