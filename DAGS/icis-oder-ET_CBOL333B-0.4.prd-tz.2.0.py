...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CBOL333B',WORKFLOW_ID='b137108350ca4ade9eeb5fe3a3c7f33a', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CBOL333B-0.4.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('b137108350ca4ade9eeb5fe3a3c7f33a')
    ...
    cbol333bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'ffbfb32e96e447d09bbb8a8b79c8de3a',
    ...
    Complete = COMMON.getICISCompleteWflowTask('b137108350ca4ade9eeb5fe3a3c7f33a')
