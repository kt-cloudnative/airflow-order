...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD703B',WORKFLOW_ID='8fe5d79be2284716aaf209e4b12fd385', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD703B-0.0.prd-tz.1.1'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 4, 9, 52, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('8fe5d79be2284716aaf209e4b12fd385')
    ...
    cbod703bJob_vol.append(getVolume('t-order-ftp-pvc','t-order-ftp-pvc'))
    cbod703bJob_volMnt.append(getVolumeMount('t-order-ftp-pvc','/app/order'))
    ...
    cbod703bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '6490719fba5b42db835fcb7703de201a',
        'volumes': cbod703bJob_vol,
        'volume_mounts': cbod703bJob_volMnt,
        'env_from':cbod703bJob_env,
        'task_id':'cbod703bJob',
        'image':'/icis/icis-oder-ppon-batch:0.4.1.46',
        'arguments':["--job.name=cbod703bJob" , "endTranDate=20240731","trdDay=202407","requestDate=${YYYYMMDDHHMISS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('8fe5d79be2284716aaf209e4b12fd385')
