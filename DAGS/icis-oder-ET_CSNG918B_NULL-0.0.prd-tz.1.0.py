...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNG918B_NULL',WORKFLOW_ID='a132b663d4a94d59ac03ad672cac7381', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNG918B_NULL-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('a132b663d4a94d59ac03ad672cac7381')
    ...
    csng918bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '1dca0505bb0c4011af324efe89c312f8',
    ...
    Complete = COMMON.getICISCompleteWflowTask('a132b663d4a94d59ac03ad672cac7381')
