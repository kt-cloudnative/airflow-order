...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON305B',WORKFLOW_ID='3ab99e966eeb41ba9250dc0d97fac3c3', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON305B-0.0.prd-tz.4.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('3ab99e966eeb41ba9250dc0d97fac3c3')
    ...
    cbon305bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'a6c95618601d4eddae5f4d9e5071ba41',
    ...
    Complete = COMMON.getICISCompleteWflowTask('3ab99e966eeb41ba9250dc0d97fac3c3')
