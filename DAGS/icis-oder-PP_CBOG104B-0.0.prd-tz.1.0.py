...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOG104B',WORKFLOW_ID='749e7a2715a04165bcbfd1157b2d9160', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOG104B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('749e7a2715a04165bcbfd1157b2d9160')
    ...
    cbog104bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'b4cb3c20e0b24ed181b2d03deb3e28f9',
    ...
    Complete = COMMON.getICISCompleteWflowTask('749e7a2715a04165bcbfd1157b2d9160')
