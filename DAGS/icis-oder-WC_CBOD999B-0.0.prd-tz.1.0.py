...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='WC_CBOD999B',WORKFLOW_ID='fc12973e2dc648089915326d9d74d12c', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-WC_CBOD999B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('fc12973e2dc648089915326d9d74d12c')
    ...
    cbod999bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '9d2bca2228d446399881e1a160355758',
    ...
    Complete = COMMON.getICISCompleteWflowTask('fc12973e2dc648089915326d9d74d12c')
