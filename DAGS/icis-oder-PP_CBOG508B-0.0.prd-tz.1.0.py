...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOG508B',WORKFLOW_ID='dea950feac65489792581c446dafcc9e', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOG508B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('dea950feac65489792581c446dafcc9e')
    ...
    cbog508bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'db1d56bcfe684b0488baf6f882eb1462',
    ...
    Complete = COMMON.getICISCompleteWflowTask('dea950feac65489792581c446dafcc9e')
