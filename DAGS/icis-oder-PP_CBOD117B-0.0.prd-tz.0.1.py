...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBOD117B',WORKFLOW_ID='3e332a685c804fa793614d86c67e065b', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBOD117B-0.0.prd-tz.0.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('3e332a685c804fa793614d86c67e065b')
    ...
    cbod117bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '1359c22f1c9f4054a2c0adabec30b547',
    ...
    Complete = COMMON.getICISCompleteWflowTask('3e332a685c804fa793614d86c67e065b')
