...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNG918B_8',WORKFLOW_ID='fb0ba9cfeb404cc1a1435f8e46c86067', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNG918B_8-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('fb0ba9cfeb404cc1a1435f8e46c86067')
    ...
    csng918bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '8a3e55d8582e43e8b6680263f1e60ba9',
    ...
    Complete = COMMON.getICISCompleteWflowTask('fb0ba9cfeb404cc1a1435f8e46c86067')
