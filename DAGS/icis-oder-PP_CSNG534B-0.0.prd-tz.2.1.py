...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG534B',WORKFLOW_ID='3f67566dd6354acfbd2856bb14195510', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG534B-0.0.prd-tz.2.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('3f67566dd6354acfbd2856bb14195510')
    ...
    csng534bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '2a50964540c14787a60e742e81bc16c0',
    ...
    Complete = COMMON.getICISCompleteWflowTask('3f67566dd6354acfbd2856bb14195510')
