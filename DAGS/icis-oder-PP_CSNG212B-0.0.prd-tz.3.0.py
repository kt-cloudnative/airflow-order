...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG212B',WORKFLOW_ID='9fadb049eba9419382c137d9dd84429d', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG212B-0.0.prd-tz.3.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('9fadb049eba9419382c137d9dd84429d')
    ...
    csng212bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '31f7d66286794bd9aefbcb8867ab60af',
    ...
    Complete = COMMON.getICISCompleteWflowTask('9fadb049eba9419382c137d9dd84429d')
