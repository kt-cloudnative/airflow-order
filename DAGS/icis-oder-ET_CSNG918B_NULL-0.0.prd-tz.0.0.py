...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNG918B_NULL',WORKFLOW_ID='2de10e56fd03473d82badee188374ca5', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNG918B_NULL-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('2de10e56fd03473d82badee188374ca5')
    ...
    csng918bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'cd47d086d40645deb8fd7a9fed0856c7',
    ...
    Complete = COMMON.getICISCompleteWflowTask('2de10e56fd03473d82badee188374ca5')
