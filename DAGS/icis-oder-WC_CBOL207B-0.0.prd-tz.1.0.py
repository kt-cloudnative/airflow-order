...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='WC_CBOL207B',WORKFLOW_ID='b5116ed4e65f47c5bd07493e406e63f1', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-WC_CBOL207B-0.0.prd-tz.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('b5116ed4e65f47c5bd07493e406e63f1')
    ...
    cbol207bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '0565b9ba7b85461588af4c7516708d9d',
    ...
    Complete = COMMON.getICISCompleteWflowTask('b5116ed4e65f47c5bd07493e406e63f1')
