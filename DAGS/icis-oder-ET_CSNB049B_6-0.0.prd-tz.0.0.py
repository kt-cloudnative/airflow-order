...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNB049B_6',WORKFLOW_ID='4970275bf5eb4fd8b90c681f064e784a', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNB049B_6-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('4970275bf5eb4fd8b90c681f064e784a')
    ...
    csnb049bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'e15341e6cdc84ccfb5c0408da07b17e3',
    ...
    Complete = COMMON.getICISCompleteWflowTask('4970275bf5eb4fd8b90c681f064e784a')
