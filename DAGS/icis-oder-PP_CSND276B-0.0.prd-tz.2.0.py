...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSND276B',WORKFLOW_ID='5e768c107e7043778c3e90a86bd7469d', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSND276B-0.0.prd-tz.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('5e768c107e7043778c3e90a86bd7469d')
    ...
    csnd276bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'aa56fe9bdf0c4153866f501c3e5bf89c',
    ...
    Complete = COMMON.getICISCompleteWflowTask('5e768c107e7043778c3e90a86bd7469d')
