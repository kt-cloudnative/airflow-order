...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG133B',WORKFLOW_ID='2896b7c995e145df8ccdbebc84f2ed5a', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG133B-0.0.prd-tz.1.1'
    ,'schedule_interval':'@once'
    ,'start_date': datetime(2024, 11, 4, 10, 46, 00, tzinfo=local_tz)
    ,'end_date': None
    ,'paused': False
})as dag:

    authCheck = COMMON.getICISAuthCheckWflow('2896b7c995e145df8ccdbebc84f2ed5a')
    ...
    csng133bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'f452bfd30e31475c811326a7574c5862',
...
, "workMonth=202407"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('2896b7c995e145df8ccdbebc84f2ed5a')
