...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CSNG666B',WORKFLOW_ID='d6f1a35e411d42f0aa5d668468e35274', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CSNG666B-0.0.prd-tz.4.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('d6f1a35e411d42f0aa5d668468e35274')
    ...
    csng666bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'f6d4e9a611e146c5912ffeca4fca49d0',
    ...
    Complete = COMMON.getICISCompleteWflowTask('d6f1a35e411d42f0aa5d668468e35274')
