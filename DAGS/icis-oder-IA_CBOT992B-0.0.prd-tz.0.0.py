...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='IA_CBOT992B',WORKFLOW_ID='82301a1a5643461dbe86eaa6272c46b5', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-IA_CBOT992B-0.0.prd-tz.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('82301a1a5643461dbe86eaa6272c46b5')
    ...
    cbot992bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '52763b1487504bc2bfd244c64ff22b64',
    ...
    Complete = COMMON.getICISCompleteWflowTask('82301a1a5643461dbe86eaa6272c46b5')
