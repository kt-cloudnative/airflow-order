...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='PP_CBON316B',WORKFLOW_ID='f79a490cb76b4d2289454f7a82ed01f9', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-PP_CBON316B-0.0.prd-tz.4.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('f79a490cb76b4d2289454f7a82ed01f9')
    ...
    cbon316bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '4bc671e2964e45d399b413cb30432ca2',
    ...
    Complete = COMMON.getICISCompleteWflowTask('f79a490cb76b4d2289454f7a82ed01f9')
