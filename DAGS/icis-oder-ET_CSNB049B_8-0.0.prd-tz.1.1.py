...
COMMON = ICISCmmn(DOMAIN='oder',ENV='prd-tz', NAMESPACE='t-order'
                , WORKFLOW_NAME='ET_CSNB049B_8',WORKFLOW_ID='6b495dc78cf84efc8ad0efb39f30f88b', APP_NAME='NBSS_TORD', CHNL_TYPE='TO', USER_ID='91337909')

with COMMON.getICISDAG({
    'dag_id':'icis-oder-ET_CSNB049B_8-0.0.prd-tz.1.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('6b495dc78cf84efc8ad0efb39f30f88b')
    ...
    csnb049bJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '83e3eb21656c43d4b019ec6d64890fa2',
    ...
    Complete = COMMON.getICISCompleteWflowTask('6b495dc78cf84efc8ad0efb39f30f88b')
